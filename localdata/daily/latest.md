# Breakwater daily print — 2026-09-11 18:27 UTC
...
- Ledger: 131655 decision rows; 115 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 131540 rows are skipped/guard decisions and never count
...
- **HIP3**: 3 open, stop-risk **7.30 ZAR**
  ...
  - XYZ:COST BUY ntl=364 risk=1.61 bars=3 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.76 bars=2 stop=97.963000000000001685 peak=98.168
...
- Latest scan 2026-09-11T18:10:20: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 14, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 86, "regime_blocked": 247, "skipped": 432, "slice_full": 6, "slot_full": 0})
