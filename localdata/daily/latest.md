# Breakwater daily print — 2026-09-20 08:24 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **426.24 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2138.60 ZAR** (seed 2000) | lifetime: **+138.60 ZAR** | closed: 170
- Today: 15 closed, **+18.27 ZAR**
- 7d: **+138.60 ZAR** | 30d: **+138.60 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 114.05 ZAR mean notional/trade: +0.53 ZAR/trade
- Realised (170 real closes per lane_gate._is_real_close, net of fees): +0.82 ZAR/trade | sd 3.42 | SE 0.26
- Gap: +0.29 ZAR/trade | t = +1.09 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.55 ZAR | realised 140 closes +0.97 ZAR sd 3.61 SE 0.31 | gap +0.41 t +1.36 | NOT ESTABLISHED
...
- Ledger: 65679 decision rows; 170 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 65509 rows are skipped/guard decisions and never count
...
- Closed: 140 | wins: 74 | win%: 52.9 | P&L: **+135.70 ZAR** | today: +18.27 | 7d: +135.70 | 30d: +135.70
- By exit: target +146.1, horizon +85.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 40/+103.9, bull 34/+48.2, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 18n/14w +85.22; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 14n +97.18; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 11 open, stop-risk **55.80 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=5 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=428 risk=7.48 bars=0 stop=157.583175 peak=160.39
  - ETHZAR BUY ntl=424 risk=7.42 bars=17 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=4 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=3 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=16 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=7 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=5 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=5 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=5 stop=2516.6249999999998140 peak=2573.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=12 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **55.80 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=18n/+85.22
...
- Native lane: **GREEN** | closed=20 pnl=+16.63 | frozen=NO
...
- Latest scan 2026-09-20T08:24:09: errors=4 signals=None regime_blocked=None
