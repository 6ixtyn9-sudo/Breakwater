# Breakwater daily print — 2026-09-17 14:27 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **394.97 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 32884 decision rows; 100 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 32784 rows are skipped/guard decisions and never count
...
- **NATIVE**: 14 open, stop-risk **53.54 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=17 stop=10.568250000000000175 peak=10.99
  - DOGEUSDC BUY ntl=195 risk=6.51 bars=18 stop=0.07773975000000000430 peak=0.080417
  - SUIUSDC BUY ntl=98 risk=3.81 bars=4 stop=0.6937050000000000245 peak=0.72188
  - WLDUSDC BUY ntl=98 risk=3.77 bars=0 stop=0.3633724999999999915 peak=0.37798
  - TAOUSDC BUY ntl=98 risk=3.77 bars=3 stop=218.55249999999998005 peak=227.32
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=4 stop=0.0033364999999999999610 peak=0.00347
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=0 stop=120.35500000000001335 peak=125.1
  - FILUSDC BUY ntl=98 risk=3.70 bars=4 stop=0.7672624999999999540 peak=0.79746
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=0 stop=1.878824999999999980 peak=1.9487
  - XRPUSDC BUY ntl=97 risk=3.42 bars=5 stop=1.2580499999999999655 peak=1.3041
  - ETHUSDC BUY ntl=97 risk=3.37 bars=11 stop=2344.3999999999998880 peak=2428.4
  - SOLUSDC BUY ntl=98 risk=2.69 bars=4 stop=97.43574999999999960 peak=100.2
  - BTCUSDC BUY ntl=98 risk=2.32 bars=14 stop=74370.75000000000010 peak=76180.0
  - BNBUSDC BUY ntl=98 risk=1.71 bars=4 stop=712.734975 peak=725.43

- **HIP3**: 6 open, stop-risk **13.72 ZAR**
  - PARA:COHR SELL ntl=98 risk=3.07 bars=0 stop=314.50749999999999095 peak=304.92
  - PARA:CIEN SELL ntl=98 risk=2.66 bars=0 stop=377.0499999999999895 peak=367.04
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=0 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=0 stop=155.95250000000000345 peak=152.8
  - PARA:TER SELL ntl=98 risk=1.71 bars=0 stop=358.149825 peak=351.99
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=0 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **67.26 ZAR** (informational only, no cap applied)
...
- Label: **neutral** | breadth bear=0.0476 bull=0.1905 neutral=0.7619 | symbols=21
- confirmed_bear: **False** | confirmed_bull: **False** | flip: **False** | flipped_from: bear | consecutive_bear: 0 / bull 0
- as_of: 2026-09-17T14:25:32Z
...
- Latest scan 2026-09-17T14:09:14: errors=4 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `slot_full` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 39, "regime_blocked": 151, "skipped": 31, "slice_full": 21, "slot_full": 167})
