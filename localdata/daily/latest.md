# Breakwater daily print — 2026-09-24 08:06 UTC
...
- Ledger: 121042 decision rows; 250 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 120792 rows are skipped/guard decisions and never count
...
- **NATIVE**: 4 open, stop-risk **14.86 ZAR**
  - SOLUSDC BUY ntl=124 risk=4.23 bars=1 stop=111.4449999999999975 peak=115.38
  - ETHUSDC BUY ntl=124 risk=3.78 bars=15 stop=2595.5999999999998420 peak=2677.3
  - BNBUSDC BUY ntl=124 risk=3.61 bars=3 stop=750.0500000000000280 peak=772.52
  - BTCUSDC BUY ntl=124 risk=3.24 bars=14 stop=81796.74999999999985 peak=83989.0

- **HIP3**: 3 open, stop-risk **18.81 ZAR**
  - PARA:CIFR SELL ntl=250 risk=8.70 bars=15 stop=19.97774999999999890 peak=19.305
  - PARA:CRDO SELL ntl=250 risk=5.75 bars=16 stop=197.4825000000000025 peak=193.04
  - PARA:AVGO SELL ntl=250 risk=4.37 bars=16 stop=363.796950 peak=357.54
...
- Latest scan 2026-09-24T06:24:23: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 25, "regime_blocked": 416, "skipped": 890, "slice_full": 0, "slot_full": 0})
