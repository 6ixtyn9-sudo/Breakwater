# Breakwater daily print — 2026-09-19 17:44 UTC
...
- Ledger: 60453 decision rows; 152 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 60301 rows are skipped/guard decisions and never count
...
- **NATIVE**: 14 open, stop-risk **57.78 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=13 stop=108.78750000000000565 peak=113.27
  - ETHZAR BUY ntl=424 risk=7.42 bars=2 stop=41925.24000 peak=42672.0
  - ETHUSDC BUY ntl=207 risk=5.79 bars=12 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=7 stop=1784.4999999999999990 peak=1824.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=1 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=104 risk=3.96 bars=7 stop=1.3599500000000001440 peak=1.4137
  - LINKUSDC BUY ntl=105 risk=3.86 bars=5 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=12 stop=79553.750000000000095 peak=81067.0
  - DOGEUSDC BUY ntl=106 risk=3.63 bars=1 stop=0.08592275000000000190 peak=0.088963
  - BTCUSDC BUY ntl=103 risk=2.83 bars=14 stop=79105.74999999999985 peak=81333.0
  - BTCZAR BUY ntl=103 risk=2.54 bars=14 stop=1294261.0000000000005 peak=1326934.0
  - BNBZAR BUY ntl=103 risk=2.41 bars=14 stop=12153.999999999999990 peak=12444.0
  - LTCZAR BUY ntl=106 risk=2.38 bars=2 stop=910.3999999999999665 peak=931.3
  - BNBUSDC BUY ntl=106 risk=2.24 bars=1 stop=750.5700000000000765 peak=766.75
...
- Closed paper trades: **30/50** | ghost rows: **276/50** | PnL: **+2.90 ZAR**
...
- Latest scan 2026-09-19T17:44:57: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 86, "regime_blocked": 267, "skipped": 885, "slice_full": 3, "slot_full": 0})
