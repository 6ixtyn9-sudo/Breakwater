# Breakwater daily print — 2026-09-21 04:40 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **400.26 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2323.34 ZAR** (seed 2000) | lifetime: **+323.34 ZAR** | closed: 191
- Today: 6 closed, **+45.26 ZAR**
- 7d: **+323.34 ZAR** | 30d: **+323.34 ZAR**
...
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.382% | at 142.80 ZAR mean notional/trade: +0.55 ZAR/trade
- Realised (191 real closes per lane_gate._is_real_close, net of fees): +1.69 ZAR/trade | sd 4.56 | SE 0.33
- Gap: +1.15 ZAR/trade | t = +3.48 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.388% over 242/245 slices (pool 676) ~ +0.59 ZAR | realised 161 closes +1.99 ZAR sd 4.82 SE 0.38 | gap +1.40 t +3.70 | EXCEEDS
...
- Ledger: 75403 decision rows; 191 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 75212 rows are skipped/guard decisions and never count
...
- Closed: 161 | wins: 93 | win%: 57.8 | P&L: **+320.44 ZAR** | today: +45.26 | 7d: +320.44 | 30d: +320.44
- By exit: target +332.2, horizon +84.4, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 55/+258.5, bull 40/+78.4, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 35n/30w +264.68; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- **NATIVE**: 11 open, stop-risk **48.08 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=13 stop=21.98499999999999965 peak=22.51
  - BTCZAR BUY ntl=421 risk=7.36 bars=23 stop=1289481.14250 peak=1312449.0
  - SOLZAR BUY ntl=231 risk=5.81 bars=3 stop=1751.7499999999999985 peak=1797.0
  - LTCZAR BUY ntl=229 risk=4.57 bars=4 stop=920.200000000000010 peak=938.9
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=14 stop=87.90974999999999825 peak=90.96
  - SOLUSDC BUY ntl=113 risk=3.34 bars=8 stop=107.21000000000000570 peak=110.47
  - XRPUSDC BUY ntl=111 risk=3.27 bars=12 stop=1.3499000000000000060 peak=1.3908
  - XRPUSDC BUY ntl=112 risk=3.04 bars=10 stop=1.3651500000000000695 peak=1.4031
  - ETHUSDC BUY ntl=113 risk=2.61 bars=8 stop=2572.9500000000001090 peak=2633.7
  - BNBUSDC BUY ntl=112 risk=2.12 bars=10 stop=750.087499999999995 peak=764.52
  - BTCUSDC BUY ntl=111 risk=1.94 bars=12 stop=79512.74250 peak=80929.0
...
- Computed open stop-risk (section 4): **48.08 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0036 n=10058 p=0.0066 src=validated_walk_forward unproven=False paper=35n/+264.68
...
- Native lane: **GREEN** | closed=20 pnl=+172.82 | frozen=NO
...
- Latest scan 2026-09-21T04:40:36: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 87, "regime_blocked": 574, "skipped": 838, "slice_full": 0, "slot_full": 0})
