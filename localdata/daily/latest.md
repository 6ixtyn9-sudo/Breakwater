# Breakwater daily print — 2026-09-13 03:38 UTC
...
- Ledger: 175633 decision rows; 135 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 175498 rows are skipped/guard decisions and never count
...
- **NATIVE**: 7 open, stop-risk **25.54 ZAR**
  - ASTERUSDC BUY ntl=353 risk=7.49 bars=5 stop=0.6719625000000000010 peak=0.68652
  - SUIUSDC BUY ntl=353 risk=5.72 bars=8 stop=0.71029750000000001525 peak=0.72198
  - BNBUSDC BUY ntl=353 risk=4.98 bars=17 stop=725.1625000000000595 peak=735.54
  - XRPUSDC BUY ntl=353 risk=3.86 bars=8 stop=1.3481250000000000840 peak=1.363
  - DOGEUSDC BUY ntl=353 risk=3.50 bars=8 stop=0.083883749999999989905 peak=0.084723
  - XMRUSDC BUY ntl=355 risk=0.00 bars=31 stop=526.16999999999998150 peak=545.65
  - KPEPEUSDC BUY ntl=353 risk=0.00 bars=19 stop=0.0033567500000000000550 peak=0.003447
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  ...
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=32 stop=283.88000000000002330 peak=287.39
...
- Closed paper trades: **31/50** | ghost rows: **403/50** | PnL: **-20.70 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 76 / bull 0
- as_of: 2026-09-13T03:30:25Z
...
- Latest scan 2026-09-13T03:38:07: errors=1 signals=None regime_blocked=None
