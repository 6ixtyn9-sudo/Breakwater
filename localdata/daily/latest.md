# Breakwater daily print — 2026-09-13 13:27 UTC
...
- Mode: **readonly** | VALR equity: **397.25 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 187655 decision rows; 145 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 187510 rows are skipped/guard decisions and never count
...
- **HIP3**: 3 open, stop-risk **10.24 ZAR**
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=42 stop=109.37749999999999265 peak=110.76
...
- Closed paper trades: **34/50** | ghost rows: **562/50** | PnL: **-30.92 ZAR**
...
- Label: **bear** | breadth bear=0.8095 bull=0.0476 neutral=0.1429 | symbols=21
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 92 / bull 0
- as_of: 2026-09-13T13:25:27Z
...
- Latest scan 2026-09-13T13:09:47: errors=4 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 17, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 14, "regime_blocked": 573, "skipped": 23, "slice_full": 0, "slot_full": 87})
