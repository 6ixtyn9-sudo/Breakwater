# Breakwater daily print — 2026-09-22 18:06 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **459.53 ZAR** | high-water: **474.55 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2494.37 ZAR** (seed 2000) | lifetime: **+494.37 ZAR** | closed: 233
- Today: 19 closed, **-51.14 ZAR**
- 7d: **+486.34 ZAR** | 30d: **+494.37 ZAR**
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 163.94 ZAR mean notional/trade: +0.68 ZAR/trade
- Realised (233 real closes per lane_gate._is_real_close, net of fees): +2.12 ZAR/trade | sd 5.80 | SE 0.38
...
- Ledger: 95648 decision rows; 233 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 95415 rows are skipped/guard decisions and never count
...
- Closed: 196 | wins: 119 | win%: 60.7 | P&L: **+504.26 ZAR** | today: -38.35 | 7d: +502.21 | 30d: +504.26
...
- **NATIVE**: 8 open, stop-risk **47.83 ZAR**
  - BNBZAR BUY ntl=498 risk=10.49 bars=6 stop=12591.999999999999995 peak=12863.0
  - BTCZAR BUY ntl=498 risk=9.85 bars=6 stop=1372452.0000000000005 peak=1400141.0
  - ETHZAR BUY ntl=499 risk=8.90 bars=0 stop=43931.250000000000030 peak=44729.0
  - HYPEUSDC BUY ntl=126 risk=4.80 bars=12 stop=89.96399999999999715 peak=93.542
  - SOLUSDC BUY ntl=125 risk=4.60 bars=2 stop=112.66499999999999845 peak=116.98
  - ETHUSDC BUY ntl=125 risk=3.30 bars=9 stop=2656.3000000000001325 peak=2728.2
  - BNBUSDC BUY ntl=125 risk=3.06 bars=2 stop=768.0850000000000135 peak=787.38
  - BTCUSDC BUY ntl=125 risk=2.83 bars=1 stop=84492.50000000000015 peak=86453.0

- **HIP3**: 3 open, stop-risk **9.05 ZAR**
  - PARA:COHR SELL ntl=125 risk=4.68 bars=3 stop=335.5075000000000165 peak=323.4
  - PARA:RDDT SELL ntl=125 risk=2.19 bars=3 stop=162.209850 peak=159.42
  - PARA:IGV SELL ntl=125 risk=2.19 bars=0 stop=108.587600 peak=106.72

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **56.88 ZAR** (informational only, no cap applied)
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 46
- as_of: 2026-09-22T17:35:29Z
...
- Latest scan 2026-09-22T17:21:56: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 26, "regime_blocked": 351, "skipped": 848, "slice_full": 6, "slot_full": 0})
