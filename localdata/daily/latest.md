# Breakwater daily print — 2026-09-12 18:37 UTC
...
- Ledger: 163959 decision rows; 129 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 163830 rows are skipped/guard decisions and never count
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=28 stop=359.37499999999998860 peak=364.3
...
- Closed paper trades: **31/50** | ghost rows: **243/50** | PnL: **-20.70 ZAR**
...
- Latest scan 2026-09-12T18:37:37: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 47, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 44, "regime_blocked": 775, "skipped": 114, "slice_full": 1, "slot_full": 0})
