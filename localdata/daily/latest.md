# Breakwater daily print — 2026-09-10 17:38 UTC
...
- Claimed edge (median mean_ret_costadj over 47 book slices present in the validated pools): +0.413% | at 390.95 ZAR mean notional/trade: +1.61 ZAR/trade
- Realised (98 real closes per lane_gate._is_real_close, net of fees): -1.66 ZAR/trade | sd 8.25 | SE 0.83
- Gap: -3.27 ZAR/trade | t = -3.93 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.517% over 30/30 slices (pool 524) ~ +2.02 ZAR | realised 69 closes -1.96 ZAR sd 9.47 SE 1.14 | gap -3.98 t -3.49 | FALLS SHORT
...
- Ledger: 106754 decision rows; 98 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 106656 rows are skipped/guard decisions and never count
...
- **NATIVE**: 10 open, stop-risk **114.28 ZAR**
  - ONDOUSDC BUY ntl=372 risk=17.25 bars=9 stop=0.3373299999999999995 peak=0.35372
  - SUIUSDC BUY ntl=372 risk=16.80 bars=9 stop=0.729662499999999995 peak=0.76415
  - HYPEUSDC BUY ntl=372 risk=15.34 bars=9 stop=79.77874999999999920 peak=83.209
  - LTCUSDC BUY ntl=372 risk=12.08 bars=9 stop=50.712999999999995975 peak=52.414
  - SOLUSDC BUY ntl=368 risk=10.60 bars=4 stop=96.19624999999999860 peak=99.047
  - XRPUSDC BUY ntl=372 risk=10.51 bars=9 stop=1.3424999999999999680 peak=1.3815
  - BNBUSDC BUY ntl=372 risk=9.31 bars=9 stop=700.8499999999999830 peak=718.83
  - DOGEUSDC BUY ntl=369 risk=9.13 bars=5 stop=0.08314199999999999435 peak=0.08525
  - ETHUSDC BUY ntl=367 risk=8.08 bars=2 stop=2386.2499999999999110 peak=2439.9
  - BTCUSDC BUY ntl=369 risk=5.17 bars=5 stop=76750.75 peak=77841.0

- **HIP3**: 1 open, stop-risk **0.76 ZAR**
  - XYZ:STRC BUY ntl=368 risk=0.76 bars=3 stop=97.66200000000000180 peak=97.864
...
- Tradable slices: native **30/30** | hip3 **16/17**
...
- Latest scan 2026-09-10T17:38:28: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 10, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 1, "pair_held": 12, "regime_blocked": 208, "skipped": 314, "slice_full": 0, "slot_full": 147})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=2 blocks=12
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:XBI"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:ZM"}]
