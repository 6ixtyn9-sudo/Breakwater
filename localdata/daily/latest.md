# Breakwater daily print — 2026-09-25 11:46 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **532.08 ZAR** | high-water: **560.11 ZAR**
...
- Ledger: 138750 decision rows; 260 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 138490 rows are skipped/guard decisions and never count
...
- Closed: 221 | wins: 132 | win%: 59.7 | P&L: **+487.54 ZAR** | today: +6.21 | 7d: +475.48 | 30d: +487.54
...
- **NATIVE**: 6 open, stop-risk **20.31 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.79 bars=4 stop=1.4715999999999999645 peak=1.5302
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=5 stop=88.47099999999999610 peak=91.951
  - SOLUSDC BUY ntl=125 risk=3.90 bars=6 stop=112.73749999999999790 peak=116.36
  - ETHUSDC BUY ntl=126 risk=2.50 bars=0 stop=2660.8250000000000030 peak=2714.7
  - BNBUSDC BUY ntl=126 risk=2.20 bars=0 stop=763.59900 peak=777.2
  - BTCUSDC BUY ntl=125 risk=2.19 bars=3 stop=82556.52750 peak=84027.0

- **HIP3**: 2 open, stop-risk **14.02 ZAR**
  - PARA:GLW SELL ntl=250 risk=9.65 bars=19 stop=161.20750000000001620 peak=155.21
  - PARA:IGV SELL ntl=250 risk=4.37 bars=21 stop=108.546900 peak=106.68
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 40, "skipped": 40, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 2, "pair_held": 40, "signals": 833, "skipped": 791, "slice_full": 0, "slot_full": 0}}
...
- Closed paper trades: **39/50** | ghost rows: **449/50** | PnL: **+6.38 ZAR**
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 7
- as_of: 2026-09-25T11:00:28Z
...
- Latest scan 2026-09-25T11:46:31: errors=1 signals=873 regime_blocked=508
- this cycle: closed=2 new_signals=873 skipped=831 slot_full=0 slice_full=0 pair_held=40
- Action funnel: regime_blocked=508 | lane_gate_blocked=6 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=40 | slot_full=0 | skipped=831
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 40, "regime_blocked": 508, "skipped": 831, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=29.6295 cap=176.1636 used=0.2126 remaining=138.7061 replayed=7 no_new_bars=1
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:QCOM"}]
