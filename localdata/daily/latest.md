# Breakwater daily print — 2026-09-17 10:07 UTC
...
- hip3: claimed median +0.064% over 10/17 slices (pool 160) ~ +0.06 ZAR | realised 27 closes -0.03 ZAR sd 2.12 | INSUFFICIENT SAMPLE (n<30)
- Ledger: 31635 decision rows; 100 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 31535 rows are skipped/guard decisions and never count
...
- **NATIVE**: 10 open, stop-risk **38.79 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=13 stop=10.568250000000000175 peak=10.99
  - DOGEUSDC BUY ntl=195 risk=6.51 bars=14 stop=0.07773975000000000430 peak=0.080417
  - SUIUSDC BUY ntl=98 risk=3.81 bars=0 stop=0.6937050000000000245 peak=0.72188
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=0 stop=0.0033364999999999999610 peak=0.00347
  - FILUSDC BUY ntl=98 risk=3.70 bars=0 stop=0.7672624999999999540 peak=0.79746
  - XRPUSDC BUY ntl=97 risk=3.42 bars=1 stop=1.2580499999999999655 peak=1.3041
  - ETHUSDC BUY ntl=97 risk=3.37 bars=7 stop=2344.3999999999998880 peak=2428.4
  - SOLUSDC BUY ntl=98 risk=2.69 bars=0 stop=97.43574999999999960 peak=100.2
  - BTCUSDC BUY ntl=98 risk=2.32 bars=10 stop=74370.75000000000010 peak=76180.0
  - BNBUSDC BUY ntl=98 risk=1.71 bars=0 stop=712.734975 peak=725.43
...
- Computed open stop-risk (section 4): **38.79 ZAR** (informational only, no cap applied)
...
- Tradable slices: native **7/8** | hip3 **15/17**
...
- Latest scan 2026-09-17T10:07:19: errors=3 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 23, "regime_blocked": 277, "skipped": 55, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=4 blocks=9
