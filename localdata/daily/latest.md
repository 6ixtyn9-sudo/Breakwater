# Breakwater daily print — 2026-09-21 17:40 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **467.65 ZAR** | high-water: **474.55 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2512.27 ZAR** (seed 2000) | lifetime: **+512.27 ZAR** | closed: 210
- Today: 25 closed, **+234.19 ZAR**
- 7d: **+512.27 ZAR** | 30d: **+512.27 ZAR**
...
- Claimed edge (median mean_ret_costadj over 264 book slices present in the validated pools): +0.382% | at 153.06 ZAR mean notional/trade: +0.58 ZAR/trade
- Realised (210 real closes per lane_gate._is_real_close, net of fees): +2.44 ZAR/trade | sd 5.68 | SE 0.39
- Gap: +1.85 ZAR/trade | t = +4.73 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.389% over 243/246 slices (pool 676) ~ +0.63 ZAR | realised 180 closes +2.83 ZAR sd 5.98 SE 0.45 | gap +2.20 t +4.94 | EXCEEDS
...
- Ledger: 83551 decision rows; 210 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 83341 rows are skipped/guard decisions and never count
...
- Closed: 180 | wins: 112 | win%: 62.2 | P&L: **+509.37 ZAR** | today: +234.19 | 7d: +509.37 | 30d: +509.37
- By exit: target +497.6, horizon +107.9, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 61/+292.2, bull 53/+233.6, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 37n/32w +283.35; feat_close_pos_ma:2:LONG:h12 16n/15w +149.46; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_bb_pos_20:2:LONG:h15 4n/4w +16.17; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77
...
- Top pairs: LINKZAR 28n +269.82; LTCZAR 8n +106.00; SOLZAR 4n +21.46; XRPZAR 2n +18.07; BTCUSDC 11n +17.42
...
- **NATIVE**: 10 open, stop-risk **89.70 ZAR**
  - SOLZAR BUY ntl=496 risk=17.31 bars=3 stop=1865.5000000000000025 peak=1933.0
  - BNBZAR BUY ntl=503 risk=15.02 bars=2 stop=12643.499999999999985 peak=13033.0
  - BTCUSDC BUY ntl=476 risk=14.18 bars=7 stop=82209.25000000000015 peak=84735.0
  - BTCZAR BUY ntl=476 risk=13.19 bars=7 stop=1343694.00 peak=1381998.0
  - XRPUSDC BUY ntl=233 risk=8.90 bars=10 stop=1.3826000000000000025 peak=1.4375
  - ETHUSDC BUY ntl=121 risk=4.72 bars=5 stop=2620.5999999999998675 peak=2727.2
  - XRPUSDC BUY ntl=117 risk=4.45 bars=10 stop=1.3826000000000000025 peak=1.4375
  - HYPEUSDC BUY ntl=124 risk=4.44 bars=3 stop=91.43674999999999890 peak=94.838
  - BNBUSDC BUY ntl=118 risk=3.93 bars=8 stop=756.3099999999999955 peak=782.37
  - BTCUSDC BUY ntl=119 risk=3.55 bars=7 stop=82209.25000000000015 peak=84735.0

- **HIP3**: 6 open, stop-risk **34.71 ZAR**
  - PARA:CIFR SELL ntl=248 risk=9.88 bars=3 stop=19.379999999999999455 peak=18.637
  - PARA:AVGO SELL ntl=248 risk=6.90 bars=3 stop=365.2225000000000405 peak=355.33
  - PARA:CIEN SELL ntl=248 risk=6.81 bars=2 stop=374.53749999999999845 peak=364.52
  - PARA:COHR SELL ntl=124 risk=4.27 bars=3 stop=337.78750000000002090 peak=326.53
  - PARA:CRDO SELL ntl=124 risk=3.66 bars=2 stop=190.46999999999999175 peak=185.0
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=3 stop=252.9599999999999910 peak=246.63

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **124.40 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:2:LONG:h12` edge=0.0092 n=1092 p=0.3222 src=validated_walk_forward unproven=False paper=16n/+149.46
...
- Label: **bull** | breadth bear=0.0667 bull=0.9333 neutral=0.0 | symbols=15
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 22
- as_of: 2026-09-21T17:00:37Z
...
- Native lane: **GREEN** | closed=20 pnl=+190.95 | frozen=NO
...
- Latest scan 2026-09-21T17:40:51: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 72, "regime_blocked": 305, "skipped": 701, "slice_full": 6, "slot_full": 197})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:ASML"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:GIGADEV"}]
