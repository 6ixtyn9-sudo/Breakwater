# Breakwater daily print — 2026-09-13 15:07 UTC
...
- Ledger: 190073 decision rows; 146 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 189927 rows are skipped/guard decisions and never count
...
- Closed: 112 | wins: 43 | win%: 38.4 | P&L: **-240.64 ZAR** | today: -26.49 | 7d: -249.93 | 30d: -240.64
...
- **NATIVE**: 13 open, stop-risk **90.36 ZAR**
  - ARBUSDC BUY ntl=347 risk=14.70 bars=7 stop=0.13294499999999999205 peak=0.13883
  - LITUSDC BUY ntl=347 risk=13.72 bars=7 stop=3.947674999999999980 peak=4.1103
  - NEARUSDC BUY ntl=347 risk=11.05 bars=7 stop=2.2261500000000000720 peak=2.2994
  - TAOUSDC BUY ntl=347 risk=8.45 bars=7 stop=230.16499999999999520 peak=235.91
  - FARTCOINUSDC BUY ntl=347 risk=8.38 bars=7 stop=0.13803999999999998685 peak=0.14146
  - LINKUSDC BUY ntl=345 risk=7.04 bars=2 stop=11.016249999999999870 peak=11.246
  - HYPEUSDC BUY ntl=347 risk=6.66 bars=7 stop=76.92624999999999375 peak=78.432
  - LTCUSDC BUY ntl=347 risk=6.02 bars=7 stop=53.15024999999999935 peak=54.089
  - DOGEUSDC BUY ntl=347 risk=4.13 bars=7 stop=0.08315825000000000075 peak=0.08416
  - BNBUSDC BUY ntl=346 risk=3.71 bars=4 stop=707.1325000000000195 peak=714.81
  - ETHUSDC BUY ntl=346 risk=3.58 bars=6 stop=2468.62499999999990825 peak=2494.4
  - BTCUSDC BUY ntl=346 risk=2.93 bars=1 stop=76157.750000000000020 peak=76808.0
  - XMRUSDC BUY ntl=355 risk=0.00 bars=43 stop=526.16999999999998150 peak=545.65
...
- Closed paper trades: **34/50** | ghost rows: **592/50** | PnL: **-30.92 ZAR**
...
- Latest scan 2026-09-13T15:07:55: errors=6 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 22, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 16, "regime_blocked": 596, "skipped": 25, "slice_full": 0, "slot_full": 100})
