# Breakwater daily print — 2026-09-16 21:11 UTC
...
- Ledger: 27869 decision rows; 85 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 27784 rows are skipped/guard decisions and never count
...
- **NATIVE**: 12 open, stop-risk **49.47 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=0 stop=10.568250000000000175 peak=10.99
  - DOGEUSDC BUY ntl=195 risk=6.51 bars=1 stop=0.07773975000000000430 peak=0.080417
  - ARBUSDC SELL ntl=84 risk=4.94 bars=8 stop=0.17935714285714285 peak=0.16938
  - WLDUSDC BUY ntl=98 risk=4.59 bars=2 stop=0.349429999999999955 peak=0.36664
  - TRUMPUSDC BUY ntl=98 risk=4.47 bars=2 stop=1.7770750000000000540 peak=1.8622
  - ZECUSDC SELL ntl=98 risk=4.40 bars=2 stop=1396.5035714285714 peak=1336.3
  - SUIUSDC BUY ntl=98 risk=3.82 bars=2 stop=0.6670574999999999860 peak=0.6942
  - PUMPUSDC SELL ntl=98 risk=3.79 bars=4 stop=0.003815571428571429 peak=0.003674
  - TAOUSDC BUY ntl=98 risk=3.74 bars=2 stop=209.3224999999999935 peak=217.66
  - SOLUSDC BUY ntl=98 risk=2.91 bars=2 stop=94.85499999999999515 peak=97.766
  - BNBUSDC BUY ntl=98 risk=2.06 bars=2 stop=700.2850000000000755 peak=715.4
  - PUMPUSDT SELL ntl=98 risk=0.74 bars=3 stop=0.0036834199999999997 peak=0.003656

- **HIP3**: 6 open, stop-risk **12.87 ZAR**
  - PARA:CRDO SELL ntl=98 risk=3.72 bars=2 stop=167.7850000000000085 peak=161.63
  - PARA:COHR SELL ntl=99 risk=3.38 bars=7 stop=294.5500000000000190 peak=284.79
  - PARA:IREN SELL ntl=98 risk=2.75 bars=5 stop=44.663250000000000375 peak=43.45
...
- Closed paper trades: **22/50** | ghost rows: **113/50** | PnL: **+11.59 ZAR**
...
- Latest scan 2026-09-16T21:11:08: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 2, "pair_held": 10, "regime_blocked": 204, "skipped": 7, "slice_full": 0, "slot_full": 78})
