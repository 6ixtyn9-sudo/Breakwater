# Breakwater daily print — 2026-09-20 18:18 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **437.66 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2225.82 ZAR** (seed 2000) | lifetime: **+225.82 ZAR** | closed: 180
- Today: 25 closed, **+105.49 ZAR**
- 7d: **+225.82 ZAR** | 30d: **+225.82 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 130.02 ZAR mean notional/trade: +0.60 ZAR/trade
- Realised (180 real closes per lane_gate._is_real_close, net of fees): +1.25 ZAR/trade | sd 4.14 | SE 0.31
- Gap: +0.65 ZAR/trade | t = +2.11 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.64 ZAR | realised 150 closes +1.49 ZAR sd 4.39 SE 0.36 | gap +0.84 t +2.35 | EXCEEDS
...
- Ledger: 68661 decision rows; 180 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 68481 rows are skipped/guard decisions and never count
...
- Closed: 150 | wins: 82 | win%: 54.7 | P&L: **+222.92 ZAR** | today: +105.49 | 7d: +222.92 | 30d: +222.92
- By exit: target +243.2, horizon +75.9, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 48/+201.1, bull 36/+38.3, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 27n/22w +173.71; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 22n +194.33; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 13 open, stop-risk **62.38 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=1 stop=21.98499999999999965 peak=22.51
  - BNBZAR BUY ntl=418 risk=8.23 bars=13 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=444 risk=7.77 bars=0 stop=157.583175 peak=160.39
  - BTCUSDC BUY ntl=421 risk=7.36 bars=12 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=11 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=2 stop=87.90974999999999825 peak=90.96
  - XRPUSDC BUY ntl=111 risk=3.27 bars=0 stop=1.3499000000000000060 peak=1.3908
  - SOLUSDC BUY ntl=105 risk=3.24 bars=13 stop=104.35250000000000130 peak=107.69
  - SOLZAR BUY ntl=110 risk=2.47 bars=3 stop=1728.2499999999999970 peak=1768.0
  - BNBUSDC BUY ntl=105 risk=2.34 bars=13 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=13 stop=2516.6249999999998140 peak=2573.3
  - LTCZAR BUY ntl=109 risk=2.08 bars=4 stop=920.99999999999993625 peak=938.9
  - BTCUSDC BUY ntl=111 risk=1.94 bars=0 stop=79512.74250 peak=80929.0
...
- Computed open stop-risk (section 4): **62.38 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=27n/+173.71
...
- Native lane: **GREEN** | closed=20 pnl=+118.08 | frozen=NO
...
- Latest scan 2026-09-20T16:16:52: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 28, "regime_blocked": 313, "skipped": 923, "slice_full": 1, "slot_full": 0})
