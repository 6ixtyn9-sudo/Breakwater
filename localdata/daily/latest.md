# Breakwater daily print — 2026-09-18 04:25 UTC
...
- Claimed edge (median mean_ret_costadj over 211 book slices present in the validated pools): +0.309% | at 100.45 ZAR mean notional/trade: +0.31 ZAR/trade
- Realised (114 real closes per lane_gate._is_real_close, net of fees): -0.12 ZAR/trade | sd 2.55 | SE 0.24
- Gap: -0.43 ZAR/trade | t = -1.79 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.341% over 190/194 slices (pool 520) ~ +0.34 ZAR | realised 85 closes -0.19 ZAR sd 2.64 SE 0.29 | gap -0.53 t -1.85 | NOT ESTABLISHED
