# Breakwater daily print — 2026-09-17 23:02 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **401.27 ZAR** | high-water: **435.05 ZAR**
...
- Claimed edge (median mean_ret_costadj over 78 book slices present in the validated pools): +0.278% | at 100.61 ZAR mean notional/trade: +0.28 ZAR/trade
- Realised (108 real closes per lane_gate._is_real_close, net of fees): -0.32 ZAR/trade | sd 2.42 | SE 0.23
- Gap: -0.60 ZAR/trade | t = -2.58 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.367% over 57/63 slices (pool 176) ~ +0.37 ZAR | realised 80 closes -0.40 ZAR sd 2.52 SE 0.28 | gap -0.77 t -2.73 | FALLS SHORT
...
- Ledger: 34914 decision rows; 108 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 34806 rows are skipped/guard decisions and never count
...
- Closed: 80 | wins: 27 | win%: 33.8 | P&L: **-31.88 ZAR** | today: +25.67 | 7d: -31.88 | 30d: -31.88
...
- **NATIVE**: 14 open, stop-risk **44.99 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=1 stop=494.3899999999999790 peak=514.9
  - SUIUSDC BUY ntl=98 risk=3.81 bars=12 stop=0.6937050000000000245 peak=0.72188
  - WLDUSDC BUY ntl=98 risk=3.77 bars=8 stop=0.3633724999999999915 peak=0.37798
  - TAOUSDC BUY ntl=98 risk=3.77 bars=11 stop=218.55249999999998005 peak=227.32
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=12 stop=0.0033364999999999999610 peak=0.00347
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=8 stop=120.35500000000001335 peak=125.1
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=8 stop=1.878824999999999980 peak=1.9487
  - XRPUSDC BUY ntl=97 risk=3.42 bars=13 stop=1.2580499999999999655 peak=1.3041
  - LINKUSDC BUY ntl=98 risk=3.42 bars=6 stop=10.969999999999999660 peak=11.366
  - SOLUSDC BUY ntl=98 risk=2.86 bars=0 stop=98.16725000000000310 peak=101.11
  - ETHUSDC BUY ntl=98 risk=2.67 bars=3 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=3 stop=0.07923699999999999735 peak=0.081432
  - BNBUSDC BUY ntl=98 risk=1.88 bars=0 stop=720.04750000000004875 peak=734.07
  - BTCUSDC BUY ntl=98 risk=1.86 bars=7 stop=75013.500000000000040 peak=76468.0

- **HIP3**: 6 open, stop-risk **15.45 ZAR**
  - PARA:RDDT SELL ntl=98 risk=3.44 bars=6 stop=156.8850000000000120 peak=151.57
  - PARA:COHR SELL ntl=98 risk=3.07 bars=8 stop=314.50749999999999095 peak=304.92
  - PARA:CIEN SELL ntl=98 risk=2.66 bars=3 stop=377.0499999999999895 peak=367.04
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=8 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=8 stop=155.95250000000000345 peak=152.8
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=8 stop=355.982550 peak=349.86
...
- Label: **neutral** | breadth bear=0.0476 bull=0.2857 neutral=0.6667 | symbols=21
- confirmed_bear: **False** | confirmed_bull: **False** | flip: **False** | flipped_from: bear | consecutive_bear: 0 / bull 0
- as_of: 2026-09-17T22:53:16Z
...
- Latest scan 2026-09-17T22:17:28: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 81, "regime_blocked": 355, "skipped": 356, "slice_full": 27, "slot_full": 59})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:GME"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:MAGS"}]
