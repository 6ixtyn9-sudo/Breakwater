# Breakwater daily print — 2026-09-19 04:27 UTC
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.460% | at 100.27 ZAR mean notional/trade: +0.46 ZAR/trade
- Realised (134 real closes per lane_gate._is_real_close, net of fees): +0.49 ZAR/trade | sd 2.86 | SE 0.25
- Gap: +0.03 ZAR/trade | t = +0.14 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.476% over 244/247 slices (pool 705) ~ +0.48 ZAR | realised 104 closes +0.61 ZAR sd 3.01 SE 0.30 | gap +0.13 t +0.44 | NOT ESTABLISHED
