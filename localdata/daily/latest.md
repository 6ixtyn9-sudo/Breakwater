# Breakwater daily print — 2026-09-12 14:27 UTC
...
- Ledger: 155977 decision rows; 129 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 155848 rows are skipped/guard decisions and never count
...
- **NATIVE**: 9 open, stop-risk **90.57 ZAR**
  ...
  - KPEPEUSDC BUY ntl=353 risk=9.52 bars=5 stop=0.003256750000000000055 peak=0.003347
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=23 stop=359.37499999999998860 peak=364.3
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=19 stop=109.37749999999999265 peak=110.76
  ...
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=22 stop=98.1800000000000016850 peak=98.385
...
- Closed paper trades: **31/50** | ghost rows: **183/50** | PnL: **-20.70 ZAR**
...
- Latest scan 2026-09-12T14:10:21: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 63, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 55, "regime_blocked": 758, "skipped": 135, "slice_full": 0, "slot_full": 0})
