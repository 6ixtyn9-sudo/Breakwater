# Breakwater daily print — 2026-09-14 18:31 UTC
...
- Ledger: 833 decision rows; 0 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 833 rows are skipped/guard decisions and never count
...
- **NATIVE**: 19 open, stop-risk **77.84 ZAR**
  - UNIUSDC BUY ntl=197 risk=10.00 bars=2 stop=6.045149999999999975 peak=6.3687
  - TAOUSDC BUY ntl=200 risk=7.22 bars=3 stop=224.20000000000000175 peak=232.6
  - INJUSDC BUY ntl=95 risk=5.00 bars=3 stop=5.855224999999999825 peak=6.1788
  - ASTERUSDC BUY ntl=200 risk=4.99 bars=3 stop=0.6782624999999999730 peak=0.69562
  - ENAUSDC BUY ntl=100 risk=4.90 bars=2 stop=0.1347025000000000005 peak=0.14164
  - XPLUSDC BUY ntl=100 risk=4.63 bars=3 stop=0.07751075000000000995 peak=0.081272
  - ETHUSDC BUY ntl=200 risk=4.56 bars=3 stop=2444.52499999999975 peak=2501.5
  - JUPUSDC BUY ntl=100 risk=4.47 bars=3 stop=0.2266600000000000090 peak=0.23726
  - HYPEUSDC BUY ntl=100 risk=4.19 bars=3 stop=76.1829999999999980 peak=79.513
  - FARTCOINUSDC BUY ntl=100 risk=4.18 bars=3 stop=0.13483499999999999205 peak=0.14072
  - SUIUSDC BUY ntl=100 risk=3.53 bars=3 stop=0.6972224999999999185 peak=0.72274
  - XRPUSDC BUY ntl=100 risk=3.33 bars=3 stop=1.3540999999999999225 peak=1.4008
  - KPEPEUSDC BUY ntl=100 risk=3.11 bars=2 stop=0.003371749999999999855 peak=0.00348
  - LINKUSDC BUY ntl=100 risk=2.87 bars=3 stop=11.101750000000000755 peak=11.43
  - DOGEUSDC BUY ntl=100 risk=2.51 bars=3 stop=0.0818242499999999985 peak=0.083935
  - SOLUSDC BUY ntl=100 risk=2.31 bars=3 stop=99.4602499999999960 peak=101.81
  - LTCUSDC BUY ntl=100 risk=2.25 bars=3 stop=52.57149999999999735 peak=53.783
  - BTCUSDC BUY ntl=100 risk=2.01 bars=3 stop=76838.50 peak=78417.0
  - BNBUSDC BUY ntl=100 risk=1.77 bars=3 stop=708.82750000000002130 peak=721.6

- **HIP3**: 5 open, stop-risk **6.85 ZAR**
  - XYZ:AVGO SELL ntl=100 risk=2.13 bars=2 stop=354.34500000000002395 peak=346.95
  - XYZ:AMZN SELL ntl=100 risk=1.83 bars=2 stop=258.29249999999999080 peak=253.65
  - XYZ:BABA SELL ntl=100 risk=1.65 bars=2 stop=111.54500000000000465 peak=109.73
  - XYZ:COST SELL ntl=100 risk=0.94 bars=3 stop=926.8850000000000470 peak=918.28
  - XYZ:STRC SELL ntl=100 risk=0.29 bars=2 stop=98.98699999999999560 peak=98.697
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 0, "skipped": 0, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 56, "skipped": 0, "slice_full": 0, "slot_full": 56}}
...
- Latest scan 2026-09-14T18:31:42: errors=0 signals=56 regime_blocked=81
- this cycle: closed=0 new_signals=56 skipped=0 slot_full=56 slice_full=0 pair_held=0
- Action funnel: regime_blocked=81 | lane_gate_blocked=0 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=0 | slot_full=56 | skipped=0
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 0, "pair_held": 0, "regime_blocked": 81, "skipped": 0, "slice_full": 0, "slot_full": 56})
