# Breakwater daily print — 2026-09-21 00:43 UTC
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 138.33 ZAR mean notional/trade: +0.64 ZAR/trade
- Realised (187 real closes per lane_gate._is_real_close, net of fees): +1.56 ZAR/trade | sd 4.45 | SE 0.33
- Gap: +0.92 ZAR/trade | t = +2.82 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.69 ZAR | realised 157 closes +1.84 ZAR sd 4.71 SE 0.38 | gap +1.15 t +3.06 | EXCEEDS
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=32n/+236.42
