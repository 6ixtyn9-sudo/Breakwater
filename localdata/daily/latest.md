# Breakwater daily print — 2026-09-21 06:14 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **434.28 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2324.55 ZAR** (seed 2000) | lifetime: **+324.55 ZAR** | closed: 192
- Today: 7 closed, **+46.46 ZAR**
- 7d: **+324.55 ZAR** | 30d: **+324.55 ZAR**
...
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.382% | at 144.24 ZAR mean notional/trade: +0.55 ZAR/trade
- Realised (192 real closes per lane_gate._is_real_close, net of fees): +1.69 ZAR/trade | sd 4.55 | SE 0.33
- Gap: +1.14 ZAR/trade | t = +3.47 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.388% over 242/245 slices (pool 676) ~ +0.59 ZAR | realised 162 closes +1.99 ZAR sd 4.80 SE 0.38 | gap +1.39 t +3.69 | EXCEEDS
...
- Ledger: 76102 decision rows; 192 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 75910 rows are skipped/guard decisions and never count
...
- Closed: 162 | wins: 94 | win%: 58.0 | P&L: **+321.65 ZAR** | today: +46.46 | 7d: +321.65 | 30d: +321.65
- By exit: target +332.2, horizon +85.6, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 55/+258.5, bull 41/+79.6, bear 66/-16.4
...
- **NATIVE**: 11 open, stop-risk **44.79 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=14 stop=21.98499999999999965 peak=22.51
  - SOLZAR BUY ntl=231 risk=5.81 bars=4 stop=1751.7499999999999985 peak=1797.0
  - LTCZAR BUY ntl=229 risk=4.57 bars=5 stop=920.200000000000010 peak=938.9
  - BTCZAR BUY ntl=233 risk=4.07 bars=0 stop=1302258.55500 peak=1325454.0
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=15 stop=87.90974999999999825 peak=90.96
  - SOLUSDC BUY ntl=113 risk=3.34 bars=9 stop=107.21000000000000570 peak=110.47
  - XRPUSDC BUY ntl=111 risk=3.27 bars=13 stop=1.3499000000000000060 peak=1.3908
  - XRPUSDC BUY ntl=112 risk=3.04 bars=11 stop=1.3651500000000000695 peak=1.4031
  - ETHUSDC BUY ntl=113 risk=2.61 bars=9 stop=2572.9500000000001090 peak=2633.7
  - BNBUSDC BUY ntl=112 risk=2.12 bars=11 stop=750.087499999999995 peak=764.52
  - BTCUSDC BUY ntl=111 risk=1.94 bars=13 stop=79512.74250 peak=80929.0
...
- Computed open stop-risk (section 4): **44.79 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+162.04 | frozen=NO
...
- Latest scan 2026-09-21T05:20:46: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 85, "regime_blocked": 576, "skipped": 841, "slice_full": 0, "slot_full": 0})
