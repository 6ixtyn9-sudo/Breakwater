# Breakwater daily print — 2026-09-12 20:40 UTC
...
- Ledger: 166963 decision rows; 130 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 166833 rows are skipped/guard decisions and never count
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  ...
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=26 stop=105.88750000000000230 peak=107.14
...
- Closed paper trades: **31/50** | ghost rows: **268/50** | PnL: **-20.70 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 63 / bull 0
- as_of: 2026-09-12T20:30:26Z
...
- Latest scan 2026-09-12T20:40:07: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 7, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 10, "regime_blocked": 726, "skipped": 12, "slice_full": 0, "slot_full": 145})
