# Breakwater daily print — 2026-09-18 16:03 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **417.52 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2037.77 ZAR** (seed 2000) | lifetime: **+37.77 ZAR** | closed: 127
- Today: 19 closed, **+72.37 ZAR**
- 7d: **+37.77 ZAR** | 30d: **+37.77 ZAR**
...
- Claimed edge (median mean_ret_costadj over 211 book slices present in the validated pools): +0.309% | at 100.25 ZAR mean notional/trade: +0.31 ZAR/trade
- Realised (127 real closes per lane_gate._is_real_close, net of fees): +0.30 ZAR/trade | sd 2.79 | SE 0.25
- Gap: -0.01 ZAR/trade | t = -0.05 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.341% over 190/194 slices (pool 520) ~ +0.34 ZAR | realised 97 closes +0.36 ZAR sd 2.94 SE 0.30 | gap +0.02 t +0.06 | NOT ESTABLISHED
...
- Ledger: 47116 decision rows; 127 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 46989 rows are skipped/guard decisions and never count
...
- Closed: 97 | wins: 43 | win%: 44.3 | P&L: **+34.87 ZAR** | today: +66.75 | 7d: +34.87 | 30d: +34.87
- By exit: horizon +71.4, target +38.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 30/+55.1, bull 1/-3.8, bear 66/-16.4
- Top slices: feat_ext_strength:2:LONG:h15 9n/6w +26.47; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42; feat_mean_rev_strength:0:LONG:h15 2n/2w +11.65; feat_trend_slope_20:2:LONG:h12 5n/5w +11.12
...
- Top pairs: SUIUSDC 3n +14.91; LINKUSDC 4n +9.69; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32; WLDUSDC 2n +7.00
...
- **NATIVE**: 8 open, stop-risk **23.26 ZAR**
  - HYPEUSDC BUY ntl=100 risk=3.90 bars=8 stop=84.41949999999999990 peak=87.834
  - KPEPEUSDC BUY ntl=100 risk=3.70 bars=10 stop=0.00354699999999999985 peak=0.003683
  - SOLUSDC BUY ntl=101 risk=3.17 bars=2 stop=102.41999999999999640 peak=105.74
  - LINKUSDC BUY ntl=100 risk=3.07 bars=9 stop=11.365500000000000295 peak=11.725
  - DOGEUSDC BUY ntl=100 risk=2.76 bars=5 stop=0.08341424999999999530 peak=0.085771
  - BNBUSDC BUY ntl=101 risk=2.44 bars=2 stop=728.2625000000000120 peak=746.31
  - BTCUSDC BUY ntl=102 risk=2.28 bars=1 stop=78266.50000000000005 peak=80061.0
  - ETHUSDC BUY ntl=100 risk=1.94 bars=5 stop=2459.6500000000000470 peak=2508.2

- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  - PARA:COHR SELL ntl=203 risk=7.42 bars=1 stop=320.19000000000001555 peak=308.91
  - PARA:CRDO SELL ntl=203 risk=5.19 bars=1 stop=177.76000000000000660 peak=173.33
  - PARA:AVGO SELL ntl=203 risk=3.55 bars=1 stop=365.313025 peak=359.03
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=1 stop=213.38999999999999740 peak=209.27
  - PARA:CRWD SELL ntl=102 risk=1.94 bars=1 stop=242.6625000000000040 peak=238.12
  - PARA:CIEN SELL ntl=102 risk=1.78 bars=1 stop=354.059475 peak=347.97

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **45.13 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **30/50** | ghost rows: **222/50** | PnL: **+2.90 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+71.30 | frozen=NO
...
- Latest scan 2026-09-18T15:17:22: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 121, "regime_blocked": 467, "skipped": 720, "slice_full": 0, "slot_full": 105})
