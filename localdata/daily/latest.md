# Breakwater daily print — 2026-09-24 14:43 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **496.87 ZAR** | high-water: **513.36 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2474.64 ZAR** (seed 2000) | lifetime: **+474.64 ZAR** | closed: 251
- Today: 2 closed, **-0.76 ZAR**
- 7d: **+522.76 ZAR** | 30d: **+474.64 ZAR**
...
- Book: 281 slices (native 256 | hip3 25); validated pools: native 631 | hip3 160; book slices absent from pools: 18
  ...
  - ... and 8 more
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.297% | at 168.58 ZAR mean notional/trade: +0.50 ZAR/trade
- Realised (251 real closes per lane_gate._is_real_close, net of fees): +1.89 ZAR/trade | sd 5.70 | SE 0.36
- Gap: +1.39 ZAR/trade | t = +3.86 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.314% over 242/256 slices (pool 631) ~ +0.56 ZAR | realised 213 closes +2.25 ZAR sd 5.95 SE 0.41 | gap +1.70 t +4.16 | EXCEEDS
...
- Ledger: 124996 decision rows; 251 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 124745 rows are skipped/guard decisions and never count
...
- Closed: 213 | wins: 126 | win%: 59.2 | P&L: **+480.27 ZAR** | today: -0.76 | 7d: +527.48 | 30d: +480.27
- By exit: target +506.4, horizon +86.1, regime_shift -11.9, stop -100.4
- By entry regime (n/pnl): neutral 66/+282.9, bull 81/+213.8, bear 66/-16.4
...
- Closed: 38 | wins: 22 | win%: 57.9 | P&L: **-5.63 ZAR** | today: +0.00 | 7d: -4.71 | 30d: -5.63
...
- **NATIVE**: 6 open, stop-risk **24.06 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.89 bars=7 stop=1.4427999999999999790 peak=1.5016
  - DOGEUSDC BUY ntl=125 risk=4.73 bars=7 stop=0.09086000000000000020 peak=0.094433
  - SOLUSDC BUY ntl=124 risk=4.23 bars=9 stop=111.4449999999999975 peak=115.38
  - BNBUSDC BUY ntl=124 risk=3.61 bars=11 stop=750.0500000000000280 peak=772.52
  - ETHUSDC BUY ntl=125 risk=3.37 bars=3 stop=2576.6000000000002520 peak=2648.0
  - BTCUSDC BUY ntl=124 risk=3.24 bars=22 stop=81796.74999999999985 peak=83989.0

- **HIP3**: 3 open, stop-risk **20.14 ZAR**
  - PARA:GLW SELL ntl=250 risk=9.65 bars=0 stop=161.20750000000001620 peak=155.21
  - PARA:IREN SELL ntl=250 risk=6.12 bars=0 stop=48.10275000000000105 peak=46.953
  - PARA:IGV SELL ntl=250 risk=4.37 bars=0 stop=108.546900 peak=106.68

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **44.20 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **38/50** | ghost rows: **428/50** | PnL: **-5.63 ZAR**
...
- Label: **neutral** | breadth bear=0.0 bull=0.3125 neutral=0.6875 | symbols=16
- confirmed_bear: **False** | confirmed_bull: **False** | flip: **False** | flipped_from: bull | consecutive_bear: 0 / bull 0
- as_of: 2026-09-24T14:00:26Z
...
- Native lane: **RED** | closed=20 pnl=-27.76 | frozen=YES
...
- Latest scan 2026-09-24T14:43:46: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 56, "regime_blocked": 367, "skipped": 818, "slice_full": 1, "slot_full": 0})
