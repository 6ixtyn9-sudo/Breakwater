# Breakwater daily print — 2026-09-20 15:43 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **424.83 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2214.77 ZAR** (seed 2000) | lifetime: **+214.77 ZAR** | closed: 178
- Today: 23 closed, **+94.44 ZAR**
- 7d: **+214.77 ZAR** | 30d: **+214.77 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 128.40 ZAR mean notional/trade: +0.60 ZAR/trade
- Realised (178 real closes per lane_gate._is_real_close, net of fees): +1.21 ZAR/trade | sd 4.07 | SE 0.31
- Gap: +0.61 ZAR/trade | t = +2.00 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.64 ZAR | realised 148 closes +1.43 ZAR sd 4.32 SE 0.36 | gap +0.80 t +2.24 | EXCEEDS
...
- Ledger: 68274 decision rows; 178 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 68096 rows are skipped/guard decisions and never count
...
- Closed: 148 | wins: 81 | win%: 54.7 | P&L: **+211.86 ZAR** | today: +94.44 | 7d: +211.86 | 30d: +211.86
- By exit: target +230.9, horizon +77.1, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 47/+188.8, bull 35/+39.5, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 26n/21w +161.38; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 21n +182.00; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 12 open, stop-risk **61.16 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=0 stop=21.98499999999999965 peak=22.51
  - BNBZAR BUY ntl=418 risk=8.23 bars=12 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=442 risk=7.74 bars=0 stop=157.583175 peak=160.39
  - BTCUSDC BUY ntl=421 risk=7.36 bars=11 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=10 stop=1289481.14250 peak=1312449.0
  - XRPUSDC BUY ntl=106 risk=4.03 bars=14 stop=1.3528500000000000140 peak=1.4064
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=1 stop=87.90974999999999825 peak=90.96
  - SOLUSDC BUY ntl=105 risk=3.24 bars=12 stop=104.35250000000000130 peak=107.69
  - SOLZAR BUY ntl=110 risk=2.47 bars=2 stop=1728.2499999999999970 peak=1768.0
  - BNBUSDC BUY ntl=105 risk=2.34 bars=12 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=12 stop=2516.6249999999998140 peak=2573.3
  - LTCZAR BUY ntl=109 risk=2.08 bars=3 stop=920.99999999999993625 peak=938.9
...
- Computed open stop-risk (section 4): **61.16 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=26n/+161.38
...
- Native lane: **GREEN** | closed=20 pnl=+99.23 | frozen=NO
...
- Latest scan 2026-09-20T15:43:37: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 9, "regime_blocked": 290, "skipped": 886, "slice_full": 0, "slot_full": 0})
