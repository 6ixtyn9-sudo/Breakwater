# Breakwater daily print — 2026-09-26 04:16 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **539.79 ZAR** | high-water: **560.11 ZAR**
...
- Ledger: 147436 decision rows; 266 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 147170 rows are skipped/guard decisions and never count
...
- **NATIVE**: 3 open, stop-risk **9.13 ZAR**
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=21 stop=88.47099999999999610 peak=91.951
  - BNBUSDC BUY ntl=126 risk=2.20 bars=16 stop=763.59900 peak=777.2
  - BTCUSDC BUY ntl=125 risk=2.19 bars=19 stop=82556.52750 peak=84027.0
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 26, "skipped": 26, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 2, "signals": 790, "skipped": 788, "slice_full": 0, "slot_full": 0}}
...
- Latest scan 2026-09-26T03:34:37: errors=0 signals=816 regime_blocked=357
- this cycle: closed=0 new_signals=816 skipped=814 slot_full=0 slice_full=0 pair_held=2
- Action funnel: regime_blocked=357 | lane_gate_blocked=7 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=2 | slot_full=0 | skipped=814
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 7, "pair_held": 2, "regime_blocked": 357, "skipped": 814, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=16 blocks=13
- aggregate_risk: ok open=38.7200 cap=175.5709 used=0.2473 remaining=132.1487 replayed=3 no_new_bars=3
- pair_errors: []
