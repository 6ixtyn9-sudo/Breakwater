# Breakwater daily print — 2026-09-17 02:11 UTC
...
- Ledger: 29081 decision rows; 88 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 28993 rows are skipped/guard decisions and never count
...
- **NATIVE**: 12 open, stop-risk **46.85 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=5 stop=10.568250000000000175 peak=10.99
  - DOGEUSDC BUY ntl=195 risk=6.51 bars=6 stop=0.07773975000000000430 peak=0.080417
  - WLDUSDC BUY ntl=98 risk=4.59 bars=7 stop=0.349429999999999955 peak=0.36664
  - TRUMPUSDC BUY ntl=98 risk=4.47 bars=7 stop=1.7770750000000000540 peak=1.8622
  - ZECUSDC SELL ntl=98 risk=4.40 bars=7 stop=1396.5035714285714 peak=1336.3
  - SUIUSDC BUY ntl=98 risk=3.82 bars=7 stop=0.6670574999999999860 peak=0.6942
  - PUMPUSDC SELL ntl=98 risk=3.79 bars=9 stop=0.003815571428571429 peak=0.003674
  - TAOUSDC BUY ntl=98 risk=3.74 bars=7 stop=209.3224999999999935 peak=217.66
  - SOLUSDC BUY ntl=98 risk=2.91 bars=7 stop=94.85499999999999515 peak=97.766
  - BTCUSDC BUY ntl=98 risk=2.32 bars=2 stop=74370.75000000000010 peak=76180.0
  - BNBUSDC BUY ntl=98 risk=2.06 bars=7 stop=700.2850000000000755 peak=715.4
  - PUMPUSDT SELL ntl=98 risk=0.74 bars=8 stop=0.0036834199999999997 peak=0.003656

- **HIP3**: 5 open, stop-risk **9.50 ZAR**
  - PARA:CRDO SELL ntl=98 risk=3.72 bars=7 stop=167.7850000000000085 peak=161.63
...
- Label: **neutral** | breadth bear=0.2333 bull=0.1333 neutral=0.6333 | symbols=30
- confirmed_bear: **False** | confirmed_bull: **False** | flip: **False** | flipped_from: bear | consecutive_bear: 0 / bull 0
- as_of: 2026-09-17T02:00:31Z
...
- Latest scan 2026-09-17T02:11:02: errors=3 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 2, "pair_held": 15, "regime_blocked": 242, "skipped": 19, "slice_full": 0, "slot_full": 93})
