# Breakwater daily print — 2026-09-13 09:10 UTC
...
- Ledger: 182635 decision rows; 143 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 182492 rows are skipped/guard decisions and never count
...
- Closed paper trades: **34/50** | ghost rows: **507/50** | PnL: **-30.92 ZAR**
...
- Latest scan 2026-09-13T09:10:03: errors=3 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 9, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 11, "regime_blocked": 639, "skipped": 16, "slice_full": 8, "slot_full": 96})
