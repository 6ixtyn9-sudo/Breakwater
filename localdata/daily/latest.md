# Breakwater daily print — 2026-09-23 04:34 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **468.57 ZAR** | high-water: **474.55 ZAR**
...
- Ledger: 102826 decision rows; 236 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 102590 rows are skipped/guard decisions and never count
...
- Closed: 198 | wins: 119 | win%: 60.1 | P&L: **+495.78 ZAR** | today: -8.49 | 7d: +514.79 | 30d: +495.78
...
- **NATIVE**: 8 open, stop-risk **49.54 ZAR**
  - SOLZAR BUY ntl=500 risk=12.74 bars=6 stop=1874.00 peak=1923.0
  - BNBZAR BUY ntl=498 risk=9.31 bars=4 stop=12582.25 peak=12822.0
  - ETHZAR BUY ntl=499 risk=8.90 bars=11 stop=43931.250000000000030 peak=44729.0
  - HYPEUSDC BUY ntl=126 risk=4.80 bars=23 stop=89.96399999999999715 peak=93.542
  - SOLUSDC BUY ntl=125 risk=4.60 bars=13 stop=112.66499999999999845 peak=116.98
  - ETHUSDC BUY ntl=125 risk=3.30 bars=20 stop=2656.3000000000001325 peak=2728.2
  - BNBUSDC BUY ntl=125 risk=3.06 bars=13 stop=768.0850000000000135 peak=787.38
  - BTCUSDC BUY ntl=125 risk=2.83 bars=12 stop=84492.50000000000015 peak=86453.0

- **HIP3**: 3 open, stop-risk **11.17 ZAR**
  - PARA:COHR SELL ntl=125 risk=4.68 bars=14 stop=335.5075000000000165 peak=323.4
  - PARA:AVGO SELL ntl=125 risk=4.31 bars=10 stop=376.0024999999999655 peak=363.48
  - PARA:IGV SELL ntl=125 risk=2.19 bars=13 stop=108.587600 peak=106.72
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 56
- as_of: 2026-09-23T04:00:27Z
...
- Latest scan 2026-09-23T04:34:38: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 28, "regime_blocked": 754, "skipped": 629, "slice_full": 0, "slot_full": 0})
