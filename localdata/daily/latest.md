# Breakwater daily print — 2026-09-21 05:14 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **436.29 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2321.32 ZAR** (seed 2000) | lifetime: **+321.32 ZAR** | closed: 190
- Today: 5 closed, **+43.24 ZAR**
- 7d: **+321.32 ZAR** | 30d: **+321.32 ZAR**
...
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.382% | at 141.34 ZAR mean notional/trade: +0.54 ZAR/trade
- Realised (190 real closes per lane_gate._is_real_close, net of fees): +1.69 ZAR/trade | sd 4.57 | SE 0.33
- Gap: +1.15 ZAR/trade | t = +3.47 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.388% over 242/245 slices (pool 676) ~ +0.58 ZAR | realised 160 closes +1.99 ZAR sd 4.83 SE 0.38 | gap +1.41 t +3.69 | EXCEEDS
...
- Ledger: 74694 decision rows; 190 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 74504 rows are skipped/guard decisions and never count
...
- Closed: 160 | wins: 92 | win%: 57.5 | P&L: **+318.42 ZAR** | today: +43.24 | 7d: +318.42 | 30d: +318.42
- By exit: target +332.2, horizon +82.4, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 55/+258.5, bull 39/+76.4, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 34n/29w +262.67; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- **NATIVE**: 12 open, stop-risk **55.44 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=12 stop=21.98499999999999965 peak=22.51
  - BTCUSDC BUY ntl=421 risk=7.36 bars=23 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=22 stop=1289481.14250 peak=1312449.0
  - SOLZAR BUY ntl=231 risk=5.81 bars=2 stop=1751.7499999999999985 peak=1797.0
  - LTCZAR BUY ntl=229 risk=4.57 bars=3 stop=920.200000000000010 peak=938.9
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=13 stop=87.90974999999999825 peak=90.96
  - SOLUSDC BUY ntl=113 risk=3.34 bars=7 stop=107.21000000000000570 peak=110.47
  - XRPUSDC BUY ntl=111 risk=3.27 bars=11 stop=1.3499000000000000060 peak=1.3908
  - XRPUSDC BUY ntl=112 risk=3.04 bars=9 stop=1.3651500000000000695 peak=1.4031
  - ETHUSDC BUY ntl=113 risk=2.61 bars=7 stop=2572.9500000000001090 peak=2633.7
  - BNBUSDC BUY ntl=112 risk=2.12 bars=9 stop=750.087499999999995 peak=764.52
  - BTCUSDC BUY ntl=111 risk=1.94 bars=11 stop=79512.74250 peak=80929.0
...
- Computed open stop-risk (section 4): **55.44 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0036 n=10058 p=0.0066 src=validated_walk_forward unproven=False paper=34n/+262.67
...
- Label: **bull** | breadth bear=0.0667 bull=0.8667 neutral=0.0667 | symbols=15
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 9
- as_of: 2026-09-21T04:35:29Z
...
- Native lane: **GREEN** | closed=20 pnl=+182.72 | frozen=NO
...
- Latest scan 2026-09-21T03:24:06: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 86, "regime_blocked": 557, "skipped": 838, "slice_full": 0, "slot_full": 0})
