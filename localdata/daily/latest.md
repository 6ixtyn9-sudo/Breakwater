# Breakwater daily print — 2026-09-10 05:38 UTC
...
- **NATIVE**: 2 open, stop-risk **25.30 ZAR**
  - ASTERUSDC BUY ntl=383 risk=15.45 bars=12 stop=0.7107175000000000190 peak=0.74063
  - ETHUSDC BUY ntl=380 risk=9.85 bars=9 stop=2400.949999999999975 peak=2464.8

- **HIP3**: 5 open, stop-risk **14.47 ZAR**
  - XYZ:ASML BUY ntl=391 risk=6.90 bars=16 stop=1711.2750000000000930 peak=1742.0
  - XYZ:EWJ BUY ntl=382 risk=3.96 bars=14 stop=96.215500000000005610 peak=97.224
  - XYZ:COST BUY ntl=391 risk=2.63 bars=14 stop=895.06499999999997360 peak=901.13
  - XYZ:STRC BUY ntl=383 risk=0.97 bars=13 stop=97.718250000000000090 peak=97.966
  - XYZ:CRWD BUY ntl=393 risk=0.00 bars=40 stop=206.840000000000005950 peak=210.62
...
- positions without bars: 5 | replayed: 3 | invalid: 0
...
- Latest scan 2026-09-10T05:38:15: errors=0 signals=None regime_blocked=None
...
- aggregate_risk: ok open=39.7693 cap=130.2791 used=0.3571 remaining=83.7538 replayed=3 no_new_bars=5
- pair_errors: []
