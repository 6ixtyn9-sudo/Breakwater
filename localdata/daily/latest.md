# Breakwater daily print — 2026-09-24 13:44 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **500.12 ZAR** | high-water: **513.36 ZAR**
...
- Book: 277 slices (native 252 | hip3 25); validated pools: native 631 | hip3 160; book slices absent from pools: 18
  ...
  - ... and 8 more
- Claimed edge (median mean_ret_costadj over 259 book slices present in the validated pools): +0.296% | at 168.58 ZAR mean notional/trade: +0.50 ZAR/trade
...
- native: claimed median +0.313% over 238/252 slices (pool 631) ~ +0.56 ZAR | realised 213 closes +2.25 ZAR sd 5.95 SE 0.41 | gap +1.70 t +4.16 | EXCEEDS
