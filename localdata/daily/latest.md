# Breakwater daily print — 2026-09-16 17:24 UTC
...
- Equity: **1961.35 ZAR** (seed 2000) | lifetime: **-38.65 ZAR** | closed: 74
- Today: 35 closed, **-27.06 ZAR**
- 7d: **-38.65 ZAR** | 30d: **-38.65 ZAR**
...
- Realised (74 real closes per lane_gate._is_real_close, net of fees): -0.52 ZAR/trade | sd 1.95 | SE 0.23
- Gap: -0.65 ZAR/trade | t = -2.87 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.188% over 5/13 slices (pool 14) ~ +0.18 ZAR | realised 55 closes -0.86 ZAR sd 2.11 SE 0.29 | gap -1.04 t -3.65 | FALLS SHORT
...
- Ledger: 27294 decision rows; 74 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 27220 rows are skipped/guard decisions and never count
...
- Closed: 55 | wins: 11 | win%: 20.0 | P&L: **-47.09 ZAR** | today: -26.95 | 7d: -47.09 | 30d: -47.09
- By exit: target +9.9, horizon -3.7, regime_shift -12.5, stop -40.8
- By entry regime (n/pnl): bull 1/-3.8, neutral 11/-15.4, bear 43/-27.9
...
- **NATIVE**: 8 open, stop-risk **27.80 ZAR**
  - ARBUSDC SELL ntl=84 risk=4.94 bars=4 stop=0.17935714285714285 peak=0.16938
  - ZECUSDC SELL ntl=99 risk=4.46 bars=3 stop=1307.1714285714286 peak=1250.6
  - PUMPUSDC SELL ntl=98 risk=3.79 bars=0 stop=0.003815571428571429 peak=0.003674
  - FILUSDC SELL ntl=100 risk=3.73 bars=14 stop=0.8434728571428572 peak=0.81303
  - NEARUSDC SELL ntl=99 risk=3.56 bars=3 stop=2.555557142857143 peak=2.4664
  - LITUSDC SELL ntl=99 risk=3.47 bars=6 stop=4.453957142857143 peak=4.3036
  - PENDLEUSDC SELL ntl=98 risk=2.86 bars=2 stop=2.2190 peak=2.1563
  - SHIBUSDT SELL ntl=98 risk=0.98 bars=2 stop=0.0000048177000000000005 peak=0.00000477

- **HIP3**: 6 open, stop-risk **11.88 ZAR**
  - PARA:COHR SELL ntl=99 risk=3.38 bars=3 stop=294.5500000000000190 peak=284.79
  - PARA:IREN SELL ntl=98 risk=2.75 bars=1 stop=44.663250000000000375 peak=43.45
  - PARA:CRDO SELL ntl=99 risk=2.34 bars=3 stop=164.02500000000001420 peak=160.22
  - PARA:CIEN SELL ntl=99 risk=1.73 bars=3 stop=347.15249999999997345 peak=341.17
  - PARA:GLW SELL ntl=99 risk=1.18 bars=0 stop=148.99000000000001205 peak=147.23
  - PARA:AVGO SELL ntl=99 risk=0.51 bars=3 stop=344.77249999999998465 peak=342.99

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **39.68 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **19/50** | ghost rows: **70/50** | PnL: **+8.44 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 23 / bull 0
- as_of: 2026-09-16T17:13:22Z
...
- Native lane: **RED** | closed=20 pnl=-28.07 | frozen=YES
...
- Latest scan 2026-09-16T17:24:08: errors=5 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `slot_full` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 2, "pair_held": 27, "regime_blocked": 68, "skipped": 17, "slice_full": 0, "slot_full": 164})
