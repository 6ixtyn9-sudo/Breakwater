# Breakwater daily print — 2026-09-18 21:36 UTC
...
- Equity: **2057.34 ZAR** (seed 2000) | lifetime: **+57.34 ZAR** | closed: 131
- Today: 23 closed, **+91.94 ZAR**
- 7d: **+57.34 ZAR** | 30d: **+57.34 ZAR**
...
- Realised (131 real closes per lane_gate._is_real_close, net of fees): +0.44 ZAR/trade | sd 2.87 | SE 0.25
- Gap: +0.13 ZAR/trade | t = +0.51 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.341% over 190/194 slices (pool 520) ~ +0.34 ZAR | realised 101 closes +0.54 ZAR sd 3.02 SE 0.30 | gap +0.20 t +0.65 | NOT ESTABLISHED
...
- Ledger: 50603 decision rows; 131 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 50472 rows are skipped/guard decisions and never count
...
- Closed: 101 | wins: 47 | win%: 46.5 | P&L: **+54.44 ZAR** | today: +86.32 | 7d: +54.44 | 30d: +54.44
- By exit: horizon +80.9, target +48.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 32/+64.2, bull 3/+6.7, bear 66/-16.4
- Top slices: feat_ext_strength:2:LONG:h15 9n/6w +26.47; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42; feat_mean_rev_strength:0:LONG:h15 2n/2w +11.65
...
- **NATIVE**: 6 open, stop-risk **18.60 ZAR**
  - LINKUSDC BUY ntl=103 risk=3.95 bars=0 stop=11.87724999999999980 peak=12.352
  - HYPEUSDC BUY ntl=100 risk=3.90 bars=14 stop=84.41949999999999990 peak=87.834
  - ETHUSDC BUY ntl=102 risk=3.28 bars=4 stop=2515.0250000000000945 peak=2598.5
  - DOGEUSDC BUY ntl=100 risk=2.76 bars=11 stop=0.08341424999999999530 peak=0.085771
  - BNBUSDC BUY ntl=101 risk=2.44 bars=8 stop=728.2625000000000120 peak=746.31
  - BTCUSDC BUY ntl=102 risk=2.28 bars=7 stop=78266.50000000000005 peak=80061.0

- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  - PARA:COHR SELL ntl=203 risk=7.42 bars=7 stop=320.19000000000001555 peak=308.91
  - PARA:CRDO SELL ntl=203 risk=5.19 bars=7 stop=177.76000000000000660 peak=173.33
  - PARA:AVGO SELL ntl=203 risk=3.55 bars=7 stop=365.313025 peak=359.03
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=7 stop=213.38999999999999740 peak=209.27
  - PARA:CRWD SELL ntl=102 risk=1.94 bars=7 stop=242.6625000000000040 peak=238.12
  - PARA:CIEN SELL ntl=102 risk=1.78 bars=6 stop=354.059475 peak=347.97

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **40.48 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+87.00 | frozen=NO
...
- Latest scan 2026-09-18T21:36:44: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 71, "regime_blocked": 494, "skipped": 718, "slice_full": 0, "slot_full": 42})
