# Breakwater daily print — 2026-09-24 22:46 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **539.70 ZAR** | high-water: **560.11 ZAR**
...
- Ledger: 130421 decision rows; 252 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 130169 rows are skipped/guard decisions and never count
...
- Closed: 214 | wins: 127 | win%: 59.3 | P&L: **+480.78 ZAR** | today: -0.26 | 7d: +512.66 | 30d: +480.78
...
- **NATIVE**: 6 open, stop-risk **24.39 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.89 bars=15 stop=1.4427999999999999790 peak=1.5016
  - DOGEUSDC BUY ntl=125 risk=4.73 bars=15 stop=0.09086000000000000020 peak=0.094433
  - SOLUSDC BUY ntl=124 risk=4.23 bars=17 stop=111.4449999999999975 peak=115.38
  - BNBUSDC BUY ntl=124 risk=3.61 bars=19 stop=750.0500000000000280 peak=772.52
  - BTCUSDC BUY ntl=125 risk=3.57 bars=6 stop=81996.50000000000005 peak=84407.0
  - ETHUSDC BUY ntl=125 risk=3.37 bars=11 stop=2576.6000000000002520 peak=2648.0
...
- **HIP3**: 3 open, stop-risk **20.14 ZAR**
  ...
  - PARA:IGV SELL ntl=250 risk=4.37 bars=7 stop=108.546900 peak=106.68

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **44.53 ZAR** (informational only, no cap applied)
- Paper shadow ledger (gates paper entries only, nothing live): **44.53 / 174.85 ZAR | 27.6% | ok**
- Remaining: 126.5790 | cap skips: 0 | unknown skips: 0
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 17, "skipped": 16, "slice_full": 1, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 58, "signals": 824, "skipped": 766, "slice_full": 0, "slot_full": 0}}
...
- Label: **neutral** | breadth bear=0.0588 bull=0.4706 neutral=0.4706 | symbols=17
- confirmed_bear: **False** | confirmed_bull: **False** | flip: **False** | flipped_from: bull | consecutive_bear: 0 / bull 0
- as_of: 2026-09-24T22:00:27Z
...
- Latest scan 2026-09-24T22:46:41: errors=0 signals=841 regime_blocked=565
- this cycle: closed=0 new_signals=841 skipped=782 slot_full=0 slice_full=1 pair_held=58
- Action funnel: regime_blocked=565 | lane_gate_blocked=8 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=1 | pair_held=58 | slot_full=0 | skipped=782
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 58, "regime_blocked": 565, "skipped": 782, "slice_full": 1, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=44.5279 cap=174.8493 used=0.2761 remaining=126.5790 replayed=6 no_new_bars=3
- pair_errors: []
