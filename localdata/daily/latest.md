# Breakwater daily print — 2026-09-19 13:20 UTC
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.467% | at 102.67 ZAR mean notional/trade: +0.48 ZAR/trade
- Realised (145 real closes per lane_gate._is_real_close, net of fees): +0.72 ZAR/trade | sd 2.92 | SE 0.24
- Gap: +0.24 ZAR/trade | t = +0.99 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.495% over 244/247 slices (pool 719) ~ +0.51 ZAR | realised 115 closes +0.88 ZAR sd 3.06 SE 0.29 | gap +0.37 t +1.30 | NOT ESTABLISHED
