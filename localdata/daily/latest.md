# Breakwater daily print — 2026-09-14 08:10 UTC
...
- Ledger: 206146 decision rows; 163 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 205983 rows are skipped/guard decisions and never count
...
- Closed: 127 | wins: 50 | win%: 39.4 | P&L: **-227.74 ZAR** | today: +6.18 | 7d: -252.56 | 30d: -227.74
...
- **NATIVE**: 12 open, stop-risk **101.59 ZAR**
  - FARTCOINUSDC BUY ntl=346 risk=14.51 bars=0 stop=0.13682999999999998695 peak=0.14281
  - KPEPEUSDC BUY ntl=346 risk=12.86 bars=0 stop=0.0033209999999999996060 peak=0.003449
  - SUIUSDC BUY ntl=346 risk=12.45 bars=0 stop=0.6968774999999999360 peak=0.72285
  - HYPEUSDC BUY ntl=346 risk=11.95 bars=0 stop=77.02799999999999990 peak=79.781
  - LINKUSDC BUY ntl=346 risk=9.83 bars=0 stop=11.065749999999999745 peak=11.389
  - LTCUSDC BUY ntl=346 risk=9.52 bars=0 stop=52.39975000000000010 peak=53.88
  - DOGEUSDC BUY ntl=346 risk=9.09 bars=0 stop=0.08197800000000000085 peak=0.084187
  - SOLUSDC BUY ntl=346 risk=8.43 bars=0 stop=99.00075000000000455 peak=101.47
  - ETHUSDC BUY ntl=346 risk=7.29 bars=0 stop=2467.3749999999997935 peak=2520.4
  - BNBUSDC BUY ntl=346 risk=5.67 bars=0 stop=712.49750000000004510 peak=724.36
  - BTCUSDC BUY ntl=346 risk=0.00 bars=18 stop=77208.7500000000000200 peak=77859.0
  - XRPUSDC BUY ntl=347 risk=0.00 bars=12 stop=1.36360000000000002900 peak=1.3906

- **HIP3**: 1 open, stop-risk **0.00 ZAR**
  - XYZ:COST BUY ntl=364 risk=0.00 bars=66 stop=905.502500000000054400 peak=909.5

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **101.59 ZAR** (informational only, no cap applied)
...
- Latest scan 2026-09-14T08:10:12: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 12, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 34, "regime_blocked": 495, "skipped": 39, "slice_full": 2, "slot_full": 90})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=1 blocks=20
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:EWT"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:STRC"}]
