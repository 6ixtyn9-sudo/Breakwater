# Breakwater daily print — 2026-09-12 23:54 UTC
...
- Ledger: 170678 decision rows; 131 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 170547 rows are skipped/guard decisions and never count
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 68 / bull 0
- as_of: 2026-09-12T23:45:25Z
...
- Latest scan 2026-09-12T23:54:51: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 5, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 6, "regime_blocked": 720, "skipped": 8, "slice_full": 0, "slot_full": 152})
