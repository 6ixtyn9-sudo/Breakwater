# Breakwater daily print — 2026-09-25 09:45 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **537.78 ZAR** | high-water: **560.11 ZAR**
...
- Equity: **2490.92 ZAR** (seed 2000) | lifetime: **+490.92 ZAR** | closed: 258
- Today: 5 closed, **+15.22 ZAR**
- 7d: **+487.92 ZAR** | 30d: **+490.92 ZAR**
...
- Book: 294 slices (native 269 | hip3 25); validated pools: native 546 | hip3 160; book slices absent from pools: 14
  ...
  - ... and 4 more
- Claimed edge (median mean_ret_costadj over 280 book slices present in the validated pools): +0.270% | at 167.87 ZAR mean notional/trade: +0.45 ZAR/trade
- Realised (258 real closes per lane_gate._is_real_close, net of fees): +1.90 ZAR/trade | sd 5.67 | SE 0.35
- Gap: +1.45 ZAR/trade | t = +4.11 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.279% over 259/269 slices (pool 546) ~ +0.49 ZAR | realised 219 closes +2.21 ZAR sd 5.88 SE 0.40 | gap +1.72 t +4.33 | EXCEEDS
...
- Ledger: 137478 decision rows; 258 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 137220 rows are skipped/guard decisions and never count
...
- Closed: 219 | wins: 131 | win%: 59.8 | P&L: **+484.54 ZAR** | today: +3.21 | 7d: +484.07 | 30d: +484.54
- By exit: target +506.4, horizon +90.3, regime_shift -11.9, stop -100.4
- By entry regime (n/pnl): neutral 72/+287.2, bull 81/+213.8, bear 66/-16.4
...
- **NATIVE**: 6 open, stop-risk **21.79 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.79 bars=2 stop=1.4715999999999999645 peak=1.5302
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=3 stop=88.47099999999999610 peak=91.951
  - SOLUSDC BUY ntl=125 risk=3.90 bars=4 stop=112.73749999999999790 peak=116.36
  - ETHUSDC BUY ntl=125 risk=3.37 bars=22 stop=2576.6000000000002520 peak=2648.0
  - BNBUSDC BUY ntl=125 risk=2.82 bars=10 stop=759.185000000000005 peak=776.69
  - BTCUSDC BUY ntl=125 risk=2.19 bars=1 stop=82556.52750 peak=84027.0

- **HIP3**: 2 open, stop-risk **14.02 ZAR**
  - PARA:GLW SELL ntl=250 risk=9.65 bars=19 stop=161.20750000000001620 peak=155.21
  - PARA:IGV SELL ntl=250 risk=4.37 bars=19 stop=108.546900 peak=106.68

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **35.81 ZAR** (informational only, no cap applied)
- Paper shadow ledger (gates paper entries only, nothing live): **35.81 / 175.95 ZAR | 22.1% | ok**
- Remaining: 137.0177 | cap skips: 0 | unknown skips: 0
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 41, "skipped": 41, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 23, "signals": 831, "skipped": 808, "slice_full": 0, "slot_full": 0}}
...
- Closed paper trades: **39/50** | ghost rows: **438/50** | PnL: **+6.38 ZAR**
...
- Native lane: **RED** | closed=20 pnl=-16.51 | frozen=YES
...
- Latest scan 2026-09-25T09:45:58: errors=0 signals=872 regime_blocked=538
- this cycle: closed=1 new_signals=872 skipped=849 slot_full=0 slice_full=0 pair_held=23
- Action funnel: regime_blocked=538 | lane_gate_blocked=6 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=23 | slot_full=0 | skipped=849
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 23, "regime_blocked": 538, "skipped": 849, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=35.8118 cap=175.9536 used=0.2213 remaining=137.0177 replayed=13 no_new_bars=0
- pair_errors: []
