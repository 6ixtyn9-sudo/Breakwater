# Breakwater daily print — 2026-09-18 17:39 UTC
...
- Equity: **2041.57 ZAR** (seed 2000) | lifetime: **+41.57 ZAR** | closed: 128
- Today: 20 closed, **+76.16 ZAR**
- 7d: **+41.57 ZAR** | 30d: **+41.57 ZAR**
...
- Realised (128 real closes per lane_gate._is_real_close, net of fees): +0.32 ZAR/trade | sd 2.80 | SE 0.25
- Gap: +0.01 ZAR/trade | t = +0.06 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.341% over 190/194 slices (pool 520) ~ +0.34 ZAR | realised 98 closes +0.39 ZAR sd 2.95 SE 0.30 | gap +0.05 t +0.18 | NOT ESTABLISHED
...
- Ledger: 48223 decision rows; 128 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 48095 rows are skipped/guard decisions and never count
...
- Closed: 98 | wins: 44 | win%: 44.9 | P&L: **+38.67 ZAR** | today: +70.54 | 7d: +38.67 | 30d: +38.67
- By exit: horizon +71.4, target +42.6, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 31/+58.9, bull 1/-3.8, bear 66/-16.4
...
- **NATIVE**: 8 open, stop-risk **24.59 ZAR**
  - HYPEUSDC BUY ntl=100 risk=3.90 bars=10 stop=84.41949999999999990 peak=87.834
  - KPEPEUSDC BUY ntl=100 risk=3.70 bars=12 stop=0.00354699999999999985 peak=0.003683
  - ETHUSDC BUY ntl=102 risk=3.28 bars=0 stop=2515.0250000000000945 peak=2598.5
  - SOLUSDC BUY ntl=101 risk=3.17 bars=4 stop=102.41999999999999640 peak=105.74
  - LINKUSDC BUY ntl=100 risk=3.07 bars=11 stop=11.365500000000000295 peak=11.725
  - DOGEUSDC BUY ntl=100 risk=2.76 bars=7 stop=0.08341424999999999530 peak=0.085771
  - BNBUSDC BUY ntl=101 risk=2.44 bars=4 stop=728.2625000000000120 peak=746.31
  - BTCUSDC BUY ntl=102 risk=2.28 bars=3 stop=78266.50000000000005 peak=80061.0

- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  - PARA:COHR SELL ntl=203 risk=7.42 bars=3 stop=320.19000000000001555 peak=308.91
  - PARA:CRDO SELL ntl=203 risk=5.19 bars=3 stop=177.76000000000000660 peak=173.33
  - PARA:AVGO SELL ntl=203 risk=3.55 bars=3 stop=365.313025 peak=359.03
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=3 stop=213.38999999999999740 peak=209.27
  - PARA:CRWD SELL ntl=102 risk=1.94 bars=3 stop=242.6625000000000040 peak=238.12
  - PARA:CIEN SELL ntl=102 risk=1.78 bars=3 stop=354.059475 peak=347.97

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **46.47 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+74.02 | frozen=NO
...
- Latest scan 2026-09-18T17:39:11: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 112, "regime_blocked": 443, "skipped": 678, "slice_full": 0, "slot_full": 99})
