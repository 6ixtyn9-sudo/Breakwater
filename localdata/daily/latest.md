# Breakwater daily print — 2026-09-12 22:10 UTC
...
- Equity: **1765.16 ZAR** (seed 2000) | lifetime: **-234.84 ZAR** | closed: 131
- Today: 6 closed, **-1.56 ZAR**
- 7d: **-195.90 ZAR** | 30d: **-234.84 ZAR**

## 2b. Claimed vs realised

- Book: 49 slices (native 32 | hip3 17); validated pools: native 524 | hip3 464; book slices absent from pools: 0
- Claimed edge (median mean_ret_costadj over 49 book slices present in the validated pools): +0.428% | at 382.79 ZAR mean notional/trade: +1.64 ZAR/trade
- Realised (131 real closes per lane_gate._is_real_close, net of fees): -1.79 ZAR/trade | sd 8.44 | SE 0.74
...
- Ledger: 169209 decision rows; 131 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 169078 rows are skipped/guard decisions and never count
...
- Closed: 100 | wins: 40 | win%: 40.0 | P&L: **-214.15 ZAR** | today: -1.56 | 7d: -190.35 | 30d: -214.15
- By exit: target +101.5, trail_stop +45.1, lane_gate +7.6, rotated -47.9, horizon -98.8, stop -221.6
- By entry regime (n/pnl): bull 25/+9.3, bear 25/-12.1, neutral 50/-211.4
...
- **NATIVE**: 11 open, stop-risk **88.85 ZAR**
  - ARBUSDC BUY ntl=342 risk=17.66 bars=14 stop=0.1367324999999999930 peak=0.14417
  - INJUSDC BUY ntl=353 risk=17.52 bars=14 stop=5.670149999999999605 peak=5.9661
  - HYPEUSDC BUY ntl=353 risk=10.99 bars=14 stop=76.49774999999999815 peak=78.955
  - KPEPEUSDC BUY ntl=353 risk=9.52 bars=14 stop=0.003256750000000000055 peak=0.003347
  - LTCUSDC BUY ntl=353 risk=7.61 bars=12 stop=52.93850000000000305 peak=54.106
  - ASTERUSDC BUY ntl=353 risk=7.49 bars=0 stop=0.6719625000000000010 peak=0.68652
  - SUIUSDC BUY ntl=353 risk=5.72 bars=3 stop=0.71029750000000001525 peak=0.72198
  - BNBUSDC BUY ntl=353 risk=4.98 bars=12 stop=725.1625000000000595 peak=735.54
  - XRPUSDC BUY ntl=353 risk=3.86 bars=3 stop=1.3481250000000000840 peak=1.363
  - DOGEUSDC BUY ntl=353 risk=3.50 bars=3 stop=0.083883749999999989905 peak=0.084723
  - XMRUSDC BUY ntl=355 risk=0.00 bars=26 stop=526.16999999999998150 peak=545.65
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  ...
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=27 stop=283.88000000000002330 peak=287.39
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=27 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=32 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=30 stop=98.1800000000000016850 peak=98.385

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **108.38 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **31/50** | ghost rows: **298/50** | PnL: **-20.70 ZAR**
...
- Label: **bear** | breadth bear=0.5667 bull=0.1 neutral=0.3333 | symbols=30
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 66 / bull 0
- as_of: 2026-09-12T22:00:30Z
...
- Native lane: **RED** | closed=20 pnl=-32.61 | frozen=YES
...
- Latest scan 2026-09-12T22:10:24: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 8, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 6, "regime_blocked": 731, "skipped": 15, "slice_full": 0, "slot_full": 131})
