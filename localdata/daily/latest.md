# Breakwater daily print — 2026-09-13 15:56 UTC
...
- Ledger: 190702 decision rows; 146 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 190556 rows are skipped/guard decisions and never count
...
- Closed paper trades: **34/50** | ghost rows: **597/50** | PnL: **-30.92 ZAR**
...
- Latest scan 2026-09-13T15:39:26: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 22, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 24, "regime_blocked": 592, "skipped": 29, "slice_full": 0, "slot_full": 80})
