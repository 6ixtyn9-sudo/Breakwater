# Breakwater daily print — 2026-09-12 09:58 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **400.72 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 148302 decision rows; 128 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 148174 rows are skipped/guard decisions and never count
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  ...
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=15 stop=109.37749999999999265 peak=110.76
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=13 stop=283.88000000000002330 peak=287.39
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=15 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=19 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=18 stop=98.1800000000000016850 peak=98.385
...
- Latest scan 2026-09-12T09:37:26: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 54, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 43, "regime_blocked": 665, "skipped": 118, "slice_full": 0, "slot_full": 0})
