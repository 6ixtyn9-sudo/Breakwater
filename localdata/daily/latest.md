# Breakwater daily print — 2026-09-09 06:41 UTC
...
- Mode: **readonly** | VALR equity: **401.77 ZAR** | high-water: **435.05 ZAR**
...
- **NATIVE**: 8 open, stop-risk **116.43 ZAR**
  - UNIUSDC BUY ntl=334 risk=19.57 bars=14 stop=6.516825000000000045 peak=6.9228
  - JUPUSDC BUY ntl=373 risk=19.57 bars=14 stop=0.22997250000000001170 peak=0.24272
  - ASTERUSDC BUY ntl=391 risk=17.46 bars=14 stop=0.7296099999999999945 peak=0.76367
  - LINKUSDC BUY ntl=391 risk=16.08 bars=10 stop=12.02299999999999945 peak=12.538
  - LTCUSDC BUY ntl=391 risk=13.31 bars=14 stop=53.12149999999999945 peak=54.991
  - HYPEUSDC BUY ntl=391 risk=12.58 bars=14 stop=81.10949999999999880 peak=83.804
  - ETHUSDC BUY ntl=391 risk=10.28 bars=10 stop=2418.6750000000002090 peak=2483.9
  - BTCUSDC BUY ntl=391 risk=7.59 bars=10 stop=76983.749999999999960 peak=78506.0

- **HIP3**: 3 open, stop-risk **9.53 ZAR**
  - XYZ:DKNG BUY ntl=393 risk=5.87 bars=14 stop=23.333999999999998155 peak=23.688
  - XYZ:COST BUY ntl=391 risk=3.66 bars=15 stop=899.17999999999999060 peak=907.67
  - XYZ:CRWD BUY ntl=393 risk=0.00 bars=17 stop=206.840000000000005950 peak=210.62
...
- positions without bars: 9 | replayed: 2 | invalid: 0
...
- Label: **bull** | breadth bear=0.0333 bull=0.6667 neutral=0.3 | symbols=30
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: neutral | consecutive_bear: 0 / bull 110
- as_of: 2026-09-09T06:30:25Z
...
- Latest scan 2026-09-09T06:41:27: errors=1 signals=None regime_blocked=None
...
- aggregate_risk: warning open=125.9578 cap=136.9879 used=0.9967 remaining=0.4519 replayed=2 no_new_bars=9
