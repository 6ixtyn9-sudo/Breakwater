# Breakwater daily print — 2026-09-22 07:15 UTC
...
- Equity: **2503.07 ZAR** (seed 2000) | lifetime: **+503.07 ZAR** | closed: 223
- Today: 9 closed, **-42.44 ZAR**
- 7d: **+503.97 ZAR** | 30d: **+503.07 ZAR**
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 161.11 ZAR mean notional/trade: +0.66 ZAR/trade
- Realised (223 real closes per lane_gate._is_real_close, net of fees): +2.26 ZAR/trade | sd 5.82 | SE 0.39
- Gap: +1.59 ZAR/trade | t = +4.09 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.436% over 239/246 slices (pool 760) ~ +0.74 ZAR | realised 190 closes +2.74 ZAR sd 6.04 SE 0.44 | gap +2.00 t +4.57 | EXCEEDS
...
- Ledger: 90029 decision rows; 223 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 89806 rows are skipped/guard decisions and never count
...
- Closed: 190 | wins: 118 | win%: 62.1 | P&L: **+521.18 ZAR** | today: -21.43 | 7d: +526.06 | 30d: +521.18
- By exit: target +506.4, horizon +110.9, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 61/+292.2, bull 63/+245.4, bear 66/-16.4
...
- **NATIVE**: 7 open, stop-risk **56.59 ZAR**
  - BTCUSDC BUY ntl=509 risk=18.46 bars=9 stop=83480.24999999999985 peak=86621.0
  - BTCZAR BUY ntl=509 risk=16.49 bars=9 stop=1366578.2500000000010 peak=1412312.0
  - SOLUSDC BUY ntl=127 risk=4.86 bars=7 stop=114.44499999999999970 peak=118.98
  - HYPEUSDC BUY ntl=126 risk=4.80 bars=2 stop=89.96399999999999715 peak=93.542
  - ETHUSDC BUY ntl=121 risk=4.72 bars=19 stop=2620.5999999999998675 peak=2727.2
  - BNBUSDC BUY ntl=127 risk=3.91 bars=7 stop=775.7500000000000265 peak=800.28
  - BTCUSDC BUY ntl=127 risk=3.35 bars=6 stop=83664.25000000000005 peak=85933.0

- **HIP3**: 4 open, stop-risk **19.27 ZAR**
  - PARA:CIEN SELL ntl=248 risk=6.81 bars=17 stop=374.53749999999999845 peak=364.52
  - PARA:LRCX SELL ntl=254 risk=5.00 bars=11 stop=309.01249999999999675 peak=303.04
  - PARA:COHR SELL ntl=124 risk=4.27 bars=17 stop=337.78750000000002090 peak=326.53
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=17 stop=252.9599999999999910 peak=246.63

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **75.86 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **33/50** | ghost rows: **360/50** | PnL: **-18.11 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+152.59 | frozen=NO
...
- Latest scan 2026-09-22T07:15:54: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 4, "regime_blocked": 513, "skipped": 779, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=11
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:NCLD"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:SNXX"}]
