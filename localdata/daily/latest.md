# Breakwater daily print — 2026-09-13 21:35 UTC
...
- Ledger: 198266 decision rows; 149 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 198117 rows are skipped/guard decisions and never count
...
- **HIP3**: 3 open, stop-risk **10.24 ZAR**
  ...
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=51 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=55 stop=899.50250000000005440 peak=903.5
...
- Closed paper trades: **34/50** | ghost rows: **668/50** | PnL: **-30.92 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 108 / bull 0
- as_of: 2026-09-13T21:30:21Z
...
- Latest scan 2026-09-13T21:35:52: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 5, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 25, "regime_blocked": 608, "skipped": 12, "slice_full": 0, "slot_full": 133})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=5 blocks=19
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:MAGS"}]
