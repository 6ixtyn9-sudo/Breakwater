# Breakwater daily print — 2026-09-12 23:12 UTC
...
- Ledger: 169931 decision rows; 131 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 169800 rows are skipped/guard decisions and never count
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  ...
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=28 stop=109.37749999999999265 peak=110.76
...
- Closed paper trades: **31/50** | ghost rows: **318/50** | PnL: **-20.70 ZAR**
...
- Label: **bear** | breadth bear=0.5667 bull=0.1333 neutral=0.3 | symbols=30
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 67 / bull 0
- as_of: 2026-09-12T23:02:45Z
...
- Latest scan 2026-09-12T23:12:31: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 5, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 7, "regime_blocked": 708, "skipped": 8, "slice_full": 0, "slot_full": 145})
- green_gate: native_green=False hip3_green=True frozen=native islands=4 blocks=16
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:QCOM"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:XLE"}]
