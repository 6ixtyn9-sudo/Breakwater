# Breakwater daily print — 2026-09-22 01:40 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **393.00 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2538.78 ZAR** (seed 2000) | lifetime: **+538.78 ZAR** | closed: 218
- Today: 4 closed, **-6.73 ZAR**
- 7d: **+537.78 ZAR** | 30d: **+538.78 ZAR**

## 2b. Claimed vs realised

- Book: 269 slices (native 246 | hip3 23); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 258 book slices present in the validated pools): +0.410% | at 156.21 ZAR mean notional/trade: +0.64 ZAR/trade
- Realised (218 real closes per lane_gate._is_real_close, net of fees): +2.47 ZAR/trade | sd 5.69 | SE 0.39
- Gap: +1.83 ZAR/trade | t = +4.75 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.436% over 239/246 slices (pool 760) ~ +0.72 ZAR | realised 186 closes +2.94 ZAR sd 5.94 SE 0.44 | gap +2.22 t +5.10 | EXCEEDS
- hip3: claimed median +0.059% over 19/23 slices (pool 160) ~ +0.06 ZAR | realised 32 closes -0.25 ZAR sd 2.61 SE 0.46 | gap -0.31 t -0.68 | NOT ESTABLISHED
- Ledger: 86536 decision rows; 218 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 86318 rows are skipped/guard decisions and never count
...
- Closed: 186 | wins: 118 | win%: 63.4 | P&L: **+546.78 ZAR** | today: +4.17 | 7d: +546.78 | 30d: +546.78
- By exit: target +506.4, horizon +136.5, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 61/+292.2, bull 59/+271.0, bear 66/-16.4
...
- Top pairs: LINKZAR 28n +269.82; LTCZAR 8n +106.00; BTCUSDC 13n +26.22; XRPUSDC 11n +21.98; SOLZAR 4n +21.46
- Worst pairs: ZECUSDC 4n -11.98; NEARUSDC 3n -8.75; ETHZAR 2n -8.51; UNIUSDC 1n -4.19; PUMPUSDC 1n -3.88

### HIP3

- Closed: 32 | wins: 19 | win%: 59.4 | P&L: **-8.00 ZAR** | today: -10.90 | 7d: -9.00 | 30d: -8.00
...
- **NATIVE**: 10 open, stop-risk **103.03 ZAR**
  - BTCUSDC BUY ntl=509 risk=18.46 bars=3 stop=83480.24999999999985 peak=86621.0
  - SOLZAR BUY ntl=496 risk=17.31 bars=11 stop=1865.5000000000000025 peak=1933.0
  - BTCZAR BUY ntl=509 risk=16.49 bars=3 stop=1366578.2500000000010 peak=1412312.0
  - BNBZAR BUY ntl=503 risk=15.02 bars=10 stop=12643.499999999999985 peak=13033.0
  - ETHZAR BUY ntl=505 risk=14.47 bars=6 stop=43676.25 peak=44966.0
  - SOLUSDC BUY ntl=127 risk=4.86 bars=1 stop=114.44499999999999970 peak=118.98
  - ETHUSDC BUY ntl=121 risk=4.72 bars=13 stop=2620.5999999999998675 peak=2727.2
  - HYPEUSDC BUY ntl=124 risk=4.44 bars=11 stop=91.43674999999999890 peak=94.838
  - BNBUSDC BUY ntl=127 risk=3.91 bars=1 stop=775.7500000000000265 peak=800.28
  - BTCUSDC BUY ntl=127 risk=3.35 bars=0 stop=83664.25000000000005 peak=85933.0
...
- **HIP3**: 5 open, stop-risk **29.15 ZAR**
  ...
  - PARA:LRCX SELL ntl=254 risk=5.00 bars=0 stop=309.01249999999999675 peak=303.04
  - PARA:COHR SELL ntl=124 risk=4.27 bars=11 stop=337.78750000000002090 peak=326.53
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=11 stop=252.9599999999999910 peak=246.63

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **132.18 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **32/50** | ghost rows: **305/50** | PnL: **-8.00 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+201.67 | frozen=NO
...
- Tradable slices: native **191/246** | hip3 **20/23**
...
- Latest scan 2026-09-22T01:40:36: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 22, "regime_blocked": 491, "skipped": 763, "slice_full": 3, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:KSTR"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:SNXX"}]
