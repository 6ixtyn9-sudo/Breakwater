# Breakwater daily print — 2026-09-18 09:51 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **417.11 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 43599 decision rows; 118 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 43481 rows are skipped/guard decisions and never count
...
- **NATIVE**: 11 open, stop-risk **32.98 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=12 stop=494.3899999999999790 peak=514.9
  - HYPEUSDC BUY ntl=100 risk=3.90 bars=2 stop=84.41949999999999990 peak=87.834
  - KPEPEUSDC BUY ntl=100 risk=3.70 bars=4 stop=0.00354699999999999985 peak=0.003683
  - SUIUSDC BUY ntl=99 risk=3.67 bars=8 stop=0.7232825000000000470 peak=0.75106
  - LINKUSDC BUY ntl=100 risk=3.07 bars=3 stop=11.365500000000000295 peak=11.725
  - XRPUSDC BUY ntl=99 risk=2.93 bars=7 stop=1.2665499999999999605 peak=1.305
  - SOLUSDC BUY ntl=98 risk=2.86 bars=11 stop=98.16725000000000310 peak=101.11
  - ETHUSDC BUY ntl=98 risk=2.67 bars=14 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=14 stop=0.07923699999999999735 peak=0.081432
  - BNBUSDC BUY ntl=98 risk=1.88 bars=11 stop=720.04750000000004875 peak=734.07
  - BTCUSDC BUY ntl=100 risk=1.75 bars=4 stop=76176.17250 peak=77533.0

- **HIP3**: 4 open, stop-risk **10.35 ZAR**
  - PARA:COHR SELL ntl=98 risk=3.07 bars=19 stop=314.50749999999999095 peak=304.92
  ...
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=19 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **43.33 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **29/50** | ghost rows: **186/50** | PnL: **+2.52 ZAR**
...
- Latest scan 2026-09-18T09:51:18: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 154, "regime_blocked": 681, "skipped": 798, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "ConnectionError: ('Connection aborted.', ConnectionResetError(104, 'Connection reset by peer'))", "pair": "XYZ:XBI"}]
