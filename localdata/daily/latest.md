# Breakwater daily print — 2026-09-19 15:19 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **431.49 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2111.85 ZAR** (seed 2000) | lifetime: **+111.85 ZAR** | closed: 146
- Today: 14 closed, **+50.37 ZAR**
- 7d: **+111.85 ZAR** | 30d: **+111.85 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.493% | at 103.41 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (146 real closes per lane_gate._is_real_close, net of fees): +0.77 ZAR/trade | sd 2.96 | SE 0.25
- Gap: +0.26 ZAR/trade | t = +1.05 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.518% over 244/247 slices (pool 743) ~ +0.54 ZAR | realised 116 closes +0.94 ZAR sd 3.10 SE 0.29 | gap +0.40 t +1.38 | NOT ESTABLISHED
...
- Ledger: 59386 decision rows; 146 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 59240 rows are skipped/guard decisions and never count
...
- Closed: 116 | wins: 62 | win%: 53.4 | P&L: **+108.95 ZAR** | today: +50.37 | 7d: +108.95 | 30d: +108.95
- By exit: horizon +93.3, target +91.0, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 15/+56.8, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 9n/9w +42.12; feat_ext_strength:2:LONG:h15 9n/6w +26.47; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 9n +42.12; LINKUSDC 6n +16.41; SUIUSDC 3n +14.91; SOLUSDC 13n +11.15; DOGEUSDC 5n +8.92
...
- **NATIVE**: 15 open, stop-risk **58.20 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=10 stop=108.78750000000000565 peak=113.27
  - ETHUSDC BUY ntl=207 risk=5.79 bars=9 stop=2547.924999999999975 peak=2621.4
  - LINKZAR BUY ntl=211 risk=4.77 bars=0 stop=156.76499999999999970 peak=160.39
  - SOLZAR BUY ntl=208 risk=4.51 bars=4 stop=1784.4999999999999990 peak=1824.0
  - XRPUSDC BUY ntl=104 risk=3.96 bars=4 stop=1.3599500000000001440 peak=1.4137
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=13 stop=0.08463350000000000245 peak=0.087927
  - LINKUSDC BUY ntl=105 risk=3.86 bars=2 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=9 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=9 stop=22.262500000000001420 peak=23.1
  - ETHZAR BUY ntl=103 risk=2.84 bars=11 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=11 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=13 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=11 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=11 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=11 stop=12153.999999999999990 peak=12444.0
...
- Computed open stop-risk (section 4): **58.20 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=9n/+42.12
...
- Closed paper trades: **30/50** | ghost rows: **266/50** | PnL: **+2.90 ZAR**
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 35
- as_of: 2026-09-19T14:35:24Z
...
- Native lane: **GREEN** | closed=20 pnl=+79.85 | frozen=NO
...
- Latest scan 2026-09-19T14:25:18: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 74, "regime_blocked": 319, "skipped": 884, "slice_full": 1, "slot_full": 0})
