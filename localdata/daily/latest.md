# Breakwater daily print — 2026-09-17 22:05 UTC
...
- Ledger: 34410 decision rows; 105 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 34305 rows are skipped/guard decisions and never count
...
- **NATIVE**: 15 open, stop-risk **48.35 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=0 stop=494.3899999999999790 peak=514.9
  - SUIUSDC BUY ntl=98 risk=3.81 bars=11 stop=0.6937050000000000245 peak=0.72188
  - WLDUSDC BUY ntl=98 risk=3.77 bars=7 stop=0.3633724999999999915 peak=0.37798
  - TAOUSDC BUY ntl=98 risk=3.77 bars=10 stop=218.55249999999998005 peak=227.32
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=11 stop=0.0033364999999999999610 peak=0.00347
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=7 stop=120.35500000000001335 peak=125.1
  - FILUSDC BUY ntl=98 risk=3.70 bars=11 stop=0.7672624999999999540 peak=0.79746
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=7 stop=1.878824999999999980 peak=1.9487
  - XRPUSDC BUY ntl=97 risk=3.42 bars=12 stop=1.2580499999999999655 peak=1.3041
  - LINKUSDC BUY ntl=98 risk=3.42 bars=5 stop=10.969999999999999660 peak=11.366
  - SOLUSDC BUY ntl=98 risk=2.69 bars=11 stop=97.43574999999999960 peak=100.2
  - ETHUSDC BUY ntl=98 risk=2.67 bars=2 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=2 stop=0.07923699999999999735 peak=0.081432
  - BTCUSDC BUY ntl=98 risk=1.86 bars=6 stop=75013.500000000000040 peak=76468.0
  - BNBUSDC BUY ntl=98 risk=1.71 bars=11 stop=712.734975 peak=725.43

- **HIP3**: 6 open, stop-risk **15.45 ZAR**
  - PARA:RDDT SELL ntl=98 risk=3.44 bars=5 stop=156.8850000000000120 peak=151.57
  - PARA:COHR SELL ntl=98 risk=3.07 bars=7 stop=314.50749999999999095 peak=304.92
  - PARA:CIEN SELL ntl=98 risk=2.66 bars=3 stop=377.0499999999999895 peak=367.04
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=7 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=5 stop=155.95250000000000345 peak=152.8
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=7 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **63.80 ZAR** (informational only, no cap applied)
...
- Latest scan 2026-09-17T21:23:28: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 133, "regime_blocked": 393, "skipped": 333, "slice_full": 13, "slot_full": 60})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:GIGADEV"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:HYUNDAI"}]
