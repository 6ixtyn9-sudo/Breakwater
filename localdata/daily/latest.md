# Breakwater daily print — 2026-09-18 01:15 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **402.96 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1969.96 ZAR** (seed 2000) | lifetime: **-30.04 ZAR** | closed: 110
- Today: 2 closed, **+4.56 ZAR**
- 7d: **-30.04 ZAR** | 30d: **-30.04 ZAR**
...
- Claimed edge (median mean_ret_costadj over 78 book slices present in the validated pools): +0.278% | at 100.55 ZAR mean notional/trade: +0.28 ZAR/trade
- Realised (110 real closes per lane_gate._is_real_close, net of fees): -0.27 ZAR/trade | sd 2.45 | SE 0.23
- Gap: -0.55 ZAR/trade | t = -2.37 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.367% over 57/63 slices (pool 176) ~ +0.37 ZAR | realised 81 closes -0.40 ZAR sd 2.51 SE 0.28 | gap -0.77 t -2.77 | FALLS SHORT
...
- Ledger: 36043 decision rows; 110 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 35933 rows are skipped/guard decisions and never count
...
- Closed: 81 | wins: 27 | win%: 33.3 | P&L: **-32.56 ZAR** | today: -0.68 | 7d: -32.56 | 30d: -32.56
- By exit: horizon +32.9, target +9.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): bull 1/-3.8, neutral 14/-12.3, bear 66/-16.4
- Top slices: feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ext_vs_ma_20:2:LONG:h15 5n/5w +9.35; feat_ext_strength:2:LONG:h15 5n/2w +6.05; feat_trend_slope_20:2:LONG:h12 4n/4w +5.75; engine_momentum:trend_align:2:SELL:h15:FILUSDC 2n/1w +2.45
...
- **NATIVE**: 13 open, stop-risk **41.56 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=3 stop=494.3899999999999790 peak=514.9
  - SUIUSDC BUY ntl=98 risk=3.81 bars=14 stop=0.6937050000000000245 peak=0.72188
  - WLDUSDC BUY ntl=98 risk=3.77 bars=10 stop=0.3633724999999999915 peak=0.37798
  - TAOUSDC BUY ntl=98 risk=3.77 bars=13 stop=218.55249999999998005 peak=227.32
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=14 stop=0.0033364999999999999610 peak=0.00347
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=10 stop=120.35500000000001335 peak=125.1
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=10 stop=1.878824999999999980 peak=1.9487
  - LINKUSDC BUY ntl=98 risk=3.42 bars=8 stop=10.969999999999999660 peak=11.366
  - SOLUSDC BUY ntl=98 risk=2.86 bars=2 stop=98.16725000000000310 peak=101.11
  - ETHUSDC BUY ntl=98 risk=2.67 bars=5 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=5 stop=0.07923699999999999735 peak=0.081432
  - BNBUSDC BUY ntl=98 risk=1.88 bars=2 stop=720.04750000000004875 peak=734.07
  - BTCUSDC BUY ntl=98 risk=1.86 bars=9 stop=75013.500000000000040 peak=76468.0

- **HIP3**: 6 open, stop-risk **15.83 ZAR**
  - PARA:RDDT SELL ntl=98 risk=3.44 bars=8 stop=156.8850000000000120 peak=151.57
  - PARA:COHR SELL ntl=98 risk=3.07 bars=10 stop=314.50749999999999095 peak=304.92
  - PARA:NET SELL ntl=99 risk=3.05 bars=0 stop=344.7099999999999605 peak=334.37
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=10 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=8 stop=155.95250000000000345 peak=152.8
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=9 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **57.40 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_ext_strength:2:LONG:h15` edge=0.0072 n=16038 p=0.0016 src=validated_walk_forward unproven=False paper=5n/+6.05
  - `feat_trend_slope_20:2:LONG:h12` edge=0.0063 n=16968 p=0.0000 src=validated_walk_forward unproven=False paper=4n/+5.75
...
- Native lane: **GREEN** | closed=20 pnl=+26.03 | frozen=NO
...
- Tradable slices: native **61/63** | hip3 **21/25**
...
- Latest scan 2026-09-18T00:13:54: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 100, "regime_blocked": 407, "skipped": 358, "slice_full": 23, "slot_full": 53})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:BE"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:RKLB"}]
