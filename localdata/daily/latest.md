# Breakwater daily print — 2026-09-16 18:08 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **376.38 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1964.43 ZAR** (seed 2000) | lifetime: **-35.57 ZAR** | closed: 76
- Today: 37 closed, **-23.98 ZAR**
- 7d: **-35.57 ZAR** | 30d: **-35.57 ZAR**

## 2b. Claimed vs realised

- Book: 30 slices (native 13 | hip3 17); validated pools: native 14 | hip3 160; book slices absent from pools: 15
  ...
  - ... and 5 more
- Claimed edge (median mean_ret_costadj over 15 book slices present in the validated pools): +0.130% | at 98.00 ZAR mean notional/trade: +0.13 ZAR/trade
- Realised (76 real closes per lane_gate._is_real_close, net of fees): -0.47 ZAR/trade | sd 2.02 | SE 0.23
- Gap: -0.60 ZAR/trade | t = -2.57 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.188% over 5/13 slices (pool 14) ~ +0.18 ZAR | realised 56 closes -0.75 ZAR sd 2.23 SE 0.30 | gap -0.94 t -3.14 | FALLS SHORT
- hip3: claimed median +0.064% over 10/17 slices (pool 160) ~ +0.06 ZAR | realised 20 closes +0.33 ZAR sd 0.92 | INSUFFICIENT SAMPLE (n<30)
- Ledger: 27386 decision rows; 76 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 27310 rows are skipped/guard decisions and never count
...
- Closed: 56 | wins: 12 | win%: 21.4 | P&L: **-42.19 ZAR** | today: -22.05 | 7d: -42.19 | 30d: -42.19
- By exit: target +9.9, horizon +1.2, regime_shift -12.5, stop -40.8
- By entry regime (n/pnl): bull 1/-3.8, neutral 11/-15.4, bear 44/-23.0
- Top slices: engine_momentum:trend_align:2:SELL:h15:FILUSDC 1n/1w +4.90; feat_ret_10:2:LONG:h19 8n/2w +4.70; feat_realized_vol_20:2:LONG:h20 8n/7w +1.47; engine_mean_reversion:rsi:2:BUY:h10:XRPUSDT 1n/0w -0.12; feat_realized_vol_20:2:LONG:h23 3n/1w -0.13
...
- Worst pairs: TRUMPUSDC 2n -6.38; ZECUSDC 2n -5.32; XRPUSDC 3n -5.21; NEARUSDC 2n -5.10; ETHUSDC 8n -4.40

### HIP3

- Closed: 20 | wins: 16 | win%: 80.0 | P&L: **+6.63 ZAR** | today: -1.93 | 7d: +6.63 | 30d: +6.63
- By exit: target +6.3, horizon +2.0, regime_shift +1.8, trail_stop +1.0, stop -4.5
- By entry regime (n/pnl): bear 6/+5.1, bull 12/+5.0, neutral 2/-3.5
...
- Worst slices: hip3_para_equity_c0:feat_ret_vol:2:SHORT:h20 1n/0w -1.82; hip3_para_equity_c0:feat_ret_vol:2:SHORT:h24 1n/0w -1.66; hip3_xyz_commodity_c0:feat_vol_regime:1:LONG:h23 3n/2w -0.30; hip3_para_equity_c0:feat_ret_20:2:SHORT:h21 1n/0w -0.09; hip3_para_equity_c0:feat_vol_regime:2:SHORT:h24 1n/1w +1.01
- Top pairs: XYZ:STRC 8n +3.98; PARA:MELI 2n +3.06; XYZ:COPPER 1n +1.36; XYZ:SILVER 1n +0.71; XYZ:NATGAS 2n +0.63
- Worst pairs: PARA:CIEN 2n -3.47; PARA:IGV 1n -0.09; XYZ:PALLADIUM 2n -0.05; XYZ:BRENTOIL 1n +0.49; XYZ:NATGAS 2n +0.63

## 4. Open positions & risk

- **NATIVE**: 10 open, stop-risk **30.75 ZAR**
  - ARBUSDC SELL ntl=84 risk=4.94 bars=5 stop=0.17935714285714285 peak=0.16938
  - ZECUSDC SELL ntl=99 risk=4.46 bars=4 stop=1307.1714285714286 peak=1250.6
  - PUMPUSDC SELL ntl=98 risk=3.79 bars=1 stop=0.003815571428571429 peak=0.003674
  - BNBUSDC BUY ntl=197 risk=3.59 bars=0 stop=699.62250000000006310 peak=712.63
  - NEARUSDC SELL ntl=99 risk=3.56 bars=4 stop=2.555557142857143 peak=2.4664
  - LITUSDC SELL ntl=99 risk=3.47 bars=7 stop=4.453957142857143 peak=4.3036
  - PENDLEUSDC SELL ntl=98 risk=2.86 bars=3 stop=2.2190 peak=2.1563
  - FILUSDC SELL ntl=98 risk=2.36 bars=0 stop=0.7908546428571428 peak=0.77235
  - SHIBUSDT SELL ntl=98 risk=0.98 bars=3 stop=0.0000048177000000000005 peak=0.00000477
  - PUMPUSDT SELL ntl=98 risk=0.74 bars=0 stop=0.0036834199999999997 peak=0.003656

- **HIP3**: 6 open, stop-risk **13.89 ZAR**
  - PARA:CIEN SELL ntl=98 risk=3.74 bars=0 stop=359.65499999999996890 peak=346.48
  - PARA:COHR SELL ntl=99 risk=3.38 bars=4 stop=294.5500000000000190 peak=284.79
  - PARA:IREN SELL ntl=98 risk=2.75 bars=2 stop=44.663250000000000375 peak=43.45
  - PARA:CRDO SELL ntl=99 risk=2.34 bars=4 stop=164.02500000000001420 peak=160.22
  - PARA:GLW SELL ntl=99 risk=1.18 bars=4 stop=148.99000000000001205 peak=147.23
  - PARA:AVGO SELL ntl=99 risk=0.51 bars=4 stop=344.77249999999998465 peak=342.99

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **44.65 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **20/50** | ghost rows: **75/50** | PnL: **+6.63 ZAR**
...
- Label: **bear** | breadth bear=0.6 bull=0.0333 neutral=0.3333 | symbols=29
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 24 / bull 0
- as_of: 2026-09-16T18:00:31Z
...
- Native lane: **RED** | closed=20 pnl=-22.47 | frozen=YES
- HIP-3 lane: **GREEN** | closed=20 pnl=+6.63 | frozen=NO
- Frozen lanes: native
...
- Tradable slices: native **12/13** | hip3 **16/17**
...
- Latest scan 2026-09-16T18:08:38: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `slot_full` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 2, "pair_held": 20, "regime_blocked": 70, "skipped": 18, "slice_full": 0, "slot_full": 162})
- green_gate: native_green=False hip3_green=True frozen=native islands=2 blocks=7
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:AAOI"}]
