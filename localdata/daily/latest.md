# Breakwater daily print — 2026-09-21 00:47 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **435.65 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2278.08 ZAR** (seed 2000) | lifetime: **+278.08 ZAR** | closed: 185
- Today: 0 closed, **+0.00 ZAR**
- 7d: **+278.08 ZAR** | 30d: **+278.08 ZAR**
...
- Claimed edge (median mean_ret_costadj over 259 book slices present in the validated pools): +0.376% | at 136.77 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (185 real closes per lane_gate._is_real_close, net of fees): +1.50 ZAR/trade | sd 4.40 | SE 0.32
- Gap: +0.99 ZAR/trade | t = +3.06 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.385% over 238/241 slices (pool 676) ~ +0.55 ZAR | realised 155 closes +1.78 ZAR sd 4.66 SE 0.37 | gap +1.22 t +3.26 | EXCEEDS
...
- Ledger: 72026 decision rows; 185 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 71841 rows are skipped/guard decisions and never count
...
- Closed: 155 | wins: 87 | win%: 56.1 | P&L: **+275.18 ZAR** | today: +0.00 | 7d: +275.18 | 30d: +275.18
- By exit: target +293.2, horizon +78.1, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 52/+240.7, bull 37/+50.9, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 31n/26w +223.72; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 26n +244.34; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 14 open, stop-risk **65.81 ZAR**
  - XRPZAR BUY ntl=442 risk=10.31 bars=8 stop=21.98499999999999965 peak=22.51
  - BNBZAR BUY ntl=418 risk=8.23 bars=20 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=456 risk=7.98 bars=0 stop=157.583175 peak=160.39
  - BTCUSDC BUY ntl=421 risk=7.36 bars=19 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=18 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=9 stop=87.90974999999999825 peak=90.96
  - SOLUSDC BUY ntl=113 risk=3.34 bars=3 stop=107.21000000000000570 peak=110.47
  - XRPUSDC BUY ntl=111 risk=3.27 bars=7 stop=1.3499000000000000060 peak=1.3908
  - XRPUSDC BUY ntl=112 risk=3.04 bars=5 stop=1.3651500000000000695 peak=1.4031
  - ETHUSDC BUY ntl=113 risk=2.61 bars=3 stop=2572.9500000000001090 peak=2633.7
  - SOLZAR BUY ntl=110 risk=2.47 bars=10 stop=1728.2499999999999970 peak=1768.0
  - BNBUSDC BUY ntl=112 risk=2.12 bars=5 stop=750.087499999999995 peak=764.52
  - LTCZAR BUY ntl=109 risk=2.08 bars=11 stop=920.99999999999993625 peak=938.9
  - BTCUSDC BUY ntl=111 risk=1.94 bars=7 stop=79512.74250 peak=80929.0
...
- Computed open stop-risk (section 4): **65.81 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+184.37 | frozen=NO
...
- Latest scan 2026-09-20T23:44:15: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 104, "regime_blocked": 477, "skipped": 834, "slice_full": 0, "slot_full": 0})
