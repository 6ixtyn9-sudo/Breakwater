# Breakwater daily print — 2026-09-10 04:56 UTC
...
- **NATIVE**: 2 open, stop-risk **25.30 ZAR**
  - ASTERUSDC BUY ntl=383 risk=15.45 bars=11 stop=0.7107175000000000190 peak=0.74063
  - ETHUSDC BUY ntl=380 risk=9.85 bars=8 stop=2400.949999999999975 peak=2464.8

- **HIP3**: 5 open, stop-risk **14.47 ZAR**
  - XYZ:ASML BUY ntl=391 risk=6.90 bars=15 stop=1711.2750000000000930 peak=1742.0
  - XYZ:EWJ BUY ntl=382 risk=3.96 bars=13 stop=96.215500000000005610 peak=97.224
  ...
  - XYZ:CRWD BUY ntl=393 risk=0.00 bars=39 stop=206.840000000000005950 peak=210.62
...
- Latest scan 2026-09-10T04:41:10: errors=0 signals=None regime_blocked=None
...
- aggregate_risk: ok open=39.7693 cap=130.2791 used=0.3571 remaining=83.7538 replayed=5 no_new_bars=3
- pair_errors: []
