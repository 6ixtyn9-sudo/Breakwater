# Breakwater daily print — 2026-09-10 10:40 UTC
...
- Mode: **readonly** | VALR equity: **388.21 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 98519 decision rows; 91 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 98428 rows are skipped/guard decisions and never count
...
- **HIP3**: 5 open, stop-risk **10.50 ZAR**
  - XYZ:ASML BUY ntl=391 risk=6.90 bars=21 stop=1711.2750000000000930 peak=1742.0
...
- Latest scan 2026-09-10T10:40:34: errors=0 signals=None regime_blocked=None
- this cycle: closed=None new_signals=None skipped=None slot_full=None slice_full=None pair_held=None
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 18, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 0, "pair_held": 31, "regime_blocked": 634, "skipped": 114, "slice_full": 16, "slot_full": 0})
