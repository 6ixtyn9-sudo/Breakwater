# Breakwater daily print — 2026-09-10 16:40 UTC
...
- Ledger: 105704 decision rows; 98 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 105606 rows are skipped/guard decisions and never count
...
- **HIP3**: 1 open, stop-risk **0.76 ZAR**
  - XYZ:STRC BUY ntl=368 risk=0.76 bars=2 stop=97.66200000000000180 peak=97.864
...
- Latest scan 2026-09-10T16:40:24: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 12, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 1, "pair_held": 13, "regime_blocked": 202, "skipped": 308, "slice_full": 0, "slot_full": 139})
