# Breakwater daily print — 2026-09-18 01:32 UTC
...
- Equity: **1981.31 ZAR** (seed 2000) | lifetime: **-18.69 ZAR** | closed: 113
- Today: 5 closed, **+15.91 ZAR**
- 7d: **-18.69 ZAR** | 30d: **-18.69 ZAR**
...
- Claimed edge (median mean_ret_costadj over 78 book slices present in the validated pools): +0.278% | at 100.47 ZAR mean notional/trade: +0.28 ZAR/trade
- Realised (113 real closes per lane_gate._is_real_close, net of fees): -0.17 ZAR/trade | sd 2.51 | SE 0.24
- Gap: -0.45 ZAR/trade | t = -1.89 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.367% over 57/63 slices (pool 176) ~ +0.37 ZAR | realised 84 closes -0.25 ZAR sd 2.58 SE 0.28 | gap -0.62 t -2.21 | FALLS SHORT
...
- Ledger: 36699 decision rows; 113 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 36586 rows are skipped/guard decisions and never count
...
- Closed: 84 | wins: 30 | win%: 35.7 | P&L: **-21.21 ZAR** | today: +10.67 | 7d: -21.21 | 30d: -21.21
- By exit: horizon +44.3, target +9.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 17/-1.0, bull 1/-3.8, bear 66/-16.4
- Top slices: feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ext_strength:2:LONG:h15 7n/4w +14.44; feat_ext_vs_ma_20:2:LONG:h15 5n/5w +9.35; feat_trend_slope_20:2:LONG:h12 4n/4w +5.75; feat_ret_20:2:LONG:h14 1n/1w +2.97
...
- Top pairs: ARBUSDC 3n +7.76; SUIUSDC 2n +7.67; LINKUSDC 3n +6.68; TAOUSDC 3n +6.40; KPEPEUSDC 4n +2.80
...
- **NATIVE**: 11 open, stop-risk **33.89 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=4 stop=494.3899999999999790 peak=514.9
  - WLDUSDC BUY ntl=98 risk=3.77 bars=11 stop=0.3633724999999999915 peak=0.37798
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=11 stop=120.35500000000001335 peak=125.1
  - SUIUSDC BUY ntl=99 risk=3.67 bars=0 stop=0.7232825000000000470 peak=0.75106
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=11 stop=1.878824999999999980 peak=1.9487
  - LINKUSDC BUY ntl=98 risk=3.42 bars=9 stop=10.969999999999999660 peak=11.366
  - SOLUSDC BUY ntl=98 risk=2.86 bars=3 stop=98.16725000000000310 peak=101.11
  - ETHUSDC BUY ntl=98 risk=2.67 bars=6 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=6 stop=0.07923699999999999735 peak=0.081432
  - BNBUSDC BUY ntl=98 risk=1.88 bars=3 stop=720.04750000000004875 peak=734.07
  - BTCUSDC BUY ntl=98 risk=1.86 bars=10 stop=75013.500000000000040 peak=76468.0

- **HIP3**: 6 open, stop-risk **15.83 ZAR**
  - PARA:RDDT SELL ntl=98 risk=3.44 bars=8 stop=156.8850000000000120 peak=151.57
  - PARA:COHR SELL ntl=98 risk=3.07 bars=11 stop=314.50749999999999095 peak=304.92
  - PARA:NET SELL ntl=99 risk=3.05 bars=5 stop=344.7099999999999605 peak=334.37
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=11 stop=171.35750000000002975 peak=167.0
...
- Computed open stop-risk (section 4): **49.73 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_ret_20:2:LONG:h14` edge=0.0060 n=17052 p=0.0000 src=validated_walk_forward unproven=False paper=1n/+2.97
...
- Native lane: **GREEN** | closed=20 pnl=+36.34 | frozen=NO
...
- Latest scan 2026-09-18T01:23:40: errors=5 signals=None regime_blocked=None
