# Breakwater daily print — 2026-09-18 09:57 UTC
...
- Ledger: 42746 decision rows; 118 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 42628 rows are skipped/guard decisions and never count
...
- **NATIVE**: 11 open, stop-risk **32.98 ZAR**
  - XMRUSDC BUY ntl=98 risk=3.91 bars=10 stop=494.3899999999999790 peak=514.9
  - HYPEUSDC BUY ntl=100 risk=3.90 bars=0 stop=84.41949999999999990 peak=87.834
  - KPEPEUSDC BUY ntl=100 risk=3.70 bars=2 stop=0.00354699999999999985 peak=0.003683
  - SUIUSDC BUY ntl=99 risk=3.67 bars=6 stop=0.7232825000000000470 peak=0.75106
  - LINKUSDC BUY ntl=100 risk=3.07 bars=1 stop=11.365500000000000295 peak=11.725
  - XRPUSDC BUY ntl=99 risk=2.93 bars=5 stop=1.2665499999999999605 peak=1.305
  - SOLUSDC BUY ntl=98 risk=2.86 bars=9 stop=98.16725000000000310 peak=101.11
  - ETHUSDC BUY ntl=98 risk=2.67 bars=12 stop=2384.5500000000000205 peak=2451.2
  - DOGEUSDC BUY ntl=98 risk=2.64 bars=12 stop=0.07923699999999999735 peak=0.081432
  - BNBUSDC BUY ntl=98 risk=1.88 bars=9 stop=720.04750000000004875 peak=734.07
  - BTCUSDC BUY ntl=100 risk=1.75 bars=2 stop=76176.17250 peak=77533.0

- **HIP3**: 6 open, stop-risk **15.83 ZAR**
  - PARA:RDDT SELL ntl=98 risk=3.44 bars=15 stop=156.8850000000000120 peak=151.57
  - PARA:COHR SELL ntl=98 risk=3.07 bars=17 stop=314.50749999999999095 peak=304.92
  - PARA:NET SELL ntl=99 risk=3.05 bars=9 stop=344.7099999999999605 peak=334.37
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=17 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=17 stop=155.95250000000000345 peak=152.8
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=17 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **48.81 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **29/50** | ghost rows: **182/50** | PnL: **+2.52 ZAR**
