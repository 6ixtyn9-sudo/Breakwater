# Breakwater daily print — 2026-09-23 00:44 UTC
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 166.61 ZAR mean notional/trade: +0.69 ZAR/trade
- Realised (236 real closes per lane_gate._is_real_close, net of fees): +2.08 ZAR/trade | sd 5.79 | SE 0.38
- Gap: +1.39 ZAR/trade | t = +3.69 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.436% over 239/246 slices (pool 760) ~ +0.77 ZAR | realised 198 closes +2.50 ZAR sd 6.05 SE 0.43 | gap +1.74 t +4.04 | EXCEEDS
...
- Closed: 198 | wins: 119 | win%: 60.1 | P&L: **+495.78 ZAR** | today: -8.49 | 7d: +515.01 | 30d: +495.78
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:2:LONG:h12` edge=0.0092 n=1092 p=0.3222 src=validated_walk_forward unproven=False paper=26n/+128.54
...
- Latest scan 2026-09-23T00:44:39: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 21, "regime_blocked": 470, "skipped": 853, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=13
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:KSTR"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:RDDT"}]
