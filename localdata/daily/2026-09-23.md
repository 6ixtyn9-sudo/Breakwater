# Breakwater daily print — 2026-09-23 20:42 UTC
...
- Ledger: 114775 decision rows; 249 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 114526 rows are skipped/guard decisions and never count
...
- **NATIVE**: 3 open, stop-risk **10.92 ZAR**
  - BNBUSDC BUY ntl=124 risk=3.89 bars=5 stop=743.3675000000000925 peak=767.47
  - ETHUSDC BUY ntl=124 risk=3.78 bars=5 stop=2595.5999999999998420 peak=2677.3
  - BTCUSDC BUY ntl=124 risk=3.24 bars=4 stop=81796.74999999999985 peak=83989.0

- **HIP3**: 3 open, stop-risk **18.81 ZAR**
  - PARA:CIFR SELL ntl=250 risk=8.70 bars=6 stop=19.97774999999999890 peak=19.305
  - PARA:CRDO SELL ntl=250 risk=5.75 bars=6 stop=197.4825000000000025 peak=193.04
  - PARA:AVGO SELL ntl=250 risk=4.37 bars=6 stop=363.796950 peak=357.54
...
- Latest scan 2026-09-23T20:42:49: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 30, "regime_blocked": 563, "skipped": 735, "slice_full": 7, "slot_full": 0})
