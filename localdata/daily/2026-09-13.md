# Breakwater daily print — 2026-09-13 12:26 UTC
...
- Mode: **readonly** | VALR equity: **397.16 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1728.76 ZAR** (seed 2000) | lifetime: **-271.24 ZAR** | closed: 144
- Today: 13 closed, **-36.40 ZAR**
- 7d: **-267.09 ZAR** | 30d: **-271.24 ZAR**

## 2b. Claimed vs realised

- Book: 48 slices (native 31 | hip3 17); validated pools: native 524 | hip3 464; book slices absent from pools: 0
- Claimed edge (median mean_ret_costadj over 48 book slices present in the validated pools): +0.421% | at 380.19 ZAR mean notional/trade: +1.60 ZAR/trade
- Realised (144 real closes per lane_gate._is_real_close, net of fees): -1.88 ZAR/trade | sd 8.12 | SE 0.68
- Gap: -3.48 ZAR/trade | t = -5.15 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.525% over 31/31 slices (pool 524) ~ +1.99 ZAR | realised 110 closes -2.18 ZAR sd 9.00 SE 0.86 | gap -4.17 t -4.86 | FALLS SHORT
...
- Ledger: 186432 decision rows; 144 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 186288 rows are skipped/guard decisions and never count
...
- Closed: 110 | wins: 42 | win%: 38.2 | P&L: **-240.33 ZAR** | today: -26.18 | 7d: -251.33 | 30d: -240.33
- By exit: target +101.5, trail_stop +49.6, lane_gate +7.6, rotated -47.9, horizon -120.1, stop -231.0
- By entry regime (n/pnl): bull 26/+6.3, bear 29/-30.6, neutral 55/-216.1
...
- **NATIVE**: 13 open, stop-risk **93.08 ZAR**
  - ARBUSDC BUY ntl=347 risk=14.70 bars=4 stop=0.13294499999999999205 peak=0.13883
  - LITUSDC BUY ntl=347 risk=13.72 bars=4 stop=3.947674999999999980 peak=4.1103
  - NEARUSDC BUY ntl=347 risk=11.05 bars=4 stop=2.2261500000000000720 peak=2.2994
  - TAOUSDC BUY ntl=347 risk=8.45 bars=4 stop=230.16499999999999520 peak=235.91
  - FARTCOINUSDC BUY ntl=347 risk=8.38 bars=4 stop=0.13803999999999998685 peak=0.14146
  - ASTERUSDC BUY ntl=353 risk=7.49 bars=14 stop=0.6719625000000000010 peak=0.68652
  - HYPEUSDC BUY ntl=347 risk=6.66 bars=4 stop=76.92624999999999375 peak=78.432
  - LTCUSDC BUY ntl=347 risk=6.02 bars=4 stop=53.15024999999999935 peak=54.089
  - LINKUSDC BUY ntl=347 risk=5.20 bars=4 stop=11.254749999999999435 peak=11.426
  - DOGEUSDC BUY ntl=347 risk=4.13 bars=4 stop=0.08315825000000000075 peak=0.08416
  - BNBUSDC BUY ntl=346 risk=3.71 bars=1 stop=707.1325000000000195 peak=714.81
  - ETHUSDC BUY ntl=346 risk=3.58 bars=3 stop=2468.62499999999990825 peak=2494.4
  - XMRUSDC BUY ntl=355 risk=0.00 bars=40 stop=526.16999999999998150 peak=545.65

- **HIP3**: 3 open, stop-risk **10.24 ZAR**
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=41 stop=109.37749999999999265 peak=110.76
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=41 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=45 stop=899.50250000000005440 peak=903.5

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **103.32 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **34/50** | ghost rows: **547/50** | PnL: **-30.92 ZAR**
...
- Label: **bear** | breadth bear=0.7143 bull=0.0476 neutral=0.2381 | symbols=21
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 90 / bull 0
- as_of: 2026-09-13T12:25:28Z
...
- Native lane: **RED** | closed=20 pnl=-46.80 | frozen=YES
...
- Latest scan 2026-09-13T12:09:50: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 13, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 9, "regime_blocked": 612, "skipped": 16, "slice_full": 0, "slot_full": 108})
