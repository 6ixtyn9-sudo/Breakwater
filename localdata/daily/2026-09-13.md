# Breakwater daily print — 2026-09-13 18:09 UTC
...
- Ledger: 193795 decision rows; 146 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 193649 rows are skipped/guard decisions and never count
...
- **HIP3**: 3 open, stop-risk **10.24 ZAR**
  ...
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=47 stop=105.88750000000000230 peak=107.14
...
- Closed paper trades: **34/50** | ghost rows: **618/50** | PnL: **-30.92 ZAR**
...
- Latest scan 2026-09-13T18:09:37: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 19, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 18, "regime_blocked": 605, "skipped": 22, "slice_full": 0, "slot_full": 104})
