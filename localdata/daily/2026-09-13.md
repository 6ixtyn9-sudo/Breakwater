# Breakwater daily print — 2026-09-13 21:08 UTC
...
- Mode: **readonly** | VALR equity: **407.75 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1735.16 ZAR** (seed 2000) | lifetime: **-264.84 ZAR** | closed: 149
- Today: 18 closed, **-29.99 ZAR**
- 7d: **-241.26 ZAR** | 30d: **-264.84 ZAR**

## 2b. Claimed vs realised

- Book: 49 slices (native 32 | hip3 17); validated pools: native 524 | hip3 464; book slices absent from pools: 0
- Claimed edge (median mean_ret_costadj over 49 book slices present in the validated pools): +0.428% | at 379.11 ZAR mean notional/trade: +1.62 ZAR/trade
- Realised (149 real closes per lane_gate._is_real_close, net of fees): -1.78 ZAR/trade | sd 8.06 | SE 0.66
- Gap: -3.40 ZAR/trade | t = -5.15 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.526% over 32/32 slices (pool 524) ~ +1.98 ZAR | realised 115 closes -2.03 ZAR sd 8.89 SE 0.83 | gap -4.02 t -4.84 | FALLS SHORT
...
- Ledger: 197637 decision rows; 149 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 197488 rows are skipped/guard decisions and never count
...
- Closed: 115 | wins: 45 | win%: 39.1 | P&L: **-233.92 ZAR** | today: -19.77 | 7d: -225.49 | 30d: -233.92
- By exit: target +101.5, trail_stop +49.6, lane_gate +7.6, rotated -47.9, horizon -108.2, stop -236.5
- By entry regime (n/pnl): bull 26/+6.3, bear 34/-24.1, neutral 55/-216.1
...
- **NATIVE**: 14 open, stop-risk **95.08 ZAR**
  - LITUSDC BUY ntl=347 risk=16.84 bars=1 stop=4.007975000000000130 peak=4.2124
  - ARBUSDC BUY ntl=347 risk=14.70 bars=13 stop=0.13294499999999999205 peak=0.13883
  - NEARUSDC BUY ntl=347 risk=11.05 bars=13 stop=2.2261500000000000720 peak=2.2994
  - SUIUSDC BUY ntl=347 risk=9.10 bars=1 stop=0.6996824999999999825 peak=0.71853
  - TAOUSDC BUY ntl=347 risk=8.45 bars=13 stop=230.16499999999999520 peak=235.91
  - LINKUSDC BUY ntl=345 risk=7.04 bars=8 stop=11.016249999999999870 peak=11.246
  - XRPUSDC BUY ntl=347 risk=6.92 bars=1 stop=1.3274000000000000290 peak=1.3544
  - SOLUSDC BUY ntl=346 risk=6.64 bars=2 stop=99.2182500000000010 peak=101.16
  - DOGEUSDC BUY ntl=347 risk=4.13 bars=13 stop=0.08315825000000000075 peak=0.08416
  - BNBUSDC BUY ntl=346 risk=3.71 bars=10 stop=707.1325000000000195 peak=714.81
  - ETHUSDC BUY ntl=346 risk=3.58 bars=12 stop=2468.62499999999990825 peak=2494.4
  - BTCUSDC BUY ntl=346 risk=2.93 bars=7 stop=76157.750000000000020 peak=76808.0
  - XMRUSDC BUY ntl=355 risk=0.00 bars=49 stop=526.16999999999998150 peak=545.65
  - LTCUSDC BUY ntl=347 risk=0.00 bars=13 stop=54.107249999999999350 peak=55.046

- **HIP3**: 3 open, stop-risk **10.24 ZAR**
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=51 stop=109.37749999999999265 peak=110.76
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=50 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=54 stop=899.50250000000005440 peak=903.5
...
- Closed paper trades: **34/50** | ghost rows: **658/50** | PnL: **-30.92 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 107 / bull 0
- as_of: 2026-09-13T21:00:27Z
...
- Native lane: **RED** | closed=20 pnl=-18.59 | frozen=YES
...
- Tradable slices: native **25/32** | hip3 **15/17**
...
- Latest scan 2026-09-13T21:08:02: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 9, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 23, "regime_blocked": 628, "skipped": 12, "slice_full": 0, "slot_full": 144})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=5 blocks=19
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:URNM"}]
