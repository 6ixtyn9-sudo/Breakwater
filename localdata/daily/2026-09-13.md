# Breakwater daily print — 2026-09-13 04:10 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **395.29 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1750.40 ZAR** (seed 2000) | lifetime: **-249.60 ZAR** | closed: 135
- Today: 4 closed, **-14.76 ZAR**
- 7d: **-210.66 ZAR** | 30d: **-249.60 ZAR**

## 2b. Claimed vs realised

- Book: 49 slices (native 32 | hip3 17); validated pools: native 524 | hip3 464; book slices absent from pools: 0
- Claimed edge (median mean_ret_costadj over 49 book slices present in the validated pools): +0.428% | at 381.83 ZAR mean notional/trade: +1.63 ZAR/trade
- Realised (135 real closes per lane_gate._is_real_close, net of fees): -1.85 ZAR/trade | sd 8.35 | SE 0.72
- Gap: -3.48 ZAR/trade | t = -4.85 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.526% over 32/32 slices (pool 524) ~ +2.00 ZAR | realised 104 closes -2.20 ZAR sd 9.22 SE 0.90 | gap -4.20 t -4.64 | FALLS SHORT
...
- Ledger: 176261 decision rows; 135 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 176126 rows are skipped/guard decisions and never count
...
- Closed: 104 | wins: 41 | win%: 39.4 | P&L: **-228.90 ZAR** | today: -14.76 | 7d: -205.11 | 30d: -228.90
- By exit: target +101.5, trail_stop +45.1, lane_gate +7.6, rotated -47.9, horizon -113.5, stop -221.6
- By entry regime (n/pnl): bull 26/+6.3, bear 27/-21.2, neutral 51/-214.1
...
- **NATIVE**: 7 open, stop-risk **25.54 ZAR**
  - ASTERUSDC BUY ntl=353 risk=7.49 bars=6 stop=0.6719625000000000010 peak=0.68652
  - SUIUSDC BUY ntl=353 risk=5.72 bars=9 stop=0.71029750000000001525 peak=0.72198
  - BNBUSDC BUY ntl=353 risk=4.98 bars=18 stop=725.1625000000000595 peak=735.54
  - XRPUSDC BUY ntl=353 risk=3.86 bars=9 stop=1.3481250000000000840 peak=1.363
  - DOGEUSDC BUY ntl=353 risk=3.50 bars=9 stop=0.083883749999999989905 peak=0.084723
  - XMRUSDC BUY ntl=355 risk=0.00 bars=32 stop=526.16999999999998150 peak=545.65
  - KPEPEUSDC BUY ntl=353 risk=0.00 bars=20 stop=0.0033637500000000000550 peak=0.003454

- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=37 stop=359.37499999999998860 peak=364.3
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=33 stop=109.37749999999999265 peak=110.76
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=33 stop=283.88000000000002330 peak=287.39
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=33 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=37 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=36 stop=98.1800000000000016850 peak=98.385

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **45.07 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **31/50** | ghost rows: **408/50** | PnL: **-20.70 ZAR**
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 77 / bull 0
- as_of: 2026-09-13T04:00:27Z
...
- Native lane: **RED** | closed=20 pnl=-85.36 | frozen=YES
...
- Latest scan 2026-09-13T04:10:19: errors=1 signals=None regime_blocked=None
