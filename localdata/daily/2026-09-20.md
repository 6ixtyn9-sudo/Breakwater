# Breakwater daily print — 2026-09-20 12:44 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **425.51 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2186.68 ZAR** (seed 2000) | lifetime: **+186.68 ZAR** | closed: 174
- Today: 19 closed, **+66.35 ZAR**
- 7d: **+186.68 ZAR** | 30d: **+186.68 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 121.34 ZAR mean notional/trade: +0.56 ZAR/trade
- Realised (174 real closes per lane_gate._is_real_close, net of fees): +1.07 ZAR/trade | sd 3.78 | SE 0.29
- Gap: +0.51 ZAR/trade | t = +1.78 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.60 ZAR | realised 144 closes +1.28 ZAR sd 4.00 SE 0.33 | gap +0.68 t +2.04 | EXCEEDS
...
- Ledger: 67174 decision rows; 174 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 67000 rows are skipped/guard decisions and never count
...
- Closed: 144 | wins: 78 | win%: 54.2 | P&L: **+183.78 ZAR** | today: +66.35 | 7d: +183.78 | 30d: +183.78
- By exit: target +194.2, horizon +85.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 44/+152.0, bull 34/+48.2, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 22n/18w +133.30; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 18n +145.26; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 12 open, stop-risk **58.05 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=9 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=437 risk=7.65 bars=0 stop=157.583175 peak=160.39
  - ETHZAR BUY ntl=424 risk=7.42 bars=21 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=8 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=7 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=20 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=11 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=9 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=9 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=9 stop=2516.6249999999998140 peak=2573.3
  - LTCZAR BUY ntl=109 risk=2.08 bars=0 stop=920.99999999999993625 peak=938.9
  - BTCUSDC BUY ntl=106 risk=1.85 bars=16 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **58.05 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=22n/+133.30
...
- Native lane: **GREEN** | closed=20 pnl=+67.26 | frozen=NO
...
- Latest scan 2026-09-20T12:44:20: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 4, "regime_blocked": 304, "skipped": 914, "slice_full": 1, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:MRVL"}]
