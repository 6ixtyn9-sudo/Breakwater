# Breakwater daily print — 2026-09-20 11:18 UTC
...
- Equity: **2150.52 ZAR** (seed 2000) | lifetime: **+150.52 ZAR** | closed: 171
- Today: 16 closed, **+30.19 ZAR**
- 7d: **+150.52 ZAR** | 30d: **+150.52 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 115.89 ZAR mean notional/trade: +0.54 ZAR/trade
- Realised (171 real closes per lane_gate._is_real_close, net of fees): +0.88 ZAR/trade | sd 3.52 | SE 0.27
- Gap: +0.34 ZAR/trade | t = +1.28 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.57 ZAR | realised 141 closes +1.05 ZAR sd 3.71 SE 0.31 | gap +0.48 t +1.54 | NOT ESTABLISHED
...
- Ledger: 66046 decision rows; 171 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 65875 rows are skipped/guard decisions and never count
...
- Closed: 141 | wins: 75 | win%: 53.2 | P&L: **+147.62 ZAR** | today: +30.19 | 7d: +147.62 | 30d: +147.62
- By exit: target +158.0, horizon +85.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 41/+115.9, bull 34/+48.2, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 19n/15w +97.14; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 15n +109.10; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 11 open, stop-risk **55.84 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=6 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=430 risk=7.52 bars=0 stop=157.583175 peak=160.39
  - ETHZAR BUY ntl=424 risk=7.42 bars=18 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=5 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=4 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=17 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=8 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=6 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=6 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=6 stop=2516.6249999999998140 peak=2573.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=13 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **55.84 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=19n/+97.14
...
- Native lane: **GREEN** | closed=20 pnl=+28.34 | frozen=NO
...
- Latest scan 2026-09-20T09:43:46: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 2, "regime_blocked": 303, "skipped": 858, "slice_full": 1, "slot_full": 0})
