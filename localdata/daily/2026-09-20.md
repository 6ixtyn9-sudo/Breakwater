# Breakwater daily print — 2026-09-20 04:43 UTC
...
- Book: 301 slices (native 276 | hip3 25); validated pools: native 761 | hip3 160; book slices absent from pools: 7
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.476% | at 108.51 ZAR mean notional/trade: +0.52 ZAR/trade
- Realised (167 real closes per lane_gate._is_real_close, net of fees): +0.62 ZAR/trade | sd 3.12 | SE 0.24
- Gap: +0.10 ZAR/trade | t = +0.42 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.488% over 273/276 slices (pool 761) ~ +0.54 ZAR | realised 137 closes +0.73 ZAR sd 3.27 SE 0.28 | gap +0.19 t +0.69 | NOT ESTABLISHED
...
- Ledger: 64172 decision rows; 167 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 64005 rows are skipped/guard decisions and never count
...
- **NATIVE**: 9 open, stop-risk **40.96 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=1 stop=12022.749999999999995 peak=12264.0
  - ETHZAR BUY ntl=424 risk=7.42 bars=13 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=0 stop=79102.05750 peak=80511.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=12 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=3 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=1 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=1 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=1 stop=2516.6249999999998140 peak=2573.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=8 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **40.96 ZAR** (informational only, no cap applied)
...
- Latest scan 2026-09-20T04:43:32: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 15, "regime_blocked": 305, "skipped": 847, "slice_full": 0, "slot_full": 0})
