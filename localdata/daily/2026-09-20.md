# Breakwater daily print — 2026-09-20 10:43 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **388.71 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2162.51 ZAR** (seed 2000) | lifetime: **+162.51 ZAR** | closed: 172
- Today: 17 closed, **+42.18 ZAR**
- 7d: **+162.51 ZAR** | 30d: **+162.51 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 117.71 ZAR mean notional/trade: +0.55 ZAR/trade
- Realised (172 real closes per lane_gate._is_real_close, net of fees): +0.94 ZAR/trade | sd 3.61 | SE 0.27
- Gap: +0.40 ZAR/trade | t = +1.45 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.58 ZAR | realised 142 closes +1.12 ZAR sd 3.81 SE 0.32 | gap +0.55 t +1.71 | NOT ESTABLISHED
...
- Ledger: 66408 decision rows; 172 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 66236 rows are skipped/guard decisions and never count
...
- Closed: 142 | wins: 76 | win%: 53.5 | P&L: **+159.61 ZAR** | today: +42.18 | 7d: +159.61 | 30d: +159.61
- By exit: target +170.0, horizon +85.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 42/+127.9, bull 34/+48.2, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 20n/16w +109.12; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 16n +121.08; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 11 open, stop-risk **55.88 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=7 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=432 risk=7.57 bars=0 stop=157.583175 peak=160.39
  - ETHZAR BUY ntl=424 risk=7.42 bars=19 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=6 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=5 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=18 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=9 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=7 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=7 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=7 stop=2516.6249999999998140 peak=2573.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=14 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **55.88 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=20n/+109.12
...
- Native lane: **GREEN** | closed=20 pnl=+39.71 | frozen=NO
...
- Latest scan 2026-09-20T10:43:45: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 3, "regime_blocked": 302, "skipped": 856, "slice_full": 1, "slot_full": 0})
