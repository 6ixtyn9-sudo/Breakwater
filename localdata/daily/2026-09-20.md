# Breakwater daily print — 2026-09-20 02:50 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **432.50 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2119.70 ZAR** (seed 2000) | lifetime: **+119.70 ZAR** | closed: 156
- Today: 1 closed, **-0.63 ZAR**
- 7d: **+119.70 ZAR** | 30d: **+119.70 ZAR**

## 2b. Claimed vs realised

- Book: 310 slices (native 285 | hip3 25); validated pools: native 761 | hip3 160; book slices absent from pools: 7
...
- Claimed edge (median mean_ret_costadj over 303 book slices present in the validated pools): +0.482% | at 106.09 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (156 real closes per lane_gate._is_real_close, net of fees): +0.77 ZAR/trade | sd 2.95 | SE 0.24
- Gap: +0.26 ZAR/trade | t = +1.08 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.502% over 282/285 slices (pool 761) ~ +0.54 ZAR | realised 126 closes +0.93 ZAR sd 3.08 SE 0.27 | gap +0.39 t +1.41 | NOT ESTABLISHED
...
- Ledger: 63374 decision rows; 156 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 63218 rows are skipped/guard decisions and never count
...
- Closed: 126 | wins: 70 | win%: 55.6 | P&L: **+116.80 ZAR** | today: -0.63 | 7d: +116.80 | 30d: +116.80
- By exit: target +99.0, horizon +93.1, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 37/+68.6, bull 23/+64.7, bear 66/-16.4
...
- **NATIVE**: 14 open, stop-risk **46.50 ZAR**
  - ETHZAR BUY ntl=424 risk=7.42 bars=11 stop=41925.24000 peak=42672.0
  - SOLZAR BUY ntl=208 risk=4.51 bars=16 stop=1784.4999999999999990 peak=1824.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=10 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=1 stop=1.3528500000000000140 peak=1.4064
  - LINKUSDC BUY ntl=105 risk=3.86 bars=14 stop=12.075999999999998530 peak=12.538
  - DOGEUSDC BUY ntl=106 risk=3.63 bars=10 stop=0.08592275000000000190 peak=0.088963
  - BTCUSDC BUY ntl=103 risk=2.83 bars=23 stop=79105.74999999999985 peak=81333.0
  - SOLUSDC BUY ntl=106 risk=2.58 bars=7 stop=108.47250000000000025 peak=111.18
  - BTCZAR BUY ntl=103 risk=2.54 bars=23 stop=1294261.0000000000005 peak=1326934.0
  - BNBZAR BUY ntl=103 risk=2.41 bars=23 stop=12153.999999999999990 peak=12444.0
  - LTCZAR BUY ntl=106 risk=2.38 bars=11 stop=910.3999999999999665 peak=931.3
  - BNBUSDC BUY ntl=106 risk=2.24 bars=10 stop=750.5700000000000765 peak=766.75
  - ETHUSDC BUY ntl=106 risk=2.04 bars=6 stop=2584.5499999999996570 peak=2635.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=6 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **46.50 ZAR** (informational only, no cap applied)
...
- Label: **bull** | breadth bear=0.0 bull=0.5882 neutral=0.4118 | symbols=17
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 45
- as_of: 2026-09-20T02:00:27Z
...
- Native lane: **GREEN** | closed=20 pnl=+51.42 | frozen=NO
...
- Tradable slices: native **220/285** | hip3 **21/25**
...
- Latest scan 2026-09-20T02:50:55: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 4, "regime_blocked": 388, "skipped": 900, "slice_full": 4, "slot_full": 0})
