# Breakwater daily print — 2026-09-20 12:18 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **424.28 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2174.56 ZAR** (seed 2000) | lifetime: **+174.56 ZAR** | closed: 173
- Today: 18 closed, **+54.23 ZAR**
- 7d: **+174.56 ZAR** | 30d: **+174.56 ZAR**
...
- Claimed edge (median mean_ret_costadj over 294 book slices present in the validated pools): +0.464% | at 119.53 ZAR mean notional/trade: +0.55 ZAR/trade
- Realised (173 real closes per lane_gate._is_real_close, net of fees): +1.01 ZAR/trade | sd 3.69 | SE 0.28
- Gap: +0.45 ZAR/trade | t = +1.62 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.473% over 273/276 slices (pool 752) ~ +0.59 ZAR | realised 143 closes +1.20 ZAR sd 3.91 SE 0.33 | gap +0.61 t +1.88 | NOT ESTABLISHED
...
- Ledger: 66781 decision rows; 173 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 66608 rows are skipped/guard decisions and never count
...
- Closed: 143 | wins: 77 | win%: 53.8 | P&L: **+171.66 ZAR** | today: +54.23 | 7d: +171.66 | 30d: +171.66
- By exit: target +182.0, horizon +85.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 43/+139.9, bull 34/+48.2, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 21n/17w +121.18; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 17n +133.14; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46; ARBUSDC 3n +7.76; AAVEUSDC 1n +7.32
...
- **NATIVE**: 11 open, stop-risk **55.92 ZAR**
  - BNBZAR BUY ntl=418 risk=8.23 bars=8 stop=12022.749999999999995 peak=12264.0
  - LINKZAR BUY ntl=435 risk=7.61 bars=0 stop=157.583175 peak=160.39
  - ETHZAR BUY ntl=424 risk=7.42 bars=20 stop=41925.24000 peak=42672.0
  - BTCUSDC BUY ntl=421 risk=7.36 bars=7 stop=79102.05750 peak=80511.0
  - BTCZAR BUY ntl=421 risk=7.36 bars=6 stop=1289481.14250 peak=1312449.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=19 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=106 risk=4.03 bars=10 stop=1.3528500000000000140 peak=1.4064
  - SOLUSDC BUY ntl=105 risk=3.24 bars=8 stop=104.35250000000000130 peak=107.69
  - BNBUSDC BUY ntl=105 risk=2.34 bars=8 stop=730.965000000000060 peak=747.72
  - ETHUSDC BUY ntl=105 risk=2.30 bars=8 stop=2516.6249999999998140 peak=2573.3
  - BTCUSDC BUY ntl=106 risk=1.85 bars=15 stop=79957.81500 peak=81382.0
...
- Computed open stop-risk (section 4): **55.92 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=21n/+121.18
...
- Native lane: **GREEN** | closed=20 pnl=+55.76 | frozen=NO
...
- Latest scan 2026-09-20T11:26:37: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 5, "regime_blocked": 316, "skipped": 830, "slice_full": 0, "slot_full": 0})
