# Breakwater daily print — 2026-09-08 19:32 UTC
...
- Mode: **readonly** | VALR equity: **400.35 ZAR** | high-water: **435.05 ZAR**
...
- **NATIVE**: 5 open, stop-risk **82.49 ZAR**
  - UNIUSDC BUY ntl=334 risk=19.57 bars=3 stop=6.516825000000000045 peak=6.9228
  - JUPUSDC BUY ntl=373 risk=19.57 bars=3 stop=0.22997250000000001170 peak=0.24272
  - ASTERUSDC BUY ntl=391 risk=17.46 bars=3 stop=0.7296099999999999945 peak=0.76367
  - LTCUSDC BUY ntl=391 risk=13.31 bars=3 stop=53.12149999999999945 peak=54.991
  - HYPEUSDC BUY ntl=391 risk=12.58 bars=3 stop=81.10949999999999880 peak=83.804

- **HIP3**: 3 open, stop-risk **9.53 ZAR**
  - XYZ:DKNG BUY ntl=393 risk=5.87 bars=6 stop=23.333999999999998155 peak=23.688
  - XYZ:COST BUY ntl=391 risk=3.66 bars=4 stop=899.17999999999999060 peak=907.67
  - XYZ:CRWD BUY ntl=393 risk=0.00 bars=6 stop=206.820000000000005950 peak=210.6
...
- Latest scan 2026-09-08T19:32:11: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `lane_gate_blocked` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 69, "pair_held": 0, "regime_blocked": 5, "skipped": 0, "slice_full": 40, "slot_full": 0})
