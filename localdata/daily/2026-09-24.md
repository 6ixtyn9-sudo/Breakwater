# Breakwater daily print — 2026-09-24 14:18 UTC
...
- Ledger: 123998 decision rows; 251 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 123747 rows are skipped/guard decisions and never count
...
- **NATIVE**: 6 open, stop-risk **24.06 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.89 bars=5 stop=1.4427999999999999790 peak=1.5016
  - DOGEUSDC BUY ntl=125 risk=4.73 bars=5 stop=0.09086000000000000020 peak=0.094433
  - SOLUSDC BUY ntl=124 risk=4.23 bars=7 stop=111.4449999999999975 peak=115.38
  - BNBUSDC BUY ntl=124 risk=3.61 bars=9 stop=750.0500000000000280 peak=772.52
  - ETHUSDC BUY ntl=125 risk=3.37 bars=1 stop=2576.6000000000002520 peak=2648.0
  - BTCUSDC BUY ntl=124 risk=3.24 bars=20 stop=81796.74999999999985 peak=83989.0
...
- Latest scan 2026-09-24T12:43:49: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 22, "regime_blocked": 360, "skipped": 844, "slice_full": 0, "slot_full": 0})
