# Breakwater daily print — 2026-09-22 14:44 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **449.30 ZAR** | high-water: **474.55 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2498.14 ZAR** (seed 2000) | lifetime: **+498.14 ZAR** | closed: 230
- Today: 16 closed, **-47.37 ZAR**
- 7d: **+498.06 ZAR** | 30d: **+498.14 ZAR**
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 164.42 ZAR mean notional/trade: +0.68 ZAR/trade
- Realised (230 real closes per lane_gate._is_real_close, net of fees): +2.17 ZAR/trade | sd 5.82 | SE 0.38
- Gap: +1.49 ZAR/trade | t = +3.88 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
...
- Ledger: 94180 decision rows; 230 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 93950 rows are skipped/guard decisions and never count
...
- Closed: 37 | wins: 21 | win%: 56.8 | P&L: **-9.90 ZAR** | today: -12.80 | 7d: -14.85 | 30d: -9.90
...
- **NATIVE**: 7 open, stop-risk **40.56 ZAR**
  - BNBZAR BUY ntl=498 risk=10.49 bars=3 stop=12591.999999999999995 peak=12863.0
  - BTCZAR BUY ntl=498 risk=9.85 bars=3 stop=1372452.0000000000005 peak=1400141.0
  - SOLUSDC BUY ntl=127 risk=4.86 bars=14 stop=114.44499999999999970 peak=118.98
  - HYPEUSDC BUY ntl=126 risk=4.80 bars=9 stop=89.96399999999999715 peak=93.542
  - BNBUSDC BUY ntl=127 risk=3.91 bars=14 stop=775.7500000000000265 peak=800.28
  - BTCUSDC BUY ntl=127 risk=3.35 bars=13 stop=83664.25000000000005 peak=85933.0
  - ETHUSDC BUY ntl=125 risk=3.30 bars=6 stop=2656.3000000000001325 peak=2728.2

- **HIP3**: 3 open, stop-risk **9.05 ZAR**
  - PARA:COHR SELL ntl=125 risk=4.68 bars=0 stop=335.5075000000000165 peak=323.4
  - PARA:RDDT SELL ntl=125 risk=2.19 bars=0 stop=162.209850 peak=159.42
  - PARA:IGV SELL ntl=125 risk=2.19 bars=0 stop=108.587600 peak=106.72

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **49.61 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **37/50** | ghost rows: **399/50** | PnL: **-9.90 ZAR**
...
- Latest scan 2026-09-22T14:44:21: errors=3 signals=None regime_blocked=None
