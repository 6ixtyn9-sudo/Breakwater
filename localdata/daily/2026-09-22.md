# Breakwater daily print — 2026-09-22 11:40 UTC
...
- Equity: **2489.93 ZAR** (seed 2000) | lifetime: **+489.93 ZAR** | closed: 226
- Today: 12 closed, **-55.59 ZAR**
- 7d: **+491.90 ZAR** | 30d: **+489.93 ZAR**
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 164.01 ZAR mean notional/trade: +0.68 ZAR/trade
- Realised (226 real closes per lane_gate._is_real_close, net of fees): +2.17 ZAR/trade | sd 5.84 | SE 0.39
- Gap: +1.49 ZAR/trade | t = +3.84 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.436% over 239/246 slices (pool 760) ~ +0.76 ZAR | realised 193 closes +2.63 ZAR sd 6.07 SE 0.44 | gap +1.88 t +4.29 | EXCEEDS
...
- Ledger: 92367 decision rows; 226 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 92141 rows are skipped/guard decisions and never count
...
- Closed: 193 | wins: 118 | win%: 61.1 | P&L: **+508.03 ZAR** | today: -34.58 | 7d: +512.91 | 30d: +508.03
- By exit: target +506.4, horizon +97.8, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 61/+292.2, bull 66/+232.3, bear 66/-16.4
...
- **NATIVE**: 7 open, stop-risk **40.56 ZAR**
  - BNBZAR BUY ntl=498 risk=10.49 bars=0 stop=12591.999999999999995 peak=12863.0
  - BTCZAR BUY ntl=498 risk=9.85 bars=0 stop=1372452.0000000000005 peak=1400141.0
  - SOLUSDC BUY ntl=127 risk=4.86 bars=11 stop=114.44499999999999970 peak=118.98
  - HYPEUSDC BUY ntl=126 risk=4.80 bars=6 stop=89.96399999999999715 peak=93.542
  - BNBUSDC BUY ntl=127 risk=3.91 bars=10 stop=775.7500000000000265 peak=800.28
  - BTCUSDC BUY ntl=127 risk=3.35 bars=10 stop=83664.25000000000005 peak=85933.0
  - ETHUSDC BUY ntl=125 risk=3.30 bars=3 stop=2656.3000000000001325 peak=2728.2

- **HIP3**: 4 open, stop-risk **19.27 ZAR**
  - PARA:CIEN SELL ntl=248 risk=6.81 bars=20 stop=374.53749999999999845 peak=364.52
  - PARA:LRCX SELL ntl=254 risk=5.00 bars=14 stop=309.01249999999999675 peak=303.04
  - PARA:COHR SELL ntl=124 risk=4.27 bars=21 stop=337.78750000000002090 peak=326.53
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=21 stop=252.9599999999999910 peak=246.63
...
- Closed paper trades: **33/50** | ghost rows: **380/50** | PnL: **-18.11 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+122.94 | frozen=NO
...
- Latest scan 2026-09-22T11:40:45: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 9, "regime_blocked": 424, "skipped": 725, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=11
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "BNBUSDC"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:XBI"}]
