# Breakwater daily print — 2026-09-22 03:40 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **453.64 ZAR** | high-water: **474.55 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2523.08 ZAR** (seed 2000) | lifetime: **+523.08 ZAR** | closed: 220
- Today: 6 closed, **-22.43 ZAR**
- 7d: **+520.09 ZAR** | 30d: **+523.08 ZAR**
...
- Book: 271 slices (native 246 | hip3 25); validated pools: native 760 | hip3 160; book slices absent from pools: 11
  ...
  - ... and 1 more
- Claimed edge (median mean_ret_costadj over 260 book slices present in the validated pools): +0.412% | at 159.33 ZAR mean notional/trade: +0.66 ZAR/trade
- Realised (220 real closes per lane_gate._is_real_close, net of fees): +2.38 ZAR/trade | sd 5.74 | SE 0.39
- Gap: +1.72 ZAR/trade | t = +4.44 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
...
- Ledger: 87739 decision rows; 220 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 87519 rows are skipped/guard decisions and never count
...
- Closed: 188 | wins: 118 | win%: 62.8 | P&L: **+531.08 ZAR** | today: -11.53 | 7d: +531.08 | 30d: +531.08
...
- Closed: 32 | wins: 19 | win%: 59.4 | P&L: **-8.00 ZAR** | today: -10.90 | 7d: -10.99 | 30d: -8.00
...
- **NATIVE**: 8 open, stop-risk **70.70 ZAR**
  - BTCUSDC BUY ntl=509 risk=18.46 bars=5 stop=83480.24999999999985 peak=86621.0
  - BTCZAR BUY ntl=509 risk=16.49 bars=5 stop=1366578.2500000000010 peak=1412312.0
  - ETHZAR BUY ntl=505 risk=14.47 bars=8 stop=43676.25 peak=44966.0
  - SOLUSDC BUY ntl=127 risk=4.86 bars=3 stop=114.44499999999999970 peak=118.98
  - ETHUSDC BUY ntl=121 risk=4.72 bars=15 stop=2620.5999999999998675 peak=2727.2
  - HYPEUSDC BUY ntl=124 risk=4.44 bars=13 stop=91.43674999999999890 peak=94.838
  - BNBUSDC BUY ntl=127 risk=3.91 bars=3 stop=775.7500000000000265 peak=800.28
  - BTCUSDC BUY ntl=127 risk=3.35 bars=2 stop=83664.25000000000005 peak=85933.0
...
- **HIP3**: 5 open, stop-risk **29.15 ZAR**
  ...
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=13 stop=252.9599999999999910 peak=246.63

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **99.85 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **32/50** | ghost rows: **325/50** | PnL: **-8.00 ZAR**
...
- Latest scan 2026-09-22T03:40:13: errors=3 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 9, "regime_blocked": 497, "skipped": 719, "slice_full": 1, "slot_full": 0})
