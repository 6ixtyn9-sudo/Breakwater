# Breakwater daily print — 2026-09-16 19:11 UTC
...
- hip3: claimed median +0.064% over 10/17 slices (pool 160) ~ +0.06 ZAR | realised 22 closes +0.53 ZAR sd 1.86 | INSUFFICIENT SAMPLE (n<30)
- Ledger: 27572 decision rows; 85 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 27487 rows are skipped/guard decisions and never count
...
- **NATIVE**: 10 open, stop-risk **35.46 ZAR**
  - ARBUSDC SELL ntl=84 risk=4.94 bars=6 stop=0.17935714285714285 peak=0.16938
  - WLDUSDC BUY ntl=98 risk=4.59 bars=0 stop=0.349429999999999955 peak=0.36664
  - TRUMPUSDC BUY ntl=98 risk=4.47 bars=0 stop=1.7770750000000000540 peak=1.8622
  - ZECUSDC SELL ntl=98 risk=4.40 bars=0 stop=1396.5035714285714 peak=1336.3
  - SUIUSDC BUY ntl=98 risk=3.82 bars=0 stop=0.6670574999999999860 peak=0.6942
  - PUMPUSDC SELL ntl=98 risk=3.79 bars=2 stop=0.003815571428571429 peak=0.003674
  - TAOUSDC BUY ntl=98 risk=3.74 bars=0 stop=209.3224999999999935 peak=217.66
  - SOLUSDC BUY ntl=98 risk=2.91 bars=0 stop=94.85499999999999515 peak=97.766
  - BNBUSDC BUY ntl=98 risk=2.06 bars=0 stop=700.2850000000000755 peak=715.4
  - PUMPUSDT SELL ntl=98 risk=0.74 bars=1 stop=0.0036834199999999997 peak=0.003656

- **HIP3**: 6 open, stop-risk **12.87 ZAR**
  - PARA:CRDO SELL ntl=98 risk=3.72 bars=0 stop=167.7850000000000085 peak=161.63
  - PARA:COHR SELL ntl=99 risk=3.38 bars=5 stop=294.5500000000000190 peak=284.79
  - PARA:IREN SELL ntl=98 risk=2.75 bars=3 stop=44.663250000000000375 peak=43.45
  - PARA:SMCI SELL ntl=98 risk=1.34 bars=0 stop=37.058749999999999995 peak=36.558
  - PARA:GLW SELL ntl=99 risk=1.18 bars=5 stop=148.99000000000001205 peak=147.23
  - PARA:AVGO SELL ntl=99 risk=0.51 bars=5 stop=344.77249999999998465 peak=342.99

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **48.34 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **22/50** | ghost rows: **93/50** | PnL: **+11.59 ZAR**
...
- Label: **bear** | breadth bear=0.5667 bull=0.0333 neutral=0.3667 | symbols=29
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 26 / bull 0
- as_of: 2026-09-16T19:00:30Z
...
- Latest scan 2026-09-16T19:11:30: errors=4 signals=None regime_blocked=None
