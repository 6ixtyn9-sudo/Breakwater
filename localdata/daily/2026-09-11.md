# Breakwater daily print — 2026-09-11 11:27 UTC
...
- Ledger: 122989 decision rows; 108 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 122881 rows are skipped/guard decisions and never count
...
- **HIP3**: 1 open, stop-risk **0.76 ZAR**
  - XYZ:STRC BUY ntl=368 risk=0.76 bars=20 stop=97.66200000000000180 peak=97.864
...
- Closed paper trades: **29/50** | ghost rows: **148/50** | PnL: **-26.98 ZAR**
...
- Latest scan 2026-09-11T11:06:09: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 7, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 6, "regime_blocked": 593, "skipped": 11, "slice_full": 0, "slot_full": 144})
