# Breakwater daily print — 2026-09-26 05:43 UTC
...
- Ledger: 148369 decision rows; 266 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 148103 rows are skipped/guard decisions and never count
...
- Closed: 224 | wins: 134 | win%: 59.8 | P&L: **+493.80 ZAR** | today: -1.15 | 7d: +428.43 | 30d: +493.80
...
- **NATIVE**: 5 open, stop-risk **15.95 ZAR**
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=23 stop=88.47099999999999610 peak=91.951
  - SOLUSDC BUY ntl=125 risk=4.63 bars=0 stop=116.19749999999999280 peak=120.65
  - BNBUSDC BUY ntl=126 risk=2.20 bars=18 stop=763.59900 peak=777.2
  - ETHUSDC BUY ntl=125 risk=2.19 bars=0 stop=2642.43375 peak=2689.5
  - BTCUSDC BUY ntl=125 risk=2.19 bars=21 stop=82556.52750 peak=84027.0
...
- Computed open stop-risk (section 4): **45.54 ZAR** (informational only, no cap applied)
- Paper shadow ledger (gates paper entries only, nothing live): **45.54 / 175.57 ZAR | 29.0% | ok**
- Remaining: 124.6990 | cap skips: 0 | unknown skips: 0
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 32, "skipped": 32, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 2, "pair_held": 4, "signals": 757, "skipped": 751, "slice_full": 0, "slot_full": 0}}
...
- Latest scan 2026-09-26T05:43:38: errors=0 signals=789 regime_blocked=375
- this cycle: closed=0 new_signals=789 skipped=783 slot_full=0 slice_full=0 pair_held=4
- Action funnel: regime_blocked=375 | lane_gate_blocked=7 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=4 | slot_full=0 | skipped=783
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 7, "pair_held": 4, "regime_blocked": 375, "skipped": 783, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=16 blocks=13
- aggregate_risk: ok open=38.7200 cap=175.5709 used=0.2898 remaining=124.6990 replayed=3 no_new_bars=3
- pair_errors: []
