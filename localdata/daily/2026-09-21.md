# Breakwater daily print — 2026-09-21 10:39 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **435.83 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2378.85 ZAR** (seed 2000) | lifetime: **+378.85 ZAR** | closed: 201
- Today: 16 closed, **+100.77 ZAR**
- 7d: **+378.85 ZAR** | 30d: **+378.85 ZAR**
...
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.382% | at 146.25 ZAR mean notional/trade: +0.56 ZAR/trade
- Realised (201 real closes per lane_gate._is_real_close, net of fees): +1.88 ZAR/trade | sd 4.65 | SE 0.33
- Gap: +1.33 ZAR/trade | t = +4.04 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.388% over 242/245 slices (pool 676) ~ +0.60 ZAR | realised 171 closes +2.20 ZAR sd 4.89 SE 0.37 | gap +1.60 t +4.27 | EXCEEDS
...
- Ledger: 79625 decision rows; 201 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 79424 rows are skipped/guard decisions and never count
...
- Closed: 171 | wins: 103 | win%: 60.2 | P&L: **+375.95 ZAR** | today: +100.77 | 7d: +375.95 | 30d: +375.95
- By exit: target +378.0, horizon +94.2, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 59/+281.9, bull 46/+110.5, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 37n/32w +283.35; feat_close_pos_ma:2:LONG:h12 10n/9w +29.78; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58
...
- Top pairs: LINKZAR 28n +269.82; XRPZAR 2n +18.07; BTCUSDC 11n +17.42; SUIUSDC 3n +14.91; LINKUSDC 7n +12.46
...
- **NATIVE**: 11 open, stop-risk **70.31 ZAR**
  - BTCUSDC BUY ntl=476 risk=14.18 bars=0 stop=82209.25000000000015 peak=84735.0
  - BTCZAR BUY ntl=476 risk=13.19 bars=0 stop=1343694.00 peak=1381998.0
  - XRPUSDC BUY ntl=233 risk=8.90 bars=3 stop=1.3826000000000000025 peak=1.4375
  - SOLZAR BUY ntl=236 risk=7.88 bars=1 stop=1737.0000000000000030 peak=1797.0
  - LTCZAR BUY ntl=229 risk=4.57 bars=10 stop=920.200000000000010 peak=938.9
  - XRPUSDC BUY ntl=117 risk=4.45 bars=3 stop=1.3826000000000000025 peak=1.4375
  - BNBUSDC BUY ntl=118 risk=3.93 bars=1 stop=756.3099999999999955 peak=782.37
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=20 stop=87.90974999999999825 peak=90.96
  - BTCUSDC BUY ntl=119 risk=3.55 bars=0 stop=82209.25000000000015 peak=84735.0
  - SOLUSDC BUY ntl=113 risk=3.34 bars=14 stop=107.21000000000000570 peak=110.47
  - ETHUSDC BUY ntl=113 risk=2.61 bars=14 stop=2572.9500000000001090 peak=2633.7
...
- Computed open stop-risk (section 4): **70.31 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:2:LONG:h12` edge=0.0092 n=1092 p=0.3222 src=validated_walk_forward unproven=False paper=10n/+29.78
...
- Closed paper trades: **30/50** | ghost rows: **284/50** | PnL: **+2.90 ZAR**
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 15
- as_of: 2026-09-21T10:00:29Z
...
- Native lane: **GREEN** | closed=20 pnl=+140.65 | frozen=NO
...
- Latest scan 2026-09-21T10:39:52: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 106, "regime_blocked": 586, "skipped": 855, "slice_full": 4, "slot_full": 0})
