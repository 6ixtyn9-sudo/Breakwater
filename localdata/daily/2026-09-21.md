# Breakwater daily print — 2026-09-21 13:39 UTC
...
- Equity: **2430.43 ZAR** (seed 2000) | lifetime: **+430.43 ZAR** | closed: 206
- Today: 21 closed, **+152.35 ZAR**
- 7d: **+430.43 ZAR** | 30d: **+430.43 ZAR**
...
- Claimed edge (median mean_ret_costadj over 263 book slices present in the validated pools): +0.382% | at 149.59 ZAR mean notional/trade: +0.57 ZAR/trade
- Realised (206 real closes per lane_gate._is_real_close, net of fees): +2.09 ZAR/trade | sd 4.87 | SE 0.34
- Gap: +1.52 ZAR/trade | t = +4.48 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.388% over 242/245 slices (pool 676) ~ +0.61 ZAR | realised 176 closes +2.43 ZAR sd 5.11 SE 0.39 | gap +1.82 t +4.71 | EXCEEDS
...
- Ledger: 81911 decision rows; 206 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 81705 rows are skipped/guard decisions and never count
...
- Closed: 176 | wins: 108 | win%: 61.4 | P&L: **+427.53 ZAR** | today: +152.35 | 7d: +427.53 | 30d: +427.53
- By exit: target +420.4, horizon +103.3, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 60/+287.6, bull 50/+156.4, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 37n/32w +283.35; feat_close_pos_ma:2:LONG:h12 13n/12w +72.22; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_bb_pos_20:2:LONG:h15 4n/4w +16.17; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77
...
- Top pairs: LINKZAR 28n +269.82; LTCZAR 6n +42.81; XRPZAR 2n +18.07; BTCUSDC 11n +17.42; SUIUSDC 3n +14.91
...
- **NATIVE**: 10 open, stop-risk **80.56 ZAR**
  - LTCZAR BUY ntl=486 risk=16.05 bars=0 stop=907.9000000000000285 peak=938.9
  - BTCUSDC BUY ntl=476 risk=14.18 bars=3 stop=82209.25000000000015 peak=84735.0
  - BTCZAR BUY ntl=476 risk=13.19 bars=3 stop=1343694.00 peak=1381998.0
  - XRPUSDC BUY ntl=233 risk=8.90 bars=6 stop=1.3826000000000000025 peak=1.4375
  - SOLZAR BUY ntl=236 risk=7.88 bars=4 stop=1737.0000000000000030 peak=1797.0
  - ETHUSDC BUY ntl=121 risk=4.72 bars=1 stop=2620.5999999999998675 peak=2727.2
  - XRPUSDC BUY ntl=117 risk=4.45 bars=6 stop=1.3826000000000000025 peak=1.4375
  - BNBUSDC BUY ntl=118 risk=3.93 bars=4 stop=756.3099999999999955 peak=782.37
  - HYPEUSDC BUY ntl=110 risk=3.70 bars=23 stop=87.90974999999999825 peak=90.96
  - BTCUSDC BUY ntl=119 risk=3.55 bars=3 stop=82209.25000000000015 peak=84735.0
...
- Computed open stop-risk (section 4): **80.56 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:2:LONG:h12` edge=0.0092 n=1092 p=0.3222 src=validated_walk_forward unproven=False paper=13n/+72.22
...
- Native lane: **GREEN** | closed=20 pnl=+151.44 | frozen=NO
...
- Latest scan 2026-09-21T13:39:14: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 83, "regime_blocked": 580, "skipped": 846, "slice_full": 1, "slot_full": 0})
