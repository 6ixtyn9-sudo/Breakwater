# Breakwater daily print — 2026-09-21 20:40 UTC
...
- Equity: **2522.42 ZAR** (seed 2000) | lifetime: **+522.42 ZAR** | closed: 211
- Today: 26 closed, **+244.34 ZAR**
- 7d: **+522.42 ZAR** | 30d: **+522.42 ZAR**
...
- Claimed edge (median mean_ret_costadj over 264 book slices present in the validated pools): +0.382% | at 153.44 ZAR mean notional/trade: +0.59 ZAR/trade
- Realised (211 real closes per lane_gate._is_real_close, net of fees): +2.48 ZAR/trade | sd 5.69 | SE 0.39
- Gap: +1.89 ZAR/trade | t = +4.82 (one-sample t of realised mean vs the claimed constant) | verdict: EXCEEDS
- native: claimed median +0.389% over 243/246 slices (pool 676) ~ +0.63 ZAR | realised 181 closes +2.87 ZAR sd 5.99 SE 0.45 | gap +2.24 t +5.03 | EXCEEDS
...
- Ledger: 84465 decision rows; 211 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 84254 rows are skipped/guard decisions and never count
...
- Closed: 181 | wins: 113 | win%: 62.4 | P&L: **+519.52 ZAR** | today: +244.34 | 7d: +519.52 | 30d: +519.52
- By exit: target +497.6, horizon +118.0, regime_shift -11.9, stop -84.3
- By entry regime (n/pnl): neutral 61/+292.2, bull 54/+243.8, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 37n/32w +283.35; feat_close_pos_ma:2:LONG:h12 17n/16w +159.61; feat_ext_strength:2:LONG:h15 12n/8w +24.00; feat_bb_pos_20:2:LONG:h15 4n/4w +16.17; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77
...
- **NATIVE**: 10 open, stop-risk **95.27 ZAR**
  - SOLZAR BUY ntl=496 risk=17.31 bars=6 stop=1865.5000000000000025 peak=1933.0
  - BNBZAR BUY ntl=503 risk=15.02 bars=5 stop=12643.499999999999985 peak=13033.0
  - ETHZAR BUY ntl=505 risk=14.47 bars=1 stop=43676.25 peak=44966.0
  - BTCUSDC BUY ntl=476 risk=14.18 bars=10 stop=82209.25000000000015 peak=84735.0
  - BTCZAR BUY ntl=476 risk=13.19 bars=10 stop=1343694.00 peak=1381998.0
  - ETHUSDC BUY ntl=121 risk=4.72 bars=8 stop=2620.5999999999998675 peak=2727.2
  - XRPUSDC BUY ntl=117 risk=4.45 bars=13 stop=1.3826000000000000025 peak=1.4375
  - HYPEUSDC BUY ntl=124 risk=4.44 bars=6 stop=91.43674999999999890 peak=94.838
  - BNBUSDC BUY ntl=118 risk=3.93 bars=11 stop=756.3099999999999955 peak=782.37
  - BTCUSDC BUY ntl=119 risk=3.55 bars=10 stop=82209.25000000000015 peak=84735.0

- **HIP3**: 6 open, stop-risk **34.71 ZAR**
  - PARA:CIFR SELL ntl=248 risk=9.88 bars=6 stop=19.379999999999999455 peak=18.637
  - PARA:AVGO SELL ntl=248 risk=6.90 bars=6 stop=365.2225000000000405 peak=355.33
  - PARA:CIEN SELL ntl=248 risk=6.81 bars=6 stop=374.53749999999999845 peak=364.52
  - PARA:COHR SELL ntl=124 risk=4.27 bars=6 stop=337.78750000000002090 peak=326.53
  - PARA:CRDO SELL ntl=124 risk=3.66 bars=6 stop=190.46999999999999175 peak=185.0
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=6 stop=252.9599999999999910 peak=246.63

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **129.97 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:2:LONG:h12` edge=0.0092 n=1092 p=0.3222 src=validated_walk_forward unproven=False paper=17n/+159.61
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 25
- as_of: 2026-09-21T20:00:27Z
...
- Native lane: **GREEN** | closed=20 pnl=+199.08 | frozen=NO
...
- Latest scan 2026-09-21T20:40:02: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 77, "regime_blocked": 284, "skipped": 707, "slice_full": 6, "slot_full": 195})
