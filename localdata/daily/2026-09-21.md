# Breakwater daily print — 2026-09-21 19:39 UTC
...
- Ledger: 84150 decision rows; 211 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 83939 rows are skipped/guard decisions and never count
...
- **NATIVE**: 10 open, stop-risk **95.27 ZAR**
  - SOLZAR BUY ntl=496 risk=17.31 bars=5 stop=1865.5000000000000025 peak=1933.0
  - BNBZAR BUY ntl=503 risk=15.02 bars=4 stop=12643.499999999999985 peak=13033.0
  - ETHZAR BUY ntl=505 risk=14.47 bars=0 stop=43676.25 peak=44966.0
  - BTCUSDC BUY ntl=476 risk=14.18 bars=9 stop=82209.25000000000015 peak=84735.0
  - BTCZAR BUY ntl=476 risk=13.19 bars=9 stop=1343694.00 peak=1381998.0
  - ETHUSDC BUY ntl=121 risk=4.72 bars=7 stop=2620.5999999999998675 peak=2727.2
  - XRPUSDC BUY ntl=117 risk=4.45 bars=12 stop=1.3826000000000000025 peak=1.4375
  - HYPEUSDC BUY ntl=124 risk=4.44 bars=5 stop=91.43674999999999890 peak=94.838
  - BNBUSDC BUY ntl=118 risk=3.93 bars=10 stop=756.3099999999999955 peak=782.37
  - BTCUSDC BUY ntl=119 risk=3.55 bars=9 stop=82209.25000000000015 peak=84735.0

- **HIP3**: 6 open, stop-risk **34.71 ZAR**
  - PARA:CIFR SELL ntl=248 risk=9.88 bars=5 stop=19.379999999999999455 peak=18.637
  - PARA:AVGO SELL ntl=248 risk=6.90 bars=5 stop=365.2225000000000405 peak=355.33
  - PARA:CIEN SELL ntl=248 risk=6.81 bars=2 stop=374.53749999999999845 peak=364.52
  - PARA:COHR SELL ntl=124 risk=4.27 bars=5 stop=337.78750000000002090 peak=326.53
  - PARA:CRDO SELL ntl=124 risk=3.66 bars=5 stop=190.46999999999999175 peak=185.0
  - PARA:CRWD SELL ntl=124 risk=3.18 bars=5 stop=252.9599999999999910 peak=246.63
...
- Latest scan 2026-09-21T19:39:52: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 78, "regime_blocked": 278, "skipped": 672, "slice_full": 2, "slot_full": 196})
