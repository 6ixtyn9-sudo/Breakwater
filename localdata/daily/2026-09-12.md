# Breakwater daily print — 2026-09-12 07:06 UTC
...
- Ledger: 144699 decision rows; 128 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 144571 rows are skipped/guard decisions and never count
...
- **NATIVE**: 3 open, stop-risk **35.44 ZAR**
  - DOGEUSDC BUY ntl=339 risk=17.86 bars=12 stop=0.07961000000000000190 peak=0.084031
  - SOLUSDC BUY ntl=319 risk=17.58 bars=10 stop=96.85199999999999725 peak=102.5
  - XMRUSDC BUY ntl=355 risk=0.00 bars=11 stop=521.50999999999998150 peak=540.99
...
- Computed open stop-risk (section 4): **54.97 ZAR** (informational only, no cap applied)
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 59 / bull 0
- as_of: 2026-09-12T07:00:21Z
...
- Latest scan 2026-09-12T07:06:03: errors=1 signals=None regime_blocked=None
