# Breakwater daily print — 2026-09-12 15:40 UTC
...
- Ledger: 158635 decision rows; 129 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 158506 rows are skipped/guard decisions and never count
...
- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=25 stop=359.37499999999998860 peak=364.3
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=21 stop=109.37749999999999265 peak=110.76
...
- Closed paper trades: **31/50** | ghost rows: **203/50** | PnL: **-20.70 ZAR**
...
- Latest scan 2026-09-12T15:40:22: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 62, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 59, "regime_blocked": 766, "skipped": 122, "slice_full": 6, "slot_full": 0})
