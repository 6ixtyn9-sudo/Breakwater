# Breakwater daily print — 2026-09-12 21:26 UTC
...
- Ledger: 167721 decision rows; 130 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 167591 rows are skipped/guard decisions and never count
...
- Label: **neutral** | breadth bear=0.4118 bull=0.1176 neutral=0.4706 | symbols=17
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **False** | flipped_from: bear | consecutive_bear: 64 / bull 0
- as_of: 2026-09-12T21:25:29Z
...
- Latest scan 2026-09-12T21:06:07: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 6, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 8, "regime_blocked": 743, "skipped": 9, "slice_full": 0, "slot_full": 132})
