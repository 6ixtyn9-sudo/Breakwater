# Breakwater daily print — 2026-09-12 11:27 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **399.67 ZAR** | high-water: **435.05 ZAR**
...
- Ledger: 150790 decision rows; 129 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 150661 rows are skipped/guard decisions and never count
...
- **NATIVE**: 9 open, stop-risk **90.57 ZAR**
  - DOGEUSDC BUY ntl=339 risk=17.86 bars=16 stop=0.07961000000000000190 peak=0.084031
  - ARBUSDC BUY ntl=342 risk=17.66 bars=3 stop=0.1367324999999999930 peak=0.14417
  - INJUSDC BUY ntl=353 risk=17.52 bars=3 stop=5.670149999999999605 peak=5.9661
  - HYPEUSDC BUY ntl=353 risk=10.99 bars=3 stop=76.49774999999999815 peak=78.955
  - KPEPEUSDC BUY ntl=353 risk=9.52 bars=3 stop=0.003256750000000000055 peak=0.003347
  - LTCUSDC BUY ntl=353 risk=7.61 bars=1 stop=52.93850000000000305 peak=54.106
  - BNBUSDC BUY ntl=353 risk=4.98 bars=1 stop=725.1625000000000595 peak=735.54
  - ETHUSDC BUY ntl=353 risk=4.43 bars=1 stop=2498.8500000000000015 peak=2530.6
  - XMRUSDC BUY ntl=355 risk=0.00 bars=15 stop=526.16999999999998150 peak=545.65

- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=19 stop=359.37499999999998860 peak=364.3
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=16 stop=109.37749999999999265 peak=110.76
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=15 stop=283.88000000000002330 peak=287.39
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=16 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=20 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=19 stop=98.1800000000000016850 peak=98.385
...
- Closed paper trades: **31/50** | ghost rows: **173/50** | PnL: **-20.70 ZAR**
...
- Latest scan 2026-09-12T11:09:57: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 59, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 5, "pair_held": 53, "regime_blocked": 717, "skipped": 122, "slice_full": 3, "slot_full": 0})
