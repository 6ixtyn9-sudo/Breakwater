# Breakwater daily print — 2026-09-12 06:10 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **399.21 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1764.39 ZAR** (seed 2000) | lifetime: **-235.61 ZAR** | closed: 127
- Today: 2 closed, **-2.33 ZAR**
- 7d: **-196.35 ZAR** | 30d: **-235.61 ZAR**

## 2b. Claimed vs realised

- Book: 48 slices (native 31 | hip3 17); validated pools: native 524 | hip3 464; book slices absent from pools: 0
- Claimed edge (median mean_ret_costadj over 48 book slices present in the validated pools): +0.421% | at 384.09 ZAR mean notional/trade: +1.62 ZAR/trade
- Realised (127 real closes per lane_gate._is_real_close, net of fees): -1.86 ZAR/trade | sd 8.56 | SE 0.76
- Gap: -3.47 ZAR/trade | t = -4.57 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed median +0.525% over 31/31 slices (pool 524) ~ +2.01 ZAR | realised 96 closes -2.24 ZAR sd 9.55 SE 0.97 | gap -4.25 t -4.36 | FALLS SHORT
...
- Ledger: 143661 decision rows; 127 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 143534 rows are skipped/guard decisions and never count
...
- Closed: 96 | wins: 38 | win%: 39.6 | P&L: **-214.91 ZAR** | today: -2.33 | 7d: -190.80 | 30d: -214.91
- By exit: target +101.5, trail_stop +45.1, lane_gate +7.6, rotated -47.9, horizon -99.5, stop -221.6
- By entry regime (n/pnl): bull 24/+10.8, bear 24/-14.6, neutral 48/-211.1
...
- **NATIVE**: 4 open, stop-risk **50.77 ZAR**
  - DOGEUSDC BUY ntl=339 risk=17.86 bars=11 stop=0.07961000000000000190 peak=0.084031
  - SOLUSDC BUY ntl=319 risk=17.58 bars=9 stop=96.85199999999999725 peak=102.5
  - LTCUSDC BUY ntl=355 risk=15.33 bars=10 stop=51.16399999999999820 peak=53.475
  - XMRUSDC BUY ntl=355 risk=0.00 bars=10 stop=521.50999999999998150 peak=540.99

- **HIP3**: 6 open, stop-risk **19.53 ZAR**
  - XYZ:AVGO BUY ntl=364 risk=4.92 bars=16 stop=359.37499999999998860 peak=364.3
  - XYZ:EWT BUY ntl=357 risk=4.46 bars=11 stop=109.37749999999999265 peak=110.76
  - XYZ:HYUNDAI BUY ntl=357 risk=4.36 bars=10 stop=283.88000000000002330 peak=287.39
  - XYZ:EBAY BUY ntl=357 risk=4.18 bars=10 stop=105.88750000000000230 peak=107.14
  - XYZ:COST BUY ntl=364 risk=1.61 bars=15 stop=899.50250000000005440 peak=903.5
  - XYZ:STRC BUY ntl=365 risk=0.00 bars=14 stop=98.1790000000000016850 peak=98.384

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **70.30 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_trend_slope_20:2:LONG:h11` edge=0.0065 n=17661 p=0.0000 src=validated_walk_forward unproven=False paper=1n/+0.42
...
- confirmed_bear: **True** | confirmed_bull: **False** | flip: **True** | flipped_from: bear | consecutive_bear: 57 / bull 0
- as_of: 2026-09-12T06:00:28Z
...
- Native lane: **RED** | closed=20 pnl=-20.09 | frozen=YES
...
- Latest scan 2026-09-12T06:10:19: errors=5 signals=None regime_blocked=None
