# Breakwater daily print — 2026-09-25 14:43 UTC
...
- Ledger: 140752 decision rows; 262 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 140490 rows are skipped/guard decisions and never count
...
- Closed: 221 | wins: 132 | win%: 59.7 | P&L: **+487.54 ZAR** | today: +6.21 | 7d: +458.44 | 30d: +487.54
...
- **NATIVE**: 6 open, stop-risk **20.31 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.79 bars=7 stop=1.4715999999999999645 peak=1.5302
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=8 stop=88.47099999999999610 peak=91.951
  - SOLUSDC BUY ntl=125 risk=3.90 bars=9 stop=112.73749999999999790 peak=116.36
  - ETHUSDC BUY ntl=126 risk=2.50 bars=3 stop=2660.8250000000000030 peak=2714.7
  - BNBUSDC BUY ntl=126 risk=2.20 bars=3 stop=763.59900 peak=777.2
  - BTCUSDC BUY ntl=125 risk=2.19 bars=6 stop=82556.52750 peak=84027.0
...
- **HIP3**: 3 open, stop-risk **26.37 ZAR**
  ...
  - PARA:COHR SELL ntl=502 risk=8.79 bars=0 stop=298.870275 peak=293.73
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 3, "pair_held": 0, "signals": 121, "skipped": 115, "slice_full": 3, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 24, "signals": 830, "skipped": 806, "slice_full": 0, "slot_full": 0}}
...
- Latest scan 2026-09-25T14:43:28: errors=0 signals=951 regime_blocked=502
- this cycle: closed=2 new_signals=951 skipped=921 slot_full=0 slice_full=3 pair_held=24
- Action funnel: regime_blocked=502 | lane_gate_blocked=6 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=3 | pair_held=24 | slot_full=0 | skipped=921
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 24, "regime_blocked": 502, "skipped": 921, "slice_full": 3, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=20.3083 cap=175.7800 used=0.2977 remaining=123.4578 replayed=9 no_new_bars=0
- pair_errors: []
