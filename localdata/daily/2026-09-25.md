# Breakwater daily print — 2026-09-25 00:34 UTC
...
- Ledger: 131772 decision rows; 253 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 131519 rows are skipped/guard decisions and never count
...
- Closed: 215 | wins: 128 | win%: 59.5 | P&L: **+481.33 ZAR** | today: +0.00 | 7d: +513.89 | 30d: +481.33
...
- **NATIVE**: 6 open, stop-risk **23.60 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.89 bars=17 stop=1.4427999999999999790 peak=1.5016
  - DOGEUSDC BUY ntl=125 risk=4.73 bars=17 stop=0.09086000000000000020 peak=0.094433
  - SOLUSDC BUY ntl=124 risk=4.23 bars=19 stop=111.4449999999999975 peak=115.38
  - BTCUSDC BUY ntl=125 risk=3.57 bars=8 stop=81996.50000000000005 peak=84407.0
  - ETHUSDC BUY ntl=125 risk=3.37 bars=13 stop=2576.6000000000002520 peak=2648.0
  - BNBUSDC BUY ntl=125 risk=2.82 bars=1 stop=759.185000000000005 peak=776.69
...
- **HIP3**: 3 open, stop-risk **20.14 ZAR**
  ...
  - PARA:IGV SELL ntl=250 risk=4.37 bars=10 stop=108.546900 peak=106.68
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 25, "skipped": 24, "slice_full": 1, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 51, "signals": 804, "skipped": 753, "slice_full": 0, "slot_full": 0}}
...
- Latest scan 2026-09-25T00:34:41: errors=0 signals=829 regime_blocked=545
- this cycle: closed=0 new_signals=829 skipped=777 slot_full=0 slice_full=1 pair_held=51
- Action funnel: regime_blocked=545 | lane_gate_blocked=8 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=1 | pair_held=51 | slot_full=0 | skipped=777
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 8, "pair_held": 51, "regime_blocked": 545, "skipped": 777, "slice_full": 1, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=43.7351 cap=174.8883 used=0.2715 remaining=127.4086 replayed=7 no_new_bars=2
- pair_errors: []
