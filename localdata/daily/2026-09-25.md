# Breakwater daily print — 2026-09-25 04:46 UTC
...
- Ledger: 134291 decision rows; 255 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 134036 rows are skipped/guard decisions and never count
...
- Closed: 217 | wins: 130 | win%: 59.9 | P&L: **+484.27 ZAR** | today: +2.94 | 7d: +492.80 | 30d: +484.27
...
- **NATIVE**: 4 open, stop-risk **13.98 ZAR**
  - SOLUSDC BUY ntl=124 risk=4.23 bars=23 stop=111.4449999999999975 peak=115.38
  - BTCUSDC BUY ntl=125 risk=3.57 bars=12 stop=81996.50000000000005 peak=84407.0
  - ETHUSDC BUY ntl=125 risk=3.37 bars=17 stop=2576.6000000000002520 peak=2648.0
  - BNBUSDC BUY ntl=125 risk=2.82 bars=5 stop=759.185000000000005 peak=776.69
...
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 44, "skipped": 43, "slice_full": 1, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 13, "signals": 840, "skipped": 827, "slice_full": 0, "slot_full": 0}}
- Highest-risk: **PARA:GLW** 9.6500 ZAR
- positions without bars: 3 | replayed: 4 | invalid: 0
...
- Latest scan 2026-09-25T04:46:25: errors=0 signals=884 regime_blocked=501
- this cycle: closed=0 new_signals=884 skipped=870 slot_full=0 slice_full=1 pair_held=13
- Action funnel: regime_blocked=501 | lane_gate_blocked=6 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=1 | pair_held=13 | slot_full=0 | skipped=870
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 13, "regime_blocked": 501, "skipped": 870, "slice_full": 1, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=34.1154 cap=175.0939 used=0.2127 remaining=137.8586 replayed=4 no_new_bars=3
- pair_errors: []
