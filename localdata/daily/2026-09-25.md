# Breakwater daily print — 2026-09-25 09:01 UTC
...
- Ledger: 136159 decision rows; 257 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 135902 rows are skipped/guard decisions and never count
...
- **NATIVE**: 5 open, stop-risk **19.60 ZAR**
  - XRPUSDC BUY ntl=125 risk=4.79 bars=0 stop=1.4715999999999999645 peak=1.5302
  - HYPEUSDC BUY ntl=125 risk=4.74 bars=1 stop=88.47099999999999610 peak=91.951
  - SOLUSDC BUY ntl=125 risk=3.90 bars=2 stop=112.73749999999999790 peak=116.36
  - ETHUSDC BUY ntl=125 risk=3.37 bars=20 stop=2576.6000000000002520 peak=2648.0
  - BNBUSDC BUY ntl=125 risk=2.82 bars=8 stop=759.185000000000005 peak=776.69

- **HIP3**: 3 open, stop-risk **20.14 ZAR**
  - PARA:GLW SELL ntl=250 risk=9.65 bars=16 stop=161.20750000000001620 peak=155.21
  - PARA:IREN SELL ntl=250 risk=6.12 bars=15 stop=48.10275000000000105 peak=46.953
  - PARA:IGV SELL ntl=250 risk=4.37 bars=16 stop=108.546900 peak=106.68

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **39.74 ZAR** (informational only, no cap applied)
- Paper shadow ledger (gates paper entries only, nothing live): **39.74 / 175.11 ZAR | 24.6% | ok**
- Remaining: 131.9389 | cap skips: 0 | unknown skips: 0
- booked stats: {"hip3": {"lane_gate_blocked": 0, "opened": 0, "pair_held": 0, "signals": 41, "skipped": 41, "slice_full": 0, "slot_full": 0}, "native": {"lane_gate_blocked": 0, "opened": 1, "pair_held": 14, "signals": 764, "skipped": 749, "slice_full": 0, "slot_full": 0}}
- Highest-risk: **PARA:GLW** 9.6500 ZAR
- positions without bars: 3 | replayed: 5 | invalid: 0
...
- Latest scan 2026-09-25T07:46:16: errors=0 signals=805 regime_blocked=508
- this cycle: closed=1 new_signals=805 skipped=790 slot_full=0 slice_full=0 pair_held=14
- Action funnel: regime_blocked=508 | lane_gate_blocked=6 | aggregate_risk_cap_skips=0 | aggregate_risk_unknown_skips=0 | slice_full=0 | pair_held=14 | slot_full=0 | skipped=790
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 6, "pair_held": 14, "regime_blocked": 508, "skipped": 790, "slice_full": 0, "slot_full": 0})
- green_gate: native_green=False hip3_green=False frozen=hip3,native islands=15 blocks=13
- aggregate_risk: ok open=34.9481 cap=175.1128 used=0.2465 remaining=131.9389 replayed=5 no_new_bars=3
- pair_errors: []
