# Breakwater daily print — 2026-09-19 14:21 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **431.58 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2104.40 ZAR** (seed 2000) | lifetime: **+104.40 ZAR** | closed: 145
- Today: 13 closed, **+42.92 ZAR**
- 7d: **+104.40 ZAR** | 30d: **+104.40 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.493% | at 102.67 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (145 real closes per lane_gate._is_real_close, net of fees): +0.72 ZAR/trade | sd 2.92 | SE 0.24
- Gap: +0.21 ZAR/trade | t = +0.88 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.518% over 244/247 slices (pool 743) ~ +0.54 ZAR | realised 115 closes +0.88 ZAR sd 3.06 SE 0.29 | gap +0.35 t +1.21 | NOT ESTABLISHED
...
- Ledger: 58994 decision rows; 145 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 58849 rows are skipped/guard decisions and never count
...
- Closed: 115 | wins: 61 | win%: 53.0 | P&L: **+101.50 ZAR** | today: +42.92 | 7d: +101.50 | 30d: +101.50
- By exit: horizon +93.3, target +83.6, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 14/+49.4, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 8n/8w +34.67; feat_ext_strength:2:LONG:h15 9n/6w +26.47; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 8n +34.67; LINKUSDC 6n +16.41; SUIUSDC 3n +14.91; SOLUSDC 13n +11.15; DOGEUSDC 5n +8.92
...
- **NATIVE**: 15 open, stop-risk **57.90 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=9 stop=108.78750000000000565 peak=113.27
  - ETHUSDC BUY ntl=207 risk=5.79 bars=8 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=3 stop=1784.4999999999999990 peak=1824.0
  - LINKZAR BUY ntl=210 risk=4.48 bars=0 stop=156.97749999999999860 peak=160.39
  - XRPUSDC BUY ntl=104 risk=3.96 bars=3 stop=1.3599500000000001440 peak=1.4137
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=12 stop=0.08463350000000000245 peak=0.087927
  - LINKUSDC BUY ntl=105 risk=3.86 bars=1 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=8 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=8 stop=22.262500000000001420 peak=23.1
  - ETHZAR BUY ntl=103 risk=2.84 bars=10 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=10 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=12 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=10 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=10 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=10 stop=12153.999999999999990 peak=12444.0
...
- Computed open stop-risk (section 4): **57.90 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=8n/+34.67
...
- Native lane: **GREEN** | closed=20 pnl=+75.81 | frozen=NO
...
- Latest scan 2026-09-19T13:20:20: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 80, "regime_blocked": 302, "skipped": 915, "slice_full": 1, "slot_full": 0})
