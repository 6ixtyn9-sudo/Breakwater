# Breakwater daily print — 2026-09-19 02:55 UTC
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.460% | at 100.26 ZAR mean notional/trade: +0.46 ZAR/trade
- Realised (132 real closes per lane_gate._is_real_close, net of fees): +0.47 ZAR/trade | sd 2.87 | SE 0.25
- Gap: +0.00 ZAR/trade | t = +0.02 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.476% over 244/247 slices (pool 705) ~ +0.48 ZAR | realised 102 closes +0.57 ZAR sd 3.03 SE 0.30 | gap +0.10 t +0.32 | NOT ESTABLISHED
