# Breakwater daily print — 2026-09-19 11:44 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **427.20 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2088.80 ZAR** (seed 2000) | lifetime: **+88.81 ZAR** | closed: 142
- Today: 10 closed, **+27.33 ZAR**
- 7d: **+88.81 ZAR** | 30d: **+88.81 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.460% | at 101.17 ZAR mean notional/trade: +0.47 ZAR/trade
- Realised (142 real closes per lane_gate._is_real_close, net of fees): +0.63 ZAR/trade | sd 2.85 | SE 0.24
- Gap: +0.16 ZAR/trade | t = +0.67 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.476% over 244/247 slices (pool 705) ~ +0.48 ZAR | realised 112 closes +0.77 ZAR sd 2.98 SE 0.28 | gap +0.28 t +1.00 | NOT ESTABLISHED
...
- Ledger: 58183 decision rows; 142 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 58041 rows are skipped/guard decisions and never count
...
- Closed: 112 | wins: 58 | win%: 51.8 | P&L: **+85.90 ZAR** | today: +27.33 | 7d: +85.90 | 30d: +85.90
- By exit: horizon +91.9, target +69.4, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 11/+33.8, bear 66/-16.4
- Top slices: feat_ext_strength:2:LONG:h15 9n/6w +26.47; feat_close_pos_ma:1:LONG:h24 6n/6w +20.53; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- Top pairs: LINKZAR 6n +20.53; LINKUSDC 5n +14.96; SUIUSDC 3n +14.91; SOLUSDC 13n +11.15; DOGEUSDC 5n +8.92
...
- **NATIVE**: 15 open, stop-risk **57.79 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=7 stop=108.78750000000000565 peak=113.27
  - ETHUSDC BUY ntl=207 risk=5.79 bars=6 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=1 stop=1784.4999999999999990 peak=1824.0
  - LINKZAR BUY ntl=209 risk=4.27 bars=0 stop=157.10749999999999390 peak=160.39
  - XRPUSDC BUY ntl=104 risk=3.96 bars=1 stop=1.3599500000000001440 peak=1.4137
  - LINKUSDC BUY ntl=103 risk=3.95 bars=14 stop=11.87724999999999980 peak=12.352
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=10 stop=0.08463350000000000245 peak=0.087927
  - BTCUSDC BUY ntl=207 risk=3.86 bars=6 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=6 stop=22.262500000000001420 peak=23.1
  - ETHZAR BUY ntl=103 risk=2.84 bars=8 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=8 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=10 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=8 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=8 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=8 stop=12153.999999999999990 peak=12444.0
...
- Computed open stop-risk (section 4): **73.95 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_close_pos_ma:1:LONG:h24` edge=0.0091 n=1147 p=0.3217 src=validated_walk_forward unproven=False paper=6n/+20.53
...
- Closed paper trades: **30/50** | ghost rows: **256/50** | PnL: **+2.90 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+73.85 | frozen=NO
...
- Latest scan 2026-09-19T11:44:12: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 63, "regime_blocked": 382, "skipped": 870, "slice_full": 0, "slot_full": 0})
