# Breakwater daily print — 2026-09-19 19:44 UTC
...
- Equity: **2118.80 ZAR** (seed 2000) | lifetime: **+118.80 ZAR** | closed: 153
- Today: 21 closed, **+57.32 ZAR**
- 7d: **+118.80 ZAR** | 30d: **+118.80 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.493% | at 104.78 ZAR mean notional/trade: +0.52 ZAR/trade
- Realised (153 real closes per lane_gate._is_real_close, net of fees): +0.78 ZAR/trade | sd 2.98 | SE 0.24
- Gap: +0.26 ZAR/trade | t = +1.08 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.518% over 244/247 slices (pool 743) ~ +0.55 ZAR | realised 123 closes +0.94 ZAR sd 3.12 SE 0.28 | gap +0.39 t +1.40 | NOT ESTABLISHED
...
- Ledger: 61103 decision rows; 153 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 60950 rows are skipped/guard decisions and never count
...
- Closed: 123 | wins: 68 | win%: 55.3 | P&L: **+115.90 ZAR** | today: +57.32 | 7d: +115.90 | 30d: +115.90
- By exit: target +99.0, horizon +92.2, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 36/+69.2, bull 21/+63.1, bear 66/-16.4
- Top slices: feat_close_pos_ma:1:LONG:h24 10n/10w +50.15; feat_ext_strength:2:LONG:h15 10n/6w +22.48; feat_atr_norm_ext:2:LONG:h15 3n/3w +15.77; feat_ret_10:2:LONG:h19 11n/5w +14.58; feat_ret_20:2:LONG:h14 5n/5w +13.42
...
- **NATIVE**: 14 open, stop-risk **52.18 ZAR**
  - ETHZAR BUY ntl=424 risk=7.42 bars=4 stop=41925.24000 peak=42672.0
  - ETHUSDC BUY ntl=207 risk=5.79 bars=14 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=9 stop=1784.4999999999999990 peak=1824.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=3 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=104 risk=3.96 bars=9 stop=1.3599500000000001440 peak=1.4137
  - LINKUSDC BUY ntl=105 risk=3.86 bars=7 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=14 stop=79553.750000000000095 peak=81067.0
  - DOGEUSDC BUY ntl=106 risk=3.63 bars=3 stop=0.08592275000000000190 peak=0.088963
  - BTCUSDC BUY ntl=103 risk=2.83 bars=16 stop=79105.74999999999985 peak=81333.0
  - SOLUSDC BUY ntl=106 risk=2.58 bars=0 stop=108.47250000000000025 peak=111.18
  - BTCZAR BUY ntl=103 risk=2.54 bars=16 stop=1294261.0000000000005 peak=1326934.0
  - BNBZAR BUY ntl=103 risk=2.41 bars=16 stop=12153.999999999999990 peak=12444.0
  - LTCZAR BUY ntl=106 risk=2.38 bars=4 stop=910.3999999999999665 peak=931.3
  - BNBUSDC BUY ntl=106 risk=2.24 bars=3 stop=750.5700000000000765 peak=766.75
...
- Computed open stop-risk (section 4): **52.18 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_ext_strength:2:LONG:h15` edge=0.0072 n=16038 p=0.0016 src=validated_walk_forward unproven=False paper=10n/+22.48
...
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 39
- as_of: 2026-09-19T19:00:25Z
...
- Native lane: **GREEN** | closed=20 pnl=+54.89 | frozen=NO
...
- Latest scan 2026-09-19T19:44:34: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 46, "regime_blocked": 260, "skipped": 798, "slice_full": 6, "slot_full": 0})
