# Breakwater daily print — 2026-09-19 20:19 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **429.21 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2122.80 ZAR** (seed 2000) | lifetime: **+122.80 ZAR** | closed: 152
- Today: 20 closed, **+61.32 ZAR**
- 7d: **+122.80 ZAR** | 30d: **+122.80 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.493% | at 104.11 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (152 real closes per lane_gate._is_real_close, net of fees): +0.81 ZAR/trade | sd 2.96 | SE 0.24
- Gap: +0.29 ZAR/trade | t = +1.23 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.518% over 244/247 slices (pool 743) ~ +0.55 ZAR | realised 122 closes +0.98 ZAR sd 3.10 SE 0.28 | gap +0.44 t +1.56 | NOT ESTABLISHED
...
- Ledger: 60782 decision rows; 152 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 60630 rows are skipped/guard decisions and never count
...
- Closed: 122 | wins: 68 | win%: 55.7 | P&L: **+119.90 ZAR** | today: +61.32 | 7d: +119.90 | 30d: +119.90
- By exit: target +99.0, horizon +96.2, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 36/+69.2, bull 20/+67.1, bear 66/-16.4
...
- **NATIVE**: 14 open, stop-risk **57.78 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=14 stop=108.78750000000000565 peak=113.27
  - ETHZAR BUY ntl=424 risk=7.42 bars=3 stop=41925.24000 peak=42672.0
  - ETHUSDC BUY ntl=207 risk=5.79 bars=13 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=8 stop=1784.4999999999999990 peak=1824.0
  - HYPEUSDC BUY ntl=106 risk=4.18 bars=2 stop=89.46850000000000575 peak=93.137
  - XRPUSDC BUY ntl=104 risk=3.96 bars=8 stop=1.3599500000000001440 peak=1.4137
  - LINKUSDC BUY ntl=105 risk=3.86 bars=6 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=13 stop=79553.750000000000095 peak=81067.0
  - DOGEUSDC BUY ntl=106 risk=3.63 bars=2 stop=0.08592275000000000190 peak=0.088963
  - BTCUSDC BUY ntl=103 risk=2.83 bars=15 stop=79105.74999999999985 peak=81333.0
  - BTCZAR BUY ntl=103 risk=2.54 bars=15 stop=1294261.0000000000005 peak=1326934.0
  - BNBZAR BUY ntl=103 risk=2.41 bars=15 stop=12153.999999999999990 peak=12444.0
  - LTCZAR BUY ntl=106 risk=2.38 bars=3 stop=910.3999999999999665 peak=931.3
  - BNBUSDC BUY ntl=106 risk=2.24 bars=2 stop=750.5700000000000765 peak=766.75
...
- Computed open stop-risk (section 4): **57.78 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+61.32 | frozen=NO
...
- Latest scan 2026-09-19T18:16:20: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 60, "regime_blocked": 267, "skipped": 822, "slice_full": 5, "slot_full": 0})
