# Breakwater daily print — 2026-09-19 05:44 UTC
...
- Equity: **2068.27 ZAR** (seed 2000) | lifetime: **+68.27 ZAR** | closed: 136
- Today: 4 closed, **+6.79 ZAR**
- 7d: **+68.27 ZAR** | 30d: **+68.27 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.460% | at 100.29 ZAR mean notional/trade: +0.46 ZAR/trade
- Realised (136 real closes per lane_gate._is_real_close, net of fees): +0.50 ZAR/trade | sd 2.84 | SE 0.24
- Gap: +0.04 ZAR/trade | t = +0.17 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.476% over 244/247 slices (pool 705) ~ +0.48 ZAR | realised 106 closes +0.62 ZAR sd 2.98 SE 0.29 | gap +0.14 t +0.48 | NOT ESTABLISHED
...
- Ledger: 55021 decision rows; 136 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 54885 rows are skipped/guard decisions and never count
...
- Closed: 106 | wins: 52 | win%: 49.1 | P&L: **+65.37 ZAR** | today: +6.79 | 7d: +65.37 | 30d: +65.37
- By exit: horizon +91.9, target +48.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 5/+13.2, bear 66/-16.4
...
- **NATIVE**: 13 open, stop-risk **46.85 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=1 stop=108.78750000000000565 peak=113.27
  - ETHUSDC BUY ntl=207 risk=5.79 bars=0 stop=2547.924999999999975 peak=2621.4
  - LINKUSDC BUY ntl=103 risk=3.95 bars=8 stop=11.87724999999999980 peak=12.352
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=4 stop=0.08463350000000000245 peak=0.087927
  - BTCUSDC BUY ntl=207 risk=3.86 bars=0 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=0 stop=22.262500000000001420 peak=23.1
  - ETHZAR BUY ntl=103 risk=2.84 bars=2 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=2 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=4 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=2 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=2 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=2 stop=12153.999999999999990 peak=12444.0
  - LINKZAR BUY ntl=103 risk=1.81 bars=0 stop=157.583175 peak=160.39
...
- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  ...
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=15 stop=213.38999999999999740 peak=209.27
...
- Closed paper trades: **30/50** | ghost rows: **236/50** | PnL: **+2.90 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+73.90 | frozen=NO
...
- Latest scan 2026-09-19T05:44:37: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 36, "regime_blocked": 396, "skipped": 833, "slice_full": 0, "slot_full": 123})
