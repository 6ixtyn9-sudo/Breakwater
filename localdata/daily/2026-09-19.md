# Breakwater daily print — 2026-09-19 17:18 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **433.46 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2120.85 ZAR** (seed 2000) | lifetime: **+120.85 ZAR** | closed: 149
- Today: 17 closed, **+59.37 ZAR**
- 7d: **+120.85 ZAR** | 30d: **+120.85 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.493% | at 104.13 ZAR mean notional/trade: +0.51 ZAR/trade
- Realised (149 real closes per lane_gate._is_real_close, net of fees): +0.81 ZAR/trade | sd 2.99 | SE 0.25
- Gap: +0.30 ZAR/trade | t = +1.22 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.518% over 244/247 slices (pool 743) ~ +0.55 ZAR | realised 119 closes +0.99 ZAR sd 3.13 SE 0.29 | gap +0.45 t +1.55 | NOT ESTABLISHED
...
- Ledger: 59757 decision rows; 149 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 59608 rows are skipped/guard decisions and never count
...
- Closed: 119 | wins: 65 | win%: 54.6 | P&L: **+117.95 ZAR** | today: +59.37 | 7d: +117.95 | 30d: +117.95
- By exit: target +99.0, horizon +94.3, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 18/+65.8, bear 66/-16.4
...
- Top pairs: LINKZAR 10n +50.15; LINKUSDC 6n +16.41; SUIUSDC 3n +14.91; SOLUSDC 13n +11.15; DOGEUSDC 5n +8.92
...
- **NATIVE**: 14 open, stop-risk **57.90 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=11 stop=108.78750000000000565 peak=113.27
  - ETHZAR BUY ntl=424 risk=7.42 bars=0 stop=41925.24000 peak=42672.0
  - ETHUSDC BUY ntl=207 risk=5.79 bars=10 stop=2547.924999999999975 peak=2621.4
  - SOLZAR BUY ntl=208 risk=4.51 bars=5 stop=1784.4999999999999990 peak=1824.0
  - XRPUSDC BUY ntl=104 risk=3.96 bars=5 stop=1.3599500000000001440 peak=1.4137
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=14 stop=0.08463350000000000245 peak=0.087927
  - LINKUSDC BUY ntl=105 risk=3.86 bars=3 stop=12.075999999999998530 peak=12.538
  - BTCUSDC BUY ntl=207 risk=3.86 bars=10 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=10 stop=22.262500000000001420 peak=23.1
  - BTCUSDC BUY ntl=103 risk=2.83 bars=12 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=14 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=12 stop=1294261.0000000000005 peak=1326934.0
  - BNBZAR BUY ntl=103 risk=2.41 bars=12 stop=12153.999999999999990 peak=12444.0
  - LTCZAR BUY ntl=106 risk=2.38 bars=0 stop=910.3999999999999665 peak=931.3
...
- Closed paper trades: **30/50** | ghost rows: **271/50** | PnL: **+2.90 ZAR**
...
- Native lane: **GREEN** | closed=20 pnl=+73.04 | frozen=NO
...
- Latest scan 2026-09-19T15:43:45: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 81, "regime_blocked": 295, "skipped": 890, "slice_full": 1, "slot_full": 0})
