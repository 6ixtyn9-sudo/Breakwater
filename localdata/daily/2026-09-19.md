# Breakwater daily print — 2026-09-19 11:07 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **438.71 ZAR** | high-water: **438.71 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2066.28 ZAR** (seed 2000) | lifetime: **+66.28 ZAR** | closed: 134
- Today: 2 closed, **+4.80 ZAR**
- 7d: **+66.28 ZAR** | 30d: **+66.28 ZAR**
...
- Claimed edge (median mean_ret_costadj over 287 book slices present in the validated pools): +0.493% | at 100.27 ZAR mean notional/trade: +0.49 ZAR/trade
- Realised (134 real closes per lane_gate._is_real_close, net of fees): +0.49 ZAR/trade | sd 2.86 | SE 0.25
- Gap: +0.00 ZAR/trade | t = +0.00 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.522% over 266/269 slices (pool 719) ~ +0.52 ZAR | realised 104 closes +0.61 ZAR sd 3.01 SE 0.30 | gap +0.08 t +0.29 | NOT ESTABLISHED
...
- Ledger: 54579 decision rows; 134 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 54445 rows are skipped/guard decisions and never count
...
- Closed: 104 | wins: 50 | win%: 48.1 | P&L: **+63.38 ZAR** | today: +4.80 | 7d: +63.38 | 30d: +63.38
- By exit: horizon +89.9, target +48.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 33/+66.6, bull 5/+13.2, bear 66/-16.4
...
- Top pairs: LINKUSDC 5n +14.96; SUIUSDC 3n +14.91; SOLUSDC 13n +11.15; DOGEUSDC 5n +8.92; ARBUSDC 3n +7.76
...
- **NATIVE**: 11 open, stop-risk **37.19 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=0 stop=108.78750000000000565 peak=113.27
  - LINKUSDC BUY ntl=103 risk=3.95 bars=7 stop=11.87724999999999980 peak=12.352
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=3 stop=0.08463350000000000245 peak=0.087927
  - ETHUSDC BUY ntl=102 risk=3.28 bars=11 stop=2515.0250000000000945 peak=2598.5
  - ETHZAR BUY ntl=103 risk=2.84 bars=1 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=1 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=3 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=1 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=1 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=1 stop=12153.999999999999990 peak=12444.0
  - BTCUSDC BUY ntl=102 risk=2.28 bars=14 stop=78266.50000000000005 peak=80061.0

- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  - PARA:COHR SELL ntl=203 risk=7.42 bars=14 stop=320.19000000000001555 peak=308.91
  - PARA:CRDO SELL ntl=203 risk=5.19 bars=12 stop=177.76000000000000660 peak=173.33
  - PARA:AVGO SELL ntl=203 risk=3.55 bars=14 stop=365.313025 peak=359.03
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=13 stop=213.38999999999999740 peak=209.27
  - PARA:CRWD SELL ntl=102 risk=1.94 bars=10 stop=242.6625000000000040 peak=238.12
  - PARA:CIEN SELL ntl=102 risk=1.78 bars=11 stop=354.059475 peak=347.97

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **59.07 ZAR** (informational only, no cap applied)
...
- Closed paper trades: **30/50** | ghost rows: **231/50** | PnL: **+2.90 ZAR**
...
- Label: **bull** | breadth bear=0.0 bull=0.9412 neutral=0.0588 | symbols=17
- confirmed_bear: **False** | confirmed_bull: **True** | flip: **True** | flipped_from: bull | consecutive_bear: 0 / bull 24
- as_of: 2026-09-19T04:00:26Z
...
- Native lane: **GREEN** | closed=20 pnl=+84.59 | frozen=NO
...
- Latest scan 2026-09-19T04:27:25: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 35, "regime_blocked": 420, "skipped": 880, "slice_full": 0, "slot_full": 156})
