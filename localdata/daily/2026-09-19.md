# Breakwater daily print — 2026-09-19 07:44 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **441.81 ZAR** | high-water: **441.81 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **2074.04 ZAR** (seed 2000) | lifetime: **+74.04 ZAR** | closed: 138
- Today: 6 closed, **+12.56 ZAR**
- 7d: **+74.04 ZAR** | 30d: **+74.04 ZAR**
...
- Claimed edge (median mean_ret_costadj over 265 book slices present in the validated pools): +0.460% | at 100.33 ZAR mean notional/trade: +0.46 ZAR/trade
- Realised (138 real closes per lane_gate._is_real_close, net of fees): +0.54 ZAR/trade | sd 2.83 | SE 0.24
- Gap: +0.08 ZAR/trade | t = +0.31 (one-sample t of realised mean vs the claimed constant) | verdict: NOT ESTABLISHED
- native: claimed median +0.476% over 244/247 slices (pool 705) ~ +0.48 ZAR | realised 108 closes +0.66 ZAR sd 2.97 SE 0.29 | gap +0.18 t +0.63 | NOT ESTABLISHED
...
- Ledger: 56058 decision rows; 138 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 55920 rows are skipped/guard decisions and never count
...
- Closed: 108 | wins: 54 | win%: 50.0 | P&L: **+71.14 ZAR** | today: +12.56 | 7d: +71.14 | 30d: +71.14
- By exit: horizon +91.9, target +54.7, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): neutral 35/+68.6, bull 7/+19.0, bear 66/-16.4
...
- **NATIVE**: 13 open, stop-risk **46.86 ZAR**
  - SOLUSDC BUY ntl=207 risk=8.17 bars=3 stop=108.78750000000000565 peak=113.27
  - ETHUSDC BUY ntl=207 risk=5.79 bars=2 stop=2547.924999999999975 peak=2621.4
  - LINKUSDC BUY ntl=103 risk=3.95 bars=10 stop=11.87724999999999980 peak=12.352
  - DOGEUSDC BUY ntl=103 risk=3.87 bars=6 stop=0.08463350000000000245 peak=0.087927
  - BTCUSDC BUY ntl=207 risk=3.86 bars=2 stop=79553.750000000000095 peak=81067.0
  - XRPZAR BUY ntl=103 risk=3.75 bars=2 stop=22.262500000000001420 peak=23.1
  - ETHZAR BUY ntl=103 risk=2.84 bars=4 stop=41496.500000000000095 peak=42672.0
  - BTCUSDC BUY ntl=103 risk=2.83 bars=4 stop=79105.74999999999985 peak=81333.0
  - BNBUSDC BUY ntl=103 risk=2.55 bars=6 stop=745.6200000000000145 peak=764.51
  - BTCZAR BUY ntl=103 risk=2.54 bars=4 stop=1294261.0000000000005 peak=1326934.0
  - LTCZAR BUY ntl=103 risk=2.48 bars=4 stop=908.9749999999999845 peak=931.3
  - BNBZAR BUY ntl=103 risk=2.41 bars=4 stop=12153.999999999999990 peak=12444.0
  - LINKZAR BUY ntl=104 risk=1.81 bars=0 stop=157.583175 peak=160.39

- **HIP3**: 6 open, stop-risk **21.87 ZAR**
  - PARA:COHR SELL ntl=203 risk=7.42 bars=15 stop=320.19000000000001555 peak=308.91
  - PARA:CRDO SELL ntl=203 risk=5.19 bars=17 stop=177.76000000000000660 peak=173.33
  - PARA:AVGO SELL ntl=203 risk=3.55 bars=17 stop=365.313025 peak=359.03
  - PARA:TTWO SELL ntl=102 risk=2.00 bars=17 stop=213.38999999999999740 peak=209.27
...
- Computed open stop-risk (section 4): **68.73 ZAR** (informational only, no cap applied)
...
- Native lane: **GREEN** | closed=20 pnl=+73.68 | frozen=NO
...
- Latest scan 2026-09-19T07:44:39: errors=2 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `skipped` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 3, "pair_held": 66, "regime_blocked": 442, "skipped": 946, "slice_full": 0, "slot_full": 35})
- green_gate: native_green=True hip3_green=False frozen=hip3 islands=2 blocks=9
- pair_errors: [{"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:KSTR"}, {"error": "HTTPError: 429 Client Error: Too Many Requests for url: https://api.hyperliquid.xyz/info", "pair": "XYZ:NCLD"}]
