# Breakwater daily print — 2026-09-17 03:56 UTC
...
- Book: 26 slices (native 8 | hip3 18); validated pools: native 0 | hip3 160; book slices absent from pools: 16
  ...
  - ... and 6 more
- Claimed edge (median mean_ret_costadj over 10 book slices present in the validated pools): +0.064% | at 99.04 ZAR mean notional/trade: +0.06 ZAR/trade
- Realised (86 real closes per lane_gate._is_real_close, net of fees): -0.53 ZAR/trade | sd 2.26 | SE 0.24
- Gap: -0.60 ZAR/trade | t = -2.46 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed unknown (0/8 slices in pool 0) | realised 64 closes -0.90 ZAR | claimed unknown
...
- Closed: 22 | wins: 17 | win%: 77.3 | P&L: **+11.59 ZAR** | today: +0.00 | 7d: +11.59 | 30d: +11.59
