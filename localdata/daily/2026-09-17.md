# Breakwater daily print — 2026-09-17 15:06 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **396.15 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1956.14 ZAR** (seed 2000) | lifetime: **-43.86 ZAR** | closed: 103
- Today: 17 closed, **+2.09 ZAR**
- 7d: **-43.86 ZAR** | 30d: **-43.86 ZAR**
...
- Book: 26 slices (native 8 | hip3 18); validated pools: native 0 | hip3 160; book slices absent from pools: 16
  ...
  - ... and 6 more
- Claimed edge (median mean_ret_costadj over 10 book slices present in the validated pools): +0.064% | at 99.80 ZAR mean notional/trade: +0.06 ZAR/trade
- Realised (103 real closes per lane_gate._is_real_close, net of fees): -0.43 ZAR/trade | sd 2.35 | SE 0.23
- Gap: -0.49 ZAR/trade | t = -2.12 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed unknown (0/8 slices in pool 0) | realised 76 closes -0.56 ZAR | claimed unknown
...
- Ledger: 33070 decision rows; 103 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 32967 rows are skipped/guard decisions and never count
...
- Closed: 76 | wins: 23 | win%: 30.3 | P&L: **-42.94 ZAR** | today: +14.61 | 7d: -42.94 | 30d: -42.94
- By exit: horizon +22.5, target +9.9, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): bull 1/-3.8, neutral 12/-14.2, bear 63/-25.0
- Top slices: feat_ext_vs_ma_20:2:LONG:h15 5n/5w +9.35; feat_ret_10:2:LONG:h19 10n/4w +8.07; feat_ext_strength:2:LONG:h15 4n/2w +6.73; engine_momentum:trend_align:2:SELL:h15:FILUSDC 2n/1w +2.45; feat_realized_vol_20:2:LONG:h20 8n/7w +1.47
...
- Top pairs: ARBUSDC 3n +7.76; SUIUSDC 1n +3.81; TAOUSDC 2n +3.43; WLDUSDC 1n +1.64; DOGEUSDC 3n +1.29
...
- **NATIVE**: 12 open, stop-risk **43.21 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=18 stop=10.568250000000000175 peak=10.99
  - SUIUSDC BUY ntl=98 risk=3.81 bars=5 stop=0.6937050000000000245 peak=0.72188
  - WLDUSDC BUY ntl=98 risk=3.77 bars=1 stop=0.3633724999999999915 peak=0.37798
  - TAOUSDC BUY ntl=98 risk=3.77 bars=4 stop=218.55249999999998005 peak=227.32
  - KPEPEUSDC BUY ntl=98 risk=3.76 bars=5 stop=0.0033364999999999999610 peak=0.00347
  - AAVEUSDC BUY ntl=98 risk=3.70 bars=1 stop=120.35500000000001335 peak=125.1
  - FILUSDC BUY ntl=98 risk=3.70 bars=5 stop=0.7672624999999999540 peak=0.79746
  - TRUMPUSDC BUY ntl=98 risk=3.50 bars=1 stop=1.878824999999999980 peak=1.9487
  - XRPUSDC BUY ntl=97 risk=3.42 bars=6 stop=1.2580499999999999655 peak=1.3041
  - SOLUSDC BUY ntl=98 risk=2.69 bars=5 stop=97.43574999999999960 peak=100.2
  - BTCUSDC BUY ntl=98 risk=1.86 bars=0 stop=75013.500000000000040 peak=76468.0
  - BNBUSDC BUY ntl=98 risk=1.71 bars=5 stop=712.734975 peak=725.43

- **HIP3**: 6 open, stop-risk **13.72 ZAR**
  - PARA:COHR SELL ntl=98 risk=3.07 bars=1 stop=314.50749999999999095 peak=304.92
  - PARA:CIEN SELL ntl=98 risk=2.66 bars=1 stop=377.0499999999999895 peak=367.04
  - PARA:CRDO SELL ntl=98 risk=2.55 bars=1 stop=171.35750000000002975 peak=167.0
  - PARA:GLW SELL ntl=98 risk=2.02 bars=1 stop=155.95250000000000345 peak=152.8
  - PARA:TER SELL ntl=98 risk=1.71 bars=1 stop=358.149825 peak=351.99
  - PARA:AVGO SELL ntl=98 risk=1.71 bars=1 stop=355.982550 peak=349.86

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **56.92 ZAR** (informational only, no cap applied)
...
- Native top (by paper P&L):
  ...
  - `feat_ret_10:2:LONG:h19` edge=0.0077 n=16875 p=0.0000 src=validated_walk_forward unproven=False paper=10n/+8.07
...
- Closed paper trades: **27/50** | ghost rows: **172/50** | PnL: **-0.92 ZAR**
...
- Green islands kept alive inside red lanes: 6
  ...
  - `feat_ret_10:2:LONG:h19` pnl=+8.07
...
- Latest scan 2026-09-17T15:06:05: errors=0 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `slot_full` (funnel={"aggregate_risk_cap_skips": 0, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 4, "pair_held": 25, "regime_blocked": 148, "skipped": 31, "slice_full": 16, "slot_full": 191})
