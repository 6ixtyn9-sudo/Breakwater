# Breakwater daily print — 2026-09-17 04:06 UTC

> Observation mode. Read-only digest of committed state. Nothing here trades or promotes.

## 1. Posture

- Mode: **readonly** | VALR equity: **390.31 ZAR** | high-water: **435.05 ZAR**
- Key perms: trade, view access | perps API: unavailable (ValrAuthenticationError: VALR authentication rejected request with HTTP 401)
- risk_allowed: **True** reasons=[]

## 2. Paper account

- Equity: **1944.22 ZAR** (seed 2000) | lifetime: **-55.78 ZAR** | closed: 90
- Today: 4 closed, **-9.83 ZAR**
- 7d: **-55.78 ZAR** | 30d: **-55.78 ZAR**
...
- Book: 26 slices (native 8 | hip3 18); validated pools: native 0 | hip3 160; book slices absent from pools: 16
  ...
  - ... and 6 more
- Claimed edge (median mean_ret_costadj over 10 book slices present in the validated pools): +0.064% | at 99.00 ZAR mean notional/trade: +0.06 ZAR/trade
- Realised (90 real closes per lane_gate._is_real_close, net of fees): -0.62 ZAR/trade | sd 2.26 | SE 0.24
- Gap: -0.68 ZAR/trade | t = -2.87 (one-sample t of realised mean vs the claimed constant) | verdict: FALLS SHORT
- native: claimed unknown (0/8 slices in pool 0) | realised 66 closes -0.94 ZAR | claimed unknown
...
- Ledger: 29651 decision rows; 90 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 29561 rows are skipped/guard decisions and never count
...
- Closed: 66 | wins: 14 | win%: 21.2 | P&L: **-62.11 ZAR** | today: -4.56 | 7d: -62.11 | 30d: -62.11
- By exit: target +9.9, horizon +3.4, regime_shift -11.9, stop -63.5
- By entry regime (n/pnl): bull 1/-3.8, neutral 11/-15.4, bear 54/-42.9
...
- **NATIVE**: 11 open, stop-risk **45.69 ZAR**
  - LINKUSDC BUY ntl=195 risk=7.50 bars=7 stop=10.568250000000000175 peak=10.99
  - DOGEUSDC BUY ntl=195 risk=6.51 bars=8 stop=0.07773975000000000430 peak=0.080417
  - WLDUSDC BUY ntl=98 risk=4.59 bars=9 stop=0.349429999999999955 peak=0.36664
  - TRUMPUSDC BUY ntl=98 risk=4.47 bars=9 stop=1.7770750000000000540 peak=1.8622
  - ZECUSDC SELL ntl=98 risk=4.40 bars=9 stop=1396.5035714285714 peak=1336.3
  - SUIUSDC BUY ntl=98 risk=3.82 bars=9 stop=0.6670574999999999860 peak=0.6942
  - TAOUSDC BUY ntl=98 risk=3.74 bars=9 stop=209.3224999999999935 peak=217.66
  - ETHUSDC BUY ntl=97 risk=3.37 bars=1 stop=2344.3999999999998880 peak=2428.4
  - SOLUSDC BUY ntl=98 risk=2.91 bars=9 stop=94.85499999999999515 peak=97.766
  - BTCUSDC BUY ntl=98 risk=2.32 bars=4 stop=74370.75000000000010 peak=76180.0
  - BNBUSDC BUY ntl=98 risk=2.06 bars=9 stop=700.2850000000000755 peak=715.4

- **HIP3**: 5 open, stop-risk **9.50 ZAR**
  - PARA:CRDO SELL ntl=98 risk=3.72 bars=9 stop=167.7850000000000085 peak=161.63
  - PARA:IREN SELL ntl=98 risk=2.75 bars=10 stop=44.663250000000000375 peak=43.45
  - PARA:SMCI SELL ntl=98 risk=1.34 bars=3 stop=37.058749999999999995 peak=36.558
  - PARA:GLW SELL ntl=99 risk=1.18 bars=14 stop=148.99000000000001205 peak=147.23
  - PARA:AVGO SELL ntl=99 risk=0.51 bars=14 stop=344.77249999999998465 peak=342.99

## 5. Aggregate risk leash

- Aggregate: **NOT WIRED FOR LIVE TRADING** - no cap is applied to any live position (there is no live executor); the computed open stop-risk is informational only.
- Computed open stop-risk (section 4): **55.19 ZAR** (informational only, no cap applied)
...
- Native lane: **RED** | closed=20 pnl=-32.49 | frozen=YES
...
- Latest scan 2026-09-17T04:06:11: errors=4 signals=None regime_blocked=None
