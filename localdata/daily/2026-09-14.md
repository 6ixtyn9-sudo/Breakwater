# Breakwater daily print — 2026-09-14 05:09 UTC
...
- Ledger: 203559 decision rows; 163 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 203396 rows are skipped/guard decisions and never count
...
- Closed: 127 | wins: 50 | win%: 39.4 | P&L: **-227.74 ZAR** | today: +6.18 | 7d: -219.31 | 30d: -227.74
...
- **NATIVE**: 2 open, stop-risk **6.92 ZAR**
  - XRPUSDC BUY ntl=347 risk=6.92 bars=9 stop=1.3274000000000000290 peak=1.3544
  - BTCUSDC BUY ntl=346 risk=0.00 bars=15 stop=77006.7500000000000200 peak=77657.0

- **HIP3**: 1 open, stop-risk **0.00 ZAR**
  - XYZ:COST BUY ntl=364 risk=0.00 bars=62 stop=904.932500000000054400 peak=908.93
...
- Latest scan 2026-09-14T05:09:33: errors=0 signals=None regime_blocked=None
