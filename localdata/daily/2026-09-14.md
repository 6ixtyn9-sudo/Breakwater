# Breakwater daily print — 2026-09-14 10:57 UTC
...
- Ledger: 208834 decision rows; 164 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 208670 rows are skipped/guard decisions and never count
...
- **HIP3**: 1 open, stop-risk **0.00 ZAR**
  - XYZ:COST BUY ntl=364 risk=0.00 bars=68 stop=906.242500000000054400 peak=910.24
...
- Latest scan 2026-09-14T10:39:28: errors=1 signals=None regime_blocked=None
...
- **NO ACTION:** dominant blocker = `regime_blocked` (funnel={"aggregate_risk_cap_skips": 17, "aggregate_risk_unknown_skips": 0, "lane_gate_blocked": 9, "pair_held": 40, "regime_blocked": 470, "skipped": 45, "slice_full": 0, "slot_full": 89})
