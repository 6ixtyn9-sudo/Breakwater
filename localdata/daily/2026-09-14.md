# Breakwater daily print — 2026-09-14 07:56 UTC
...
- Ledger: 205603 decision rows; 163 real closes (outcome win/loss and exit_reason in lane_gate.ACTUAL_EXITS, 8 exit reasons); the other 205440 rows are skipped/guard decisions and never count
...
- **NATIVE**: 2 open, stop-risk **0.00 ZAR**
  - BTCUSDC BUY ntl=346 risk=0.00 bars=17 stop=77006.7500000000000200 peak=77657.0
  - XRPUSDC BUY ntl=347 risk=0.00 bars=11 stop=1.35980000000000002900 peak=1.3868
